...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class YearEndVoucherLinePostDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="YearEndVoucherLinePostDto" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class YearEndVoucherLinePostDto {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="YearEndVoucherLinePostDto" />
    /// </summary>
    public class YearEndVoucherLinePostDtoJsonConverter : JsonConverter<YearEndVoucherLinePostDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="YearEndVoucherLinePostDto" />
        /// </summary>
        ...
        public override YearEndVoucherLinePostDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!postingDate.IsSet)
                throw new ArgumentException("Property is required for class YearEndVoucherLinePostDto.", nameof(postingDate));

            if (!accountId.IsSet)
                throw new ArgumentException("Property is required for class YearEndVoucherLinePostDto.", nameof(accountId));

            if (!vatId.IsSet)
                throw new ArgumentException("Property is required for class YearEndVoucherLinePostDto.", nameof(vatId));

            if (postingDate.IsSet && postingDate.Value == null)
                throw new ArgumentNullException(nameof(postingDate), "Property is not nullable for class YearEndVoucherLinePostDto.");

            if (currencyAmount.IsSet && currencyAmount.Value == null)
                throw new ArgumentNullException(nameof(currencyAmount), "Property is not nullable for class YearEndVoucherLinePostDto.");

            return new YearEndVoucherLinePostDto(postingDate.Value!.Value!, accountId.Value!, currencyAmount, currencyCode, currencyExchangeRate, customMatchingReference, departmentId, description, dim1Id, dim2Id, dim3Id, externalLineReference, locationId, productId, projectId, quantity, quantity2, vatId.Value!, vatReturnSpecification);
        }

        /// <summary>
        /// Serializes a <see cref="YearEndVoucherLinePostDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="yearEndVoucherLinePostDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, YearEndVoucherLinePostDto yearEndVoucherLinePostDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, yearEndVoucherLinePostDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="YearEndVoucherLinePostDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="yearEndVoucherLinePostDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, YearEndVoucherLinePostDto yearEndVoucherLinePostDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteString("PostingDate", yearEndVoucherLinePostDto.PostingDate.ToString(PostingDateFormat));

            if (yearEndVoucherLinePostDto.AccountId != null)
                writer.WriteNumber("AccountId", yearEndVoucherLinePostDto.AccountId.Value);
            else
                writer.WriteNull("AccountId");

            if (yearEndVoucherLinePostDto.CurrencyAmountOption.IsSet)
                writer.WriteNumber("CurrencyAmount", yearEndVoucherLinePostDto.CurrencyAmountOption.Value!.Value);

            if (yearEndVoucherLinePostDto.CurrencyCodeOption.IsSet)
                if (yearEndVoucherLinePostDto.CurrencyCodeOption.Value != null)
                    writer.WriteString("CurrencyCode", yearEndVoucherLinePostDto.CurrencyCode);
                else
                    writer.WriteNull("CurrencyCode");

            if (yearEndVoucherLinePostDto.CurrencyExchangeRateOption.IsSet)
                if (yearEndVoucherLinePostDto.CurrencyExchangeRateOption.Value != null)
                    writer.WriteNumber("CurrencyExchangeRate", yearEndVoucherLinePostDto.CurrencyExchangeRateOption.Value!.Value);
                else
                    writer.WriteNull("CurrencyExchangeRate");

            if (yearEndVoucherLinePostDto.CustomMatchingReferenceOption.IsSet)
                if (yearEndVoucherLinePostDto.CustomMatchingReferenceOption.Value != null)
                    writer.WriteString("CustomMatchingReference", yearEndVoucherLinePostDto.CustomMatchingReference);
                else
                    writer.WriteNull("CustomMatchingReference");

            if (yearEndVoucherLinePostDto.DepartmentIdOption.IsSet)
                if (yearEndVoucherLinePostDto.DepartmentIdOption.Value != null)
                    writer.WriteNumber("DepartmentId", yearEndVoucherLinePostDto.DepartmentIdOption.Value!.Value);
                else
                    writer.WriteNull("DepartmentId");

            if (yearEndVoucherLinePostDto.DescriptionOption.IsSet)
                if (yearEndVoucherLinePostDto.DescriptionOption.Value != null)
                    writer.WriteString("Description", yearEndVoucherLinePostDto.Description);
                else
                    writer.WriteNull("Description");

            if (yearEndVoucherLinePostDto.Dim1IdOption.IsSet)
                if (yearEndVoucherLinePostDto.Dim1IdOption.Value != null)
                    writer.WriteNumber("Dim1Id", yearEndVoucherLinePostDto.Dim1IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim1Id");

            if (yearEndVoucherLinePostDto.Dim2IdOption.IsSet)
                if (yearEndVoucherLinePostDto.Dim2IdOption.Value != null)
                    writer.WriteNumber("Dim2Id", yearEndVoucherLinePostDto.Dim2IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim2Id");

            if (yearEndVoucherLinePostDto.Dim3IdOption.IsSet)
                if (yearEndVoucherLinePostDto.Dim3IdOption.Value != null)
                    writer.WriteNumber("Dim3Id", yearEndVoucherLinePostDto.Dim3IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim3Id");

            if (yearEndVoucherLinePostDto.ExternalLineReferenceOption.IsSet)
                if (yearEndVoucherLinePostDto.ExternalLineReferenceOption.Value != null)
                    writer.WriteString("ExternalLineReference", yearEndVoucherLinePostDto.ExternalLineReference);
                else
                    writer.WriteNull("ExternalLineReference");

            if (yearEndVoucherLinePostDto.LocationIdOption.IsSet)
                if (yearEndVoucherLinePostDto.LocationIdOption.Value != null)
                    writer.WriteNumber("LocationId", yearEndVoucherLinePostDto.LocationIdOption.Value!.Value);
                else
                    writer.WriteNull("LocationId");

            if (yearEndVoucherLinePostDto.ProductIdOption.IsSet)
                if (yearEndVoucherLinePostDto.ProductIdOption.Value != null)
                    writer.WriteNumber("ProductId", yearEndVoucherLinePostDto.ProductIdOption.Value!.Value);
                else
                    writer.WriteNull("ProductId");

            if (yearEndVoucherLinePostDto.ProjectIdOption.IsSet)
                if (yearEndVoucherLinePostDto.ProjectIdOption.Value != null)
                    writer.WriteNumber("ProjectId", yearEndVoucherLinePostDto.ProjectIdOption.Value!.Value);
                else
                    writer.WriteNull("ProjectId");

            if (yearEndVoucherLinePostDto.QuantityOption.IsSet)
                if (yearEndVoucherLinePostDto.QuantityOption.Value != null)
                    writer.WriteNumber("Quantity", yearEndVoucherLinePostDto.QuantityOption.Value!.Value);
                else
                    writer.WriteNull("Quantity");

            if (yearEndVoucherLinePostDto.Quantity2Option.IsSet)
                if (yearEndVoucherLinePostDto.Quantity2Option.Value != null)
                    writer.WriteNumber("Quantity2", yearEndVoucherLinePostDto.Quantity2Option.Value!.Value);
                else
                    writer.WriteNull("Quantity2");

            if (yearEndVoucherLinePostDto.VatId != null)
                writer.WriteNumber("VatId", yearEndVoucherLinePostDto.VatId.Value);
            else
                writer.WriteNull("VatId");

            if (yearEndVoucherLinePostDto.VatReturnSpecificationOption.IsSet)
                if (yearEndVoucherLinePostDto.VatReturnSpecificationOption!.Value != null)
                {
                    var vatReturnSpecificationRawValue = VatReturnSpecificationValueConverter.ToJsonValue(yearEndVoucherLinePostDto.VatReturnSpecificationOption.Value!.Value);
