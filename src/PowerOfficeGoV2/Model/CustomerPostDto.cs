...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class CustomerPostDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerPostDto" /> class.
        /// </summary>
        ...
        /// <param name="deliveryTerm">The delivery term of the customer.  The delivery term set will be the default value when an invoice draft is created in Go with this customer.  The default set of delivery terms provided in Go are incoterms, but any custom string can be set.  If null, the default delivery term set on the client is used.  Note that if DeliveryTermId is set as well in the request, DeliveryTermId takes precedence and DeliveryTerm is ignored.</param>
        ...
        /// <param name="paymentTerm">The payment term of the customer.  This is the default number of days after an invoice is sent until it is due.  The payment term set will be the default value when an invoice draft is created in Go with this customer.  If null, the default payment term set on the client will be used.  Note that if PaymentTermId is set as well in the request, PaymentTermId takes precedence and PaymentTerm is ignored.</param>
        ...
        /// <param name="salesPersonEmployeeNumber">The employee number of the sales person assigned this customer.  If null, the default sales person is used if set in the SalesSettings.</param>
        ...
        /// <param name="subLedgerNumberSeriesId">The Id of the sub-ledger series this customer belong in.  Relevant if the client have multiple customer sub-ledger series, and if so highly relevant in POST calls if the integrating party does not set Number but lets Go assign the next available Number.  In such cases, Go will create the customer in the default sub-ledger series, unless this property is set.</param>
        ...
        /// <summary>
        /// The delivery term of the customer.  The delivery term set will be the default value when an invoice draft is created in Go with this customer.  The default set of delivery terms provided in Go are incoterms, but any custom string can be set.  If null, the default delivery term set on the client is used.  Note that if DeliveryTermId is set as well in the request, DeliveryTermId takes precedence and DeliveryTerm is ignored.
        /// </summary>
        /// <value>The delivery term of the customer.  The delivery term set will be the default value when an invoice draft is created in Go with this customer.  The default set of delivery terms provided in Go are incoterms, but any custom string can be set.  If null, the default delivery term set on the client is used.  Note that if DeliveryTermId is set as well in the request, DeliveryTermId takes precedence and DeliveryTerm is ignored.</value>
        /* <example>DAP</example> */
        ...
        /// <summary>
        /// The code of the department this customer is associated with.  The department will be the default value when an invoice draft is created in Go with this customer.  The department entity must exist in Go in order to set the code.  Note that if DepartmentId is set as well in the request, DepartmentId takes precedence and DepartmentCode is ignored.
        /// </summary>
        /// <value>The code of the department this customer is associated with.  The department will be the default value when an invoice draft is created in Go with this customer.  The department entity must exist in Go in order to set the code.  Note that if DepartmentId is set as well in the request, DepartmentId takes precedence and DepartmentCode is ignored.</value>
        /* <example>1A</example> */
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> InvoiceBrandingThemeCodeOption { get; private set; }

        /// <summary>
        /// The code of the branding theme used when sending invoices to this customer.  If null, the clients default branding theme will be used.  Note that if InvoiceBrandingThemeId is set as well in the request, InvoiceBrandingThemeId takes precedence and InvoiceBrandingThemeCode is ignored.
        /// </summary>
        /// <value>The code of the branding theme used when sending invoices to this customer.  If null, the clients default branding theme will be used.  Note that if InvoiceBrandingThemeId is set as well in the request, InvoiceBrandingThemeId takes precedence and InvoiceBrandingThemeCode is ignored.</value>
        /* <example>4</example> */
        [JsonPropertyName("InvoiceBrandingThemeCode")]
        public string? InvoiceBrandingThemeCode { get { return this.InvoiceBrandingThemeCodeOption; } set { this.InvoiceBrandingThemeCodeOption = new(value); } }
        ...
        /// <summary>
        /// The payment term of the customer.  This is the default number of days after an invoice is sent until it is due.  The payment term set will be the default value when an invoice draft is created in Go with this customer.  If null, the default payment term set on the client will be used.  Note that if PaymentTermId is set as well in the request, PaymentTermId takes precedence and PaymentTerm is ignored.
        /// </summary>
        /// <value>The payment term of the customer.  This is the default number of days after an invoice is sent until it is due.  The payment term set will be the default value when an invoice draft is created in Go with this customer.  If null, the default payment term set on the client will be used.  Note that if PaymentTermId is set as well in the request, PaymentTermId takes precedence and PaymentTerm is ignored.</value>
        /* <example>14</example> */
        ...
        /// <summary>
        /// The employee number of the sales person assigned this customer.  If null, the default sales person is used if set in the SalesSettings.
        /// </summary>
        /// <value>The employee number of the sales person assigned this customer.  If null, the default sales person is used if set in the SalesSettings.</value>
        /* <example>3</example> */
        ...
        /// <summary>
        /// The Id of the sub-ledger series this customer belong in.  Relevant if the client have multiple customer sub-ledger series, and if so highly relevant in POST calls if the integrating party does not set Number but lets Go assign the next available Number.  In such cases, Go will create the customer in the default sub-ledger series, unless this property is set.
        /// </summary>
        /// <value>The Id of the sub-ledger series this customer belong in.  Relevant if the client have multiple customer sub-ledger series, and if so highly relevant in POST calls if the integrating party does not set Number but lets Go assign the next available Number.  In such cases, Go will create the customer in the default sub-ledger series, unless this property is set.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomerPostDto {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="CustomerPostDto" />
    /// </summary>
    public class CustomerPostDtoJsonConverter : JsonConverter<CustomerPostDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="CustomerPostDto" />
        /// </summary>
        ...
        public override CustomerPostDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (mailAddress.IsSet && mailAddress.Value == null)
                throw new ArgumentNullException(nameof(mailAddress), "Property is not nullable for class CustomerPostDto.");

            return new CustomerPostDto(allowance, billableRate, contactGroupIds, currencyCode, customerSince, dateOfBirth, deliveryTerm, deliveryTermId, departmentCode, departmentId, doNotAddLatePaymentFees, doNotAddLatePaymentInterest, doNotAutomatePaymentNotifications, emailAddress, externalImportReference, externalNumber, firstName, invoiceBrandingThemeCode, invoiceBrandingThemeId, invoiceDeliveryType, invoiceEmailAddress, invoiceEmailAddressCC, isArchived, isPerson, isVatFree, lastName, legalName, mailAddress, name, nationalIdNumber, noticeOfDebtCollectionDeliveryType, number, organizationNumber, paymentReminderEmailAddress, paymentTerm, paymentTermId, phoneNumber, reminderDeliveryType, salesPersonEmployeeId, salesPersonEmployeeNumber, sendPaymentReminders, subLedgerNumberSeriesId, transferToDebtCollectionAgency, useInvoiceFee, websiteUrl);
        }

        /// <summary>
        /// Serializes a <see cref="CustomerPostDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="customerPostDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CustomerPostDto customerPostDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, customerPostDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CustomerPostDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="customerPostDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CustomerPostDto customerPostDto, JsonSerializerOptions jsonSerializerOptions)
        {
            if (customerPostDto.MailAddressOption.IsSet && customerPostDto.MailAddress == null)
                throw new ArgumentNullException(nameof(customerPostDto.MailAddress), "Property is required for class CustomerPostDto.");

            if (customerPostDto.AllowanceOption.IsSet)
                if (customerPostDto.AllowanceOption.Value != null)
                    writer.WriteNumber("Allowance", customerPostDto.AllowanceOption.Value!.Value);
                else
                    writer.WriteNull("Allowance");

            if (customerPostDto.BillableRateOption.IsSet)
                if (customerPostDto.BillableRateOption.Value != null)
                    writer.WriteNumber("BillableRate", customerPostDto.BillableRateOption.Value!.Value);
                else
                    writer.WriteNull("BillableRate");

            if (customerPostDto.ContactGroupIdsOption.IsSet)
                if (customerPostDto.ContactGroupIdsOption.Value != null)
                {
                    writer.WritePropertyName("ContactGroupIds");
                    JsonSerializer.Serialize(writer, customerPostDto.ContactGroupIds, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("ContactGroupIds");
            if (customerPostDto.CurrencyCodeOption.IsSet)
                if (customerPostDto.CurrencyCodeOption.Value != null)
                    writer.WriteString("CurrencyCode", customerPostDto.CurrencyCode);
                else
                    writer.WriteNull("CurrencyCode");

            if (customerPostDto.CustomerSinceOption.IsSet)
                if (customerPostDto.CustomerSinceOption.Value != null)
                    writer.WriteString("CustomerSince", customerPostDto.CustomerSinceOption.Value!.Value.ToString(CustomerSinceFormat));
                else
                    writer.WriteNull("CustomerSince");

            if (customerPostDto.DateOfBirthOption.IsSet)
                if (customerPostDto.DateOfBirthOption.Value != null)
                    writer.WriteString("DateOfBirth", customerPostDto.DateOfBirthOption.Value!.Value.ToString(DateOfBirthFormat));
                else
                    writer.WriteNull("DateOfBirth");

            if (customerPostDto.DeliveryTermOption.IsSet)
                if (customerPostDto.DeliveryTermOption.Value != null)
                    writer.WriteString("DeliveryTerm", customerPostDto.DeliveryTerm);
                else
                    writer.WriteNull("DeliveryTerm");

            if (customerPostDto.DeliveryTermIdOption.IsSet)
                if (customerPostDto.DeliveryTermIdOption.Value != null)
                    writer.WriteNumber("DeliveryTermId", customerPostDto.DeliveryTermIdOption.Value!.Value);
                else
                    writer.WriteNull("DeliveryTermId");

            if (customerPostDto.DepartmentCodeOption.IsSet)
                if (customerPostDto.DepartmentCodeOption.Value != null)
                    writer.WriteString("DepartmentCode", customerPostDto.DepartmentCode);
                else
                    writer.WriteNull("DepartmentCode");

            if (customerPostDto.DepartmentIdOption.IsSet)
                if (customerPostDto.DepartmentIdOption.Value != null)
                    writer.WriteNumber("DepartmentId", customerPostDto.DepartmentIdOption.Value!.Value);
                else
                    writer.WriteNull("DepartmentId");

            if (customerPostDto.DoNotAddLatePaymentFeesOption.IsSet)
                if (customerPostDto.DoNotAddLatePaymentFeesOption.Value != null)
                    writer.WriteBoolean("DoNotAddLatePaymentFees", customerPostDto.DoNotAddLatePaymentFeesOption.Value!.Value);
                else
                    writer.WriteNull("DoNotAddLatePaymentFees");

            if (customerPostDto.DoNotAddLatePaymentInterestOption.IsSet)
                if (customerPostDto.DoNotAddLatePaymentInterestOption.Value != null)
                    writer.WriteBoolean("DoNotAddLatePaymentInterest", customerPostDto.DoNotAddLatePaymentInterestOption.Value!.Value);
                else
                    writer.WriteNull("DoNotAddLatePaymentInterest");

            if (customerPostDto.DoNotAutomatePaymentNotificationsOption.IsSet)
                if (customerPostDto.DoNotAutomatePaymentNotificationsOption.Value != null)
                    writer.WriteBoolean("DoNotAutomatePaymentNotifications", customerPostDto.DoNotAutomatePaymentNotificationsOption.Value!.Value);
                else
                    writer.WriteNull("DoNotAutomatePaymentNotifications");

            if (customerPostDto.EmailAddressOption.IsSet)
                if (customerPostDto.EmailAddressOption.Value != null)
                    writer.WriteString("EmailAddress", customerPostDto.EmailAddress);
                else
                    writer.WriteNull("EmailAddress");

            if (customerPostDto.ExternalImportReferenceOption.IsSet)
                if (customerPostDto.ExternalImportReferenceOption.Value != null)
                    writer.WriteString("ExternalImportReference", customerPostDto.ExternalImportReference);
                else
                    writer.WriteNull("ExternalImportReference");

            if (customerPostDto.ExternalNumberOption.IsSet)
                if (customerPostDto.ExternalNumberOption.Value != null)
                    writer.WriteNumber("ExternalNumber", customerPostDto.ExternalNumberOption.Value!.Value);
                else
                    writer.WriteNull("ExternalNumber");

            if (customerPostDto.FirstNameOption.IsSet)
                if (customerPostDto.FirstNameOption.Value != null)
                    writer.WriteString("FirstName", customerPostDto.FirstName);
                else
                    writer.WriteNull("FirstName");

            if (customerPostDto.InvoiceBrandingThemeCodeOption.IsSet)
                if (customerPostDto.InvoiceBrandingThemeCodeOption.Value != null)
                    writer.WriteString("InvoiceBrandingThemeCode", customerPostDto.InvoiceBrandingThemeCode);
                else
                    writer.WriteNull("InvoiceBrandingThemeCode");

            if (customerPostDto.InvoiceBrandingThemeIdOption.IsSet)
                if (customerPostDto.InvoiceBrandingThemeIdOption.Value != null)
                    writer.WriteNumber("InvoiceBrandingThemeId", customerPostDto.InvoiceBrandingThemeIdOption.Value!.Value);
                else
                    writer.WriteNull("InvoiceBrandingThemeId");

            if (customerPostDto.InvoiceDeliveryTypeOption.IsSet)
                if (customerPostDto.InvoiceDeliveryTypeOption!.Value != null)
                {
                    var invoiceDeliveryTypeRawValue = InvoiceDeliveryTypeValueConverter.ToJsonValue(customerPostDto.InvoiceDeliveryTypeOption.Value!.Value);
                    writer.WriteString("InvoiceDeliveryType", invoiceDeliveryTypeRawValue);
                }
                else
                    writer.WriteNull("InvoiceDeliveryType");
            if (customerPostDto.InvoiceEmailAddressOption.IsSet)
                if (customerPostDto.InvoiceEmailAddressOption.Value != null)
                    writer.WriteString("InvoiceEmailAddress", customerPostDto.InvoiceEmailAddress);
                else
                    writer.WriteNull("InvoiceEmailAddress");

            if (customerPostDto.InvoiceEmailAddressCCOption.IsSet)
                if (customerPostDto.InvoiceEmailAddressCCOption.Value != null)
                    writer.WriteString("InvoiceEmailAddressCC", customerPostDto.InvoiceEmailAddressCC);
                else
                    writer.WriteNull("InvoiceEmailAddressCC");

            if (customerPostDto.IsArchivedOption.IsSet)
                if (customerPostDto.IsArchivedOption.Value != null)
                    writer.WriteBoolean("IsArchived", customerPostDto.IsArchivedOption.Value!.Value);
                else
                    writer.WriteNull("IsArchived");

            if (customerPostDto.IsPersonOption.IsSet)
                if (customerPostDto.IsPersonOption.Value != null)
                    writer.WriteBoolean("IsPerson", customerPostDto.IsPersonOption.Value!.Value);
                else
                    writer.WriteNull("IsPerson");

            if (customerPostDto.IsVatFreeOption.IsSet)
                if (customerPostDto.IsVatFreeOption.Value != null)
                    writer.WriteBoolean("IsVatFree", customerPostDto.IsVatFreeOption.Value!.Value);
                else
                    writer.WriteNull("IsVatFree");

            if (customerPostDto.LastNameOption.IsSet)
                if (customerPostDto.LastNameOption.Value != null)
                    writer.WriteString("LastName", customerPostDto.LastName);
                else
                    writer.WriteNull("LastName");

            if (customerPostDto.LegalNameOption.IsSet)
                if (customerPostDto.LegalNameOption.Value != null)
                    writer.WriteString("LegalName", customerPostDto.LegalName);
                else
                    writer.WriteNull("LegalName");

            if (customerPostDto.MailAddressOption.IsSet)
            {
                writer.WritePropertyName("MailAddress");
                JsonSerializer.Serialize(writer, customerPostDto.MailAddress, jsonSerializerOptions);
            }
            if (customerPostDto.NameOption.IsSet)
                if (customerPostDto.NameOption.Value != null)
                    writer.WriteString("Name", customerPostDto.Name);
                else
                    writer.WriteNull("Name");

            if (customerPostDto.NationalIdNumberOption.IsSet)
                if (customerPostDto.NationalIdNumberOption.Value != null)
                    writer.WriteString("NationalIdNumber", customerPostDto.NationalIdNumber);
                else
                    writer.WriteNull("NationalIdNumber");

            if (customerPostDto.NoticeOfDebtCollectionDeliveryTypeOption.IsSet)
                if (customerPostDto.NoticeOfDebtCollectionDeliveryTypeOption!.Value != null)
                {
                    var noticeOfDebtCollectionDeliveryTypeRawValue = NoticeOfDebtCollectionDeliveryTypeValueConverter.ToJsonValue(customerPostDto.NoticeOfDebtCollectionDeliveryTypeOption.Value!.Value);
            ...
            if (customerPostDto.NumberOption.IsSet)
                if (customerPostDto.NumberOption.Value != null)
                    writer.WriteNumber("Number", customerPostDto.NumberOption.Value!.Value);
                else
                    writer.WriteNull("Number");

            if (customerPostDto.OrganizationNumberOption.IsSet)
                if (customerPostDto.OrganizationNumberOption.Value != null)
                    writer.WriteString("OrganizationNumber", customerPostDto.OrganizationNumber);
                else
                    writer.WriteNull("OrganizationNumber");

            if (customerPostDto.PaymentReminderEmailAddressOption.IsSet)
                if (customerPostDto.PaymentReminderEmailAddressOption.Value != null)
                    writer.WriteString("PaymentReminderEmailAddress", customerPostDto.PaymentReminderEmailAddress);
                else
                    writer.WriteNull("PaymentReminderEmailAddress");

            if (customerPostDto.PaymentTermOption.IsSet)
                if (customerPostDto.PaymentTermOption.Value != null)
                    writer.WriteNumber("PaymentTerm", customerPostDto.PaymentTermOption.Value!.Value);
                else
                    writer.WriteNull("PaymentTerm");

            if (customerPostDto.PaymentTermIdOption.IsSet)
                if (customerPostDto.PaymentTermIdOption.Value != null)
                    writer.WriteNumber("PaymentTermId", customerPostDto.PaymentTermIdOption.Value!.Value);
                else
                    writer.WriteNull("PaymentTermId");

            if (customerPostDto.PhoneNumberOption.IsSet)
                if (customerPostDto.PhoneNumberOption.Value != null)
                    writer.WriteString("PhoneNumber", customerPostDto.PhoneNumber);
                else
                    writer.WriteNull("PhoneNumber");

            if (customerPostDto.ReminderDeliveryTypeOption.IsSet)
                if (customerPostDto.ReminderDeliveryTypeOption!.Value != null)
                {
                    var reminderDeliveryTypeRawValue = ReminderDeliveryTypeValueConverter.ToJsonValue(customerPostDto.ReminderDeliveryTypeOption.Value!.Value);
                    writer.WriteString("ReminderDeliveryType", reminderDeliveryTypeRawValue);
                }
                else
                    writer.WriteNull("ReminderDeliveryType");
            if (customerPostDto.SalesPersonEmployeeIdOption.IsSet)
                if (customerPostDto.SalesPersonEmployeeIdOption.Value != null)
                    writer.WriteNumber("SalesPersonEmployeeId", customerPostDto.SalesPersonEmployeeIdOption.Value!.Value);
                else
                    writer.WriteNull("SalesPersonEmployeeId");

            if (customerPostDto.SalesPersonEmployeeNumberOption.IsSet)
                if (customerPostDto.SalesPersonEmployeeNumberOption.Value != null)
                    writer.WriteNumber("SalesPersonEmployeeNumber", customerPostDto.SalesPersonEmployeeNumberOption.Value!.Value);
                else
                    writer.WriteNull("SalesPersonEmployeeNumber");

            if (customerPostDto.SendPaymentRemindersOption.IsSet)
                if (customerPostDto.SendPaymentRemindersOption.Value != null)
                    writer.WriteBoolean("SendPaymentReminders", customerPostDto.SendPaymentRemindersOption.Value!.Value);
                else
                    writer.WriteNull("SendPaymentReminders");

            if (customerPostDto.SubLedgerNumberSeriesIdOption.IsSet)
                if (customerPostDto.SubLedgerNumberSeriesIdOption.Value != null)
                    writer.WriteString("SubLedgerNumberSeriesId", customerPostDto.SubLedgerNumberSeriesIdOption.Value!.Value);
                else
                    writer.WriteNull("SubLedgerNumberSeriesId");

            if (customerPostDto.TransferToDebtCollectionAgencyOption.IsSet)
                if (customerPostDto.TransferToDebtCollectionAgencyOption.Value != null)
                    writer.WriteBoolean("TransferToDebtCollectionAgency", customerPostDto.TransferToDebtCollectionAgencyOption.Value!.Value);
                else
                    writer.WriteNull("TransferToDebtCollectionAgency");

            if (customerPostDto.UseInvoiceFeeOption.IsSet)
                if (customerPostDto.UseInvoiceFeeOption.Value != null)
                    writer.WriteBoolean("UseInvoiceFee", customerPostDto.UseInvoiceFeeOption.Value!.Value);
                else
                    writer.WriteNull("UseInvoiceFee");

            if (customerPostDto.WebsiteUrlOption.IsSet)
                if (customerPostDto.WebsiteUrlOption.Value != null)
                    writer.WriteString("WebsiteUrl", customerPostDto.WebsiteUrl);
                else
