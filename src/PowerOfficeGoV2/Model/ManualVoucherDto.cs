...
namespace PowerOfficeGoV2.Model
{
    ...
    public partial class ManualVoucherDto : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ManualVoucherDto(Option<DateTime?> createdDateTimeOffset = default, Option<string?> currencyCode = default, Option<string?> description = default, Option<string?> externalImportReference = default, Option<Guid?> id = default, Option<long?> importedVoucherNo = default, Option<bool?> isReversed = default, Option<string?> saftBatchId = default, Option<string?> saftSourceId = default, Option<DateOnly?> voucherDate = default, Option<List<ManualVoucherLineDto>?> voucherLines = default, Option<long?> voucherNo = default)
        {
