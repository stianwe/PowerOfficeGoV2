...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class ManualVoucherDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManualVoucherDto" /> class.
        /// </summary>
        ...
        /// <param name="voucherLines">The lines of the manual voucher</param>
        ...
        [JsonConstructor]
        public ManualVoucherDto(Option<DateTimeOffset?> createdDateTimeOffset = default, Option<string?> currencyCode = default, Option<string?> description = default, Option<string?> externalImportReference = default, Option<Guid?> id = default, Option<long?> importedVoucherNo = default, Option<bool?> isReversed = default, Option<string?> saftBatchId = default, Option<string?> saftSourceId = default, Option<DateTimeOffset?> voucherDate = default, Option<List<ManualVoucherLineDto>?> voucherLines = default, Option<long?> voucherNo = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<ManualVoucherLineDto>?> VoucherLinesOption { get; private set; }
        ...
        public List<ManualVoucherLineDto>? VoucherLines { get { return this.VoucherLinesOption; } set { this.VoucherLinesOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ManualVoucherDto {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ManualVoucherDto" />
    /// </summary>
    public class ManualVoucherDtoJsonConverter : JsonConverter<ManualVoucherDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="ManualVoucherDto" />
        /// </summary>
        ...
        public override ManualVoucherDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<ManualVoucherLineDto>?> voucherLines = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "VoucherLines":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                voucherLines = new Option<List<ManualVoucherLineDto>?>(JsonSerializer.Deserialize<List<ManualVoucherLineDto>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "VoucherNo":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (createdDateTimeOffset.IsSet && createdDateTimeOffset.Value == null)
                throw new ArgumentNullException(nameof(createdDateTimeOffset), "Property is not nullable for class ManualVoucherDto.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class ManualVoucherDto.");

            if (voucherDate.IsSet && voucherDate.Value == null)
                throw new ArgumentNullException(nameof(voucherDate), "Property is not nullable for class ManualVoucherDto.");

            if (voucherNo.IsSet && voucherNo.Value == null)
                throw new ArgumentNullException(nameof(voucherNo), "Property is not nullable for class ManualVoucherDto.");

            return new ManualVoucherDto(createdDateTimeOffset, currencyCode, description, externalImportReference, id, importedVoucherNo, isReversed, saftBatchId, saftSourceId, voucherDate, voucherLines, voucherNo);
        }

        /// <summary>
        /// Serializes a <see cref="ManualVoucherDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="manualVoucherDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ManualVoucherDto manualVoucherDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, manualVoucherDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ManualVoucherDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="manualVoucherDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ManualVoucherDto manualVoucherDto, JsonSerializerOptions jsonSerializerOptions)
        {
            if (manualVoucherDto.CreatedDateTimeOffsetOption.IsSet)
                writer.WriteString("CreatedDateTimeOffset", manualVoucherDto.CreatedDateTimeOffsetOption.Value!.Value.ToString(CreatedDateTimeOffsetFormat));

            if (manualVoucherDto.CurrencyCodeOption.IsSet)
                if (manualVoucherDto.CurrencyCodeOption.Value != null)
                    writer.WriteString("CurrencyCode", manualVoucherDto.CurrencyCode);
                else
                    writer.WriteNull("CurrencyCode");

            if (manualVoucherDto.DescriptionOption.IsSet)
                if (manualVoucherDto.DescriptionOption.Value != null)
                    writer.WriteString("Description", manualVoucherDto.Description);
                else
                    writer.WriteNull("Description");

            if (manualVoucherDto.ExternalImportReferenceOption.IsSet)
                if (manualVoucherDto.ExternalImportReferenceOption.Value != null)
                    writer.WriteString("ExternalImportReference", manualVoucherDto.ExternalImportReference);
                else
                    writer.WriteNull("ExternalImportReference");

            if (manualVoucherDto.IdOption.IsSet)
                writer.WriteString("Id", manualVoucherDto.IdOption.Value!.Value);

            if (manualVoucherDto.ImportedVoucherNoOption.IsSet)
                if (manualVoucherDto.ImportedVoucherNoOption.Value != null)
                    writer.WriteNumber("ImportedVoucherNo", manualVoucherDto.ImportedVoucherNoOption.Value!.Value);
                else
                    writer.WriteNull("ImportedVoucherNo");

            if (manualVoucherDto.IsReversedOption.IsSet)
                if (manualVoucherDto.IsReversedOption.Value != null)
                    writer.WriteBoolean("IsReversed", manualVoucherDto.IsReversedOption.Value!.Value);
                else
                    writer.WriteNull("IsReversed");

            if (manualVoucherDto.SaftBatchIdOption.IsSet)
                if (manualVoucherDto.SaftBatchIdOption.Value != null)
                    writer.WriteString("SaftBatchId", manualVoucherDto.SaftBatchId);
                else
                    writer.WriteNull("SaftBatchId");

            if (manualVoucherDto.SaftSourceIdOption.IsSet)
                if (manualVoucherDto.SaftSourceIdOption.Value != null)
                    writer.WriteString("SaftSourceId", manualVoucherDto.SaftSourceId);
                else
                    writer.WriteNull("SaftSourceId");

            if (manualVoucherDto.VoucherDateOption.IsSet)
                writer.WriteString("VoucherDate", manualVoucherDto.VoucherDateOption.Value!.Value.ToString(VoucherDateFormat));

            if (manualVoucherDto.VoucherLinesOption.IsSet)
                if (manualVoucherDto.VoucherLinesOption.Value != null)
                {
                    writer.WritePropertyName("VoucherLines");
                    JsonSerializer.Serialize(writer, manualVoucherDto.VoucherLines, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("VoucherLines");
            if (manualVoucherDto.VoucherNoOption.IsSet)
                writer.WriteNumber("VoucherNo", manualVoucherDto.VoucherNoOption.Value!.Value);
        }
    }
}
