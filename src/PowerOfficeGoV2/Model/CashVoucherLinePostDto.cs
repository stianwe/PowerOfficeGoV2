...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class CashVoucherLinePostDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CashVoucherLinePostDto" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CashVoucherLinePostDto {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="CashVoucherLinePostDto" />
    /// </summary>
    public class CashVoucherLinePostDtoJsonConverter : JsonConverter<CashVoucherLinePostDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="CashVoucherLinePostDto" />
        /// </summary>
        ...
        public override CashVoucherLinePostDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!postingDate.IsSet)
                throw new ArgumentException("Property is required for class CashVoucherLinePostDto.", nameof(postingDate));

            if (!accountId.IsSet)
                throw new ArgumentException("Property is required for class CashVoucherLinePostDto.", nameof(accountId));

            if (!vatId.IsSet)
                throw new ArgumentException("Property is required for class CashVoucherLinePostDto.", nameof(vatId));

            if (postingDate.IsSet && postingDate.Value == null)
                throw new ArgumentNullException(nameof(postingDate), "Property is not nullable for class CashVoucherLinePostDto.");

            if (currencyAmount.IsSet && currencyAmount.Value == null)
                throw new ArgumentNullException(nameof(currencyAmount), "Property is not nullable for class CashVoucherLinePostDto.");

            return new CashVoucherLinePostDto(postingDate.Value!.Value!, accountId.Value!, currencyAmount, currencyCode, currencyExchangeRate, customMatchingReference, departmentId, description, dim1Id, dim2Id, dim3Id, externalLineReference, locationId, productId, projectId, quantity, quantity2, vatId.Value!, vatReturnSpecification);
        }

        /// <summary>
        /// Serializes a <see cref="CashVoucherLinePostDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="cashVoucherLinePostDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CashVoucherLinePostDto cashVoucherLinePostDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, cashVoucherLinePostDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CashVoucherLinePostDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="cashVoucherLinePostDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CashVoucherLinePostDto cashVoucherLinePostDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteString("PostingDate", cashVoucherLinePostDto.PostingDate.ToString(PostingDateFormat));

            if (cashVoucherLinePostDto.AccountId != null)
                writer.WriteNumber("AccountId", cashVoucherLinePostDto.AccountId.Value);
            else
                writer.WriteNull("AccountId");

            if (cashVoucherLinePostDto.CurrencyAmountOption.IsSet)
                writer.WriteNumber("CurrencyAmount", cashVoucherLinePostDto.CurrencyAmountOption.Value!.Value);

            if (cashVoucherLinePostDto.CurrencyCodeOption.IsSet)
                if (cashVoucherLinePostDto.CurrencyCodeOption.Value != null)
                    writer.WriteString("CurrencyCode", cashVoucherLinePostDto.CurrencyCode);
                else
                    writer.WriteNull("CurrencyCode");

            if (cashVoucherLinePostDto.CurrencyExchangeRateOption.IsSet)
                if (cashVoucherLinePostDto.CurrencyExchangeRateOption.Value != null)
                    writer.WriteNumber("CurrencyExchangeRate", cashVoucherLinePostDto.CurrencyExchangeRateOption.Value!.Value);
                else
                    writer.WriteNull("CurrencyExchangeRate");

            if (cashVoucherLinePostDto.CustomMatchingReferenceOption.IsSet)
                if (cashVoucherLinePostDto.CustomMatchingReferenceOption.Value != null)
                    writer.WriteString("CustomMatchingReference", cashVoucherLinePostDto.CustomMatchingReference);
                else
                    writer.WriteNull("CustomMatchingReference");

            if (cashVoucherLinePostDto.DepartmentIdOption.IsSet)
                if (cashVoucherLinePostDto.DepartmentIdOption.Value != null)
                    writer.WriteNumber("DepartmentId", cashVoucherLinePostDto.DepartmentIdOption.Value!.Value);
                else
                    writer.WriteNull("DepartmentId");

            if (cashVoucherLinePostDto.DescriptionOption.IsSet)
                if (cashVoucherLinePostDto.DescriptionOption.Value != null)
                    writer.WriteString("Description", cashVoucherLinePostDto.Description);
                else
                    writer.WriteNull("Description");

            if (cashVoucherLinePostDto.Dim1IdOption.IsSet)
                if (cashVoucherLinePostDto.Dim1IdOption.Value != null)
                    writer.WriteNumber("Dim1Id", cashVoucherLinePostDto.Dim1IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim1Id");

            if (cashVoucherLinePostDto.Dim2IdOption.IsSet)
                if (cashVoucherLinePostDto.Dim2IdOption.Value != null)
                    writer.WriteNumber("Dim2Id", cashVoucherLinePostDto.Dim2IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim2Id");

            if (cashVoucherLinePostDto.Dim3IdOption.IsSet)
                if (cashVoucherLinePostDto.Dim3IdOption.Value != null)
                    writer.WriteNumber("Dim3Id", cashVoucherLinePostDto.Dim3IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim3Id");

            if (cashVoucherLinePostDto.ExternalLineReferenceOption.IsSet)
                if (cashVoucherLinePostDto.ExternalLineReferenceOption.Value != null)
                    writer.WriteString("ExternalLineReference", cashVoucherLinePostDto.ExternalLineReference);
                else
                    writer.WriteNull("ExternalLineReference");

            if (cashVoucherLinePostDto.LocationIdOption.IsSet)
                if (cashVoucherLinePostDto.LocationIdOption.Value != null)
                    writer.WriteNumber("LocationId", cashVoucherLinePostDto.LocationIdOption.Value!.Value);
                else
                    writer.WriteNull("LocationId");

            if (cashVoucherLinePostDto.ProductIdOption.IsSet)
                if (cashVoucherLinePostDto.ProductIdOption.Value != null)
                    writer.WriteNumber("ProductId", cashVoucherLinePostDto.ProductIdOption.Value!.Value);
                else
                    writer.WriteNull("ProductId");

            if (cashVoucherLinePostDto.ProjectIdOption.IsSet)
                if (cashVoucherLinePostDto.ProjectIdOption.Value != null)
                    writer.WriteNumber("ProjectId", cashVoucherLinePostDto.ProjectIdOption.Value!.Value);
                else
                    writer.WriteNull("ProjectId");

            if (cashVoucherLinePostDto.QuantityOption.IsSet)
                if (cashVoucherLinePostDto.QuantityOption.Value != null)
                    writer.WriteNumber("Quantity", cashVoucherLinePostDto.QuantityOption.Value!.Value);
                else
                    writer.WriteNull("Quantity");

            if (cashVoucherLinePostDto.Quantity2Option.IsSet)
                if (cashVoucherLinePostDto.Quantity2Option.Value != null)
                    writer.WriteNumber("Quantity2", cashVoucherLinePostDto.Quantity2Option.Value!.Value);
                else
                    writer.WriteNull("Quantity2");

            if (cashVoucherLinePostDto.VatId != null)
                writer.WriteNumber("VatId", cashVoucherLinePostDto.VatId.Value);
            else
                writer.WriteNull("VatId");

            if (cashVoucherLinePostDto.VatReturnSpecificationOption.IsSet)
                if (cashVoucherLinePostDto.VatReturnSpecificationOption!.Value != null)
                {
                    var vatReturnSpecificationRawValue = VatReturnSpecificationValueConverter.ToJsonValue(cashVoucherLinePostDto.VatReturnSpecificationOption.Value!.Value);
