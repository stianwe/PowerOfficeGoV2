...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class BankVoucherLinePostDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BankVoucherLinePostDto" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public BankVoucherLinePostDto(DateTimeOffset postingDate, long? accountId = default, Option<string?> cid = default, Option<double?> currencyAmount = default, Option<string?> currencyCode = default, Option<double?> currencyExchangeRate = default, Option<string?> customMatchingReference = default, Option<long?> departmentId = default, Option<string?> description = default, Option<long?> dim1Id = default, Option<long?> dim2Id = default, Option<long?> dim3Id = default, Option<string?> externalLineReference = default, Option<string?> invoiceNo = default, Option<long?> locationId = default, Option<long?> productId = default, Option<long?> projectId = default, Option<double?> quantity = default, Option<double?> quantity2 = default, int? vatId = default, Option<VatReturnSpecification?> vatReturnSpecification = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BankVoucherLinePostDto {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="BankVoucherLinePostDto" />
    /// </summary>
    public class BankVoucherLinePostDtoJsonConverter : JsonConverter<BankVoucherLinePostDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="BankVoucherLinePostDto" />
        /// </summary>
        ...
        public override BankVoucherLinePostDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!postingDate.IsSet)
                throw new ArgumentException("Property is required for class BankVoucherLinePostDto.", nameof(postingDate));

            if (!accountId.IsSet)
                throw new ArgumentException("Property is required for class BankVoucherLinePostDto.", nameof(accountId));

            if (!vatId.IsSet)
                throw new ArgumentException("Property is required for class BankVoucherLinePostDto.", nameof(vatId));

            if (postingDate.IsSet && postingDate.Value == null)
                throw new ArgumentNullException(nameof(postingDate), "Property is not nullable for class BankVoucherLinePostDto.");

            if (currencyAmount.IsSet && currencyAmount.Value == null)
                throw new ArgumentNullException(nameof(currencyAmount), "Property is not nullable for class BankVoucherLinePostDto.");

            return new BankVoucherLinePostDto(postingDate.Value!.Value!, accountId.Value!, cid, currencyAmount, currencyCode, currencyExchangeRate, customMatchingReference, departmentId, description, dim1Id, dim2Id, dim3Id, externalLineReference, invoiceNo, locationId, productId, projectId, quantity, quantity2, vatId.Value!, vatReturnSpecification);
        }

        /// <summary>
        /// Serializes a <see cref="BankVoucherLinePostDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="bankVoucherLinePostDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BankVoucherLinePostDto bankVoucherLinePostDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, bankVoucherLinePostDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="BankVoucherLinePostDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="bankVoucherLinePostDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BankVoucherLinePostDto bankVoucherLinePostDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteString("PostingDate", bankVoucherLinePostDto.PostingDate.ToString(PostingDateFormat));

            if (bankVoucherLinePostDto.AccountId != null)
                writer.WriteNumber("AccountId", bankVoucherLinePostDto.AccountId.Value);
            else
                writer.WriteNull("AccountId");

            if (bankVoucherLinePostDto.CidOption.IsSet)
                if (bankVoucherLinePostDto.CidOption.Value != null)
                    writer.WriteString("Cid", bankVoucherLinePostDto.Cid);
                else
                    writer.WriteNull("Cid");

            if (bankVoucherLinePostDto.CurrencyAmountOption.IsSet)
                writer.WriteNumber("CurrencyAmount", bankVoucherLinePostDto.CurrencyAmountOption.Value!.Value);

            if (bankVoucherLinePostDto.CurrencyCodeOption.IsSet)
                if (bankVoucherLinePostDto.CurrencyCodeOption.Value != null)
                    writer.WriteString("CurrencyCode", bankVoucherLinePostDto.CurrencyCode);
                else
                    writer.WriteNull("CurrencyCode");

            if (bankVoucherLinePostDto.CurrencyExchangeRateOption.IsSet)
                if (bankVoucherLinePostDto.CurrencyExchangeRateOption.Value != null)
                    writer.WriteNumber("CurrencyExchangeRate", bankVoucherLinePostDto.CurrencyExchangeRateOption.Value!.Value);
                else
                    writer.WriteNull("CurrencyExchangeRate");

            if (bankVoucherLinePostDto.CustomMatchingReferenceOption.IsSet)
                if (bankVoucherLinePostDto.CustomMatchingReferenceOption.Value != null)
                    writer.WriteString("CustomMatchingReference", bankVoucherLinePostDto.CustomMatchingReference);
                else
                    writer.WriteNull("CustomMatchingReference");

            if (bankVoucherLinePostDto.DepartmentIdOption.IsSet)
                if (bankVoucherLinePostDto.DepartmentIdOption.Value != null)
                    writer.WriteNumber("DepartmentId", bankVoucherLinePostDto.DepartmentIdOption.Value!.Value);
                else
                    writer.WriteNull("DepartmentId");

            if (bankVoucherLinePostDto.DescriptionOption.IsSet)
                if (bankVoucherLinePostDto.DescriptionOption.Value != null)
                    writer.WriteString("Description", bankVoucherLinePostDto.Description);
                else
                    writer.WriteNull("Description");

            if (bankVoucherLinePostDto.Dim1IdOption.IsSet)
                if (bankVoucherLinePostDto.Dim1IdOption.Value != null)
                    writer.WriteNumber("Dim1Id", bankVoucherLinePostDto.Dim1IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim1Id");

            if (bankVoucherLinePostDto.Dim2IdOption.IsSet)
                if (bankVoucherLinePostDto.Dim2IdOption.Value != null)
                    writer.WriteNumber("Dim2Id", bankVoucherLinePostDto.Dim2IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim2Id");

            if (bankVoucherLinePostDto.Dim3IdOption.IsSet)
                if (bankVoucherLinePostDto.Dim3IdOption.Value != null)
                    writer.WriteNumber("Dim3Id", bankVoucherLinePostDto.Dim3IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim3Id");

            if (bankVoucherLinePostDto.ExternalLineReferenceOption.IsSet)
                if (bankVoucherLinePostDto.ExternalLineReferenceOption.Value != null)
                    writer.WriteString("ExternalLineReference", bankVoucherLinePostDto.ExternalLineReference);
                else
                    writer.WriteNull("ExternalLineReference");

            if (bankVoucherLinePostDto.InvoiceNoOption.IsSet)
                if (bankVoucherLinePostDto.InvoiceNoOption.Value != null)
                    writer.WriteString("InvoiceNo", bankVoucherLinePostDto.InvoiceNo);
                else
                    writer.WriteNull("InvoiceNo");

            if (bankVoucherLinePostDto.LocationIdOption.IsSet)
                if (bankVoucherLinePostDto.LocationIdOption.Value != null)
                    writer.WriteNumber("LocationId", bankVoucherLinePostDto.LocationIdOption.Value!.Value);
                else
                    writer.WriteNull("LocationId");

            if (bankVoucherLinePostDto.ProductIdOption.IsSet)
                if (bankVoucherLinePostDto.ProductIdOption.Value != null)
                    writer.WriteNumber("ProductId", bankVoucherLinePostDto.ProductIdOption.Value!.Value);
                else
                    writer.WriteNull("ProductId");

            if (bankVoucherLinePostDto.ProjectIdOption.IsSet)
                if (bankVoucherLinePostDto.ProjectIdOption.Value != null)
                    writer.WriteNumber("ProjectId", bankVoucherLinePostDto.ProjectIdOption.Value!.Value);
                else
                    writer.WriteNull("ProjectId");

            if (bankVoucherLinePostDto.QuantityOption.IsSet)
                if (bankVoucherLinePostDto.QuantityOption.Value != null)
                    writer.WriteNumber("Quantity", bankVoucherLinePostDto.QuantityOption.Value!.Value);
                else
                    writer.WriteNull("Quantity");

            if (bankVoucherLinePostDto.Quantity2Option.IsSet)
                if (bankVoucherLinePostDto.Quantity2Option.Value != null)
                    writer.WriteNumber("Quantity2", bankVoucherLinePostDto.Quantity2Option.Value!.Value);
                else
                    writer.WriteNull("Quantity2");

            if (bankVoucherLinePostDto.VatId != null)
                writer.WriteNumber("VatId", bankVoucherLinePostDto.VatId.Value);
            else
                writer.WriteNull("VatId");

            if (bankVoucherLinePostDto.VatReturnSpecificationOption.IsSet)
                if (bankVoucherLinePostDto.VatReturnSpecificationOption!.Value != null)
                {
                    var vatReturnSpecificationRawValue = VatReturnSpecificationValueConverter.ToJsonValue(bankVoucherLinePostDto.VatReturnSpecificationOption.Value!.Value);
