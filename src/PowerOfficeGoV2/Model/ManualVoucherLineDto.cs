...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class ManualVoucherLineDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManualVoucherLineDto" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ManualVoucherLineDto {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ManualVoucherLineDto" />
    /// </summary>
    public class ManualVoucherLineDtoJsonConverter : JsonConverter<ManualVoucherLineDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="ManualVoucherLineDto" />
        /// </summary>
        ...
        public override ManualVoucherLineDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!postingDate.IsSet)
                throw new ArgumentException("Property is required for class ManualVoucherLineDto.", nameof(postingDate));

            if (postingDate.IsSet && postingDate.Value == null)
                throw new ArgumentNullException(nameof(postingDate), "Property is not nullable for class ManualVoucherLineDto.");

            if (createdDateTimeOffset.IsSet && createdDateTimeOffset.Value == null)
                throw new ArgumentNullException(nameof(createdDateTimeOffset), "Property is not nullable for class ManualVoucherLineDto.");

            if (currencyAmount.IsSet && currencyAmount.Value == null)
                throw new ArgumentNullException(nameof(currencyAmount), "Property is not nullable for class ManualVoucherLineDto.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class ManualVoucherLineDto.");

            return new ManualVoucherLineDto(postingDate.Value!.Value!, accountId, createdDateTimeOffset, currencyAmount, currencyCode, currencyExchangeRate, customMatchingReference, departmentId, description, dim1Id, dim2Id, dim3Id, externalLineReference, id, locationId, productId, projectId, quantity, quantity2, vatId, vatReturnSpecification);
        }

        /// <summary>
        /// Serializes a <see cref="ManualVoucherLineDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="manualVoucherLineDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ManualVoucherLineDto manualVoucherLineDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, manualVoucherLineDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ManualVoucherLineDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="manualVoucherLineDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ManualVoucherLineDto manualVoucherLineDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteString("PostingDate", manualVoucherLineDto.PostingDate.ToString(PostingDateFormat));

            if (manualVoucherLineDto.AccountIdOption.IsSet)
                if (manualVoucherLineDto.AccountIdOption.Value != null)
                    writer.WriteNumber("AccountId", manualVoucherLineDto.AccountIdOption.Value!.Value);
                else
                    writer.WriteNull("AccountId");

            if (manualVoucherLineDto.CreatedDateTimeOffsetOption.IsSet)
                writer.WriteString("CreatedDateTimeOffset", manualVoucherLineDto.CreatedDateTimeOffsetOption.Value!.Value.ToString(CreatedDateTimeOffsetFormat));

            if (manualVoucherLineDto.CurrencyAmountOption.IsSet)
                writer.WriteNumber("CurrencyAmount", manualVoucherLineDto.CurrencyAmountOption.Value!.Value);

            if (manualVoucherLineDto.CurrencyCodeOption.IsSet)
                if (manualVoucherLineDto.CurrencyCodeOption.Value != null)
                    writer.WriteString("CurrencyCode", manualVoucherLineDto.CurrencyCode);
                else
                    writer.WriteNull("CurrencyCode");

            if (manualVoucherLineDto.CurrencyExchangeRateOption.IsSet)
                if (manualVoucherLineDto.CurrencyExchangeRateOption.Value != null)
                    writer.WriteNumber("CurrencyExchangeRate", manualVoucherLineDto.CurrencyExchangeRateOption.Value!.Value);
                else
                    writer.WriteNull("CurrencyExchangeRate");

            if (manualVoucherLineDto.CustomMatchingReferenceOption.IsSet)
                if (manualVoucherLineDto.CustomMatchingReferenceOption.Value != null)
                    writer.WriteString("CustomMatchingReference", manualVoucherLineDto.CustomMatchingReference);
                else
                    writer.WriteNull("CustomMatchingReference");

            if (manualVoucherLineDto.DepartmentIdOption.IsSet)
                if (manualVoucherLineDto.DepartmentIdOption.Value != null)
                    writer.WriteNumber("DepartmentId", manualVoucherLineDto.DepartmentIdOption.Value!.Value);
                else
                    writer.WriteNull("DepartmentId");

            if (manualVoucherLineDto.DescriptionOption.IsSet)
                if (manualVoucherLineDto.DescriptionOption.Value != null)
                    writer.WriteString("Description", manualVoucherLineDto.Description);
                else
                    writer.WriteNull("Description");

            if (manualVoucherLineDto.Dim1IdOption.IsSet)
                if (manualVoucherLineDto.Dim1IdOption.Value != null)
                    writer.WriteNumber("Dim1Id", manualVoucherLineDto.Dim1IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim1Id");

            if (manualVoucherLineDto.Dim2IdOption.IsSet)
                if (manualVoucherLineDto.Dim2IdOption.Value != null)
                    writer.WriteNumber("Dim2Id", manualVoucherLineDto.Dim2IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim2Id");

            if (manualVoucherLineDto.Dim3IdOption.IsSet)
                if (manualVoucherLineDto.Dim3IdOption.Value != null)
                    writer.WriteNumber("Dim3Id", manualVoucherLineDto.Dim3IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim3Id");

            if (manualVoucherLineDto.ExternalLineReferenceOption.IsSet)
                if (manualVoucherLineDto.ExternalLineReferenceOption.Value != null)
                    writer.WriteString("ExternalLineReference", manualVoucherLineDto.ExternalLineReference);
                else
                    writer.WriteNull("ExternalLineReference");

            if (manualVoucherLineDto.IdOption.IsSet)
                writer.WriteNumber("Id", manualVoucherLineDto.IdOption.Value!.Value);

            if (manualVoucherLineDto.LocationIdOption.IsSet)
                if (manualVoucherLineDto.LocationIdOption.Value != null)
                    writer.WriteNumber("LocationId", manualVoucherLineDto.LocationIdOption.Value!.Value);
                else
                    writer.WriteNull("LocationId");

            if (manualVoucherLineDto.ProductIdOption.IsSet)
                if (manualVoucherLineDto.ProductIdOption.Value != null)
                    writer.WriteNumber("ProductId", manualVoucherLineDto.ProductIdOption.Value!.Value);
                else
                    writer.WriteNull("ProductId");

            if (manualVoucherLineDto.ProjectIdOption.IsSet)
                if (manualVoucherLineDto.ProjectIdOption.Value != null)
                    writer.WriteNumber("ProjectId", manualVoucherLineDto.ProjectIdOption.Value!.Value);
                else
                    writer.WriteNull("ProjectId");

            if (manualVoucherLineDto.QuantityOption.IsSet)
                if (manualVoucherLineDto.QuantityOption.Value != null)
                    writer.WriteNumber("Quantity", manualVoucherLineDto.QuantityOption.Value!.Value);
                else
                    writer.WriteNull("Quantity");

            if (manualVoucherLineDto.Quantity2Option.IsSet)
                if (manualVoucherLineDto.Quantity2Option.Value != null)
                    writer.WriteNumber("Quantity2", manualVoucherLineDto.Quantity2Option.Value!.Value);
                else
                    writer.WriteNull("Quantity2");

            if (manualVoucherLineDto.VatIdOption.IsSet)
                if (manualVoucherLineDto.VatIdOption.Value != null)
                    writer.WriteNumber("VatId", manualVoucherLineDto.VatIdOption.Value!.Value);
                else
                    writer.WriteNull("VatId");

            if (manualVoucherLineDto.VatReturnSpecificationOption.IsSet)
                if (manualVoucherLineDto.VatReturnSpecificationOption!.Value != null)
                {
                    var vatReturnSpecificationRawValue = VatReturnSpecificationValueConverter.ToJsonValue(manualVoucherLineDto.VatReturnSpecificationOption.Value!.Value);
