...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class YearEndVoucherDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="YearEndVoucherDto" /> class.
        /// </summary>
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<YearEndVoucherLineDto>?> VoucherLinesOption { get; private set; }
        ...
        public List<YearEndVoucherLineDto>? VoucherLines { get { return this.VoucherLinesOption; } set { this.VoucherLinesOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class YearEndVoucherDto {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="YearEndVoucherDto" />
    /// </summary>
    public class YearEndVoucherDtoJsonConverter : JsonConverter<YearEndVoucherDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="YearEndVoucherDto" />
        /// </summary>
        ...
        public override YearEndVoucherDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "VoucherLines":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                voucherLines = new Option<List<YearEndVoucherLineDto>?>(JsonSerializer.Deserialize<List<YearEndVoucherLineDto>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "VoucherNo":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (createdDateTimeOffset.IsSet && createdDateTimeOffset.Value == null)
                throw new ArgumentNullException(nameof(createdDateTimeOffset), "Property is not nullable for class YearEndVoucherDto.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class YearEndVoucherDto.");

            if (voucherDate.IsSet && voucherDate.Value == null)
                throw new ArgumentNullException(nameof(voucherDate), "Property is not nullable for class YearEndVoucherDto.");

            if (voucherNo.IsSet && voucherNo.Value == null)
                throw new ArgumentNullException(nameof(voucherNo), "Property is not nullable for class YearEndVoucherDto.");

            return new YearEndVoucherDto(createdDateTimeOffset, currencyCode, description, externalImportReference, id, importedVoucherNo, isReversed, saftBatchId, saftSourceId, voucherDate, voucherLines, voucherNo);
        }

        /// <summary>
        /// Serializes a <see cref="YearEndVoucherDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="yearEndVoucherDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, YearEndVoucherDto yearEndVoucherDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, yearEndVoucherDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="YearEndVoucherDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="yearEndVoucherDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, YearEndVoucherDto yearEndVoucherDto, JsonSerializerOptions jsonSerializerOptions)
        {
            if (yearEndVoucherDto.CreatedDateTimeOffsetOption.IsSet)
                writer.WriteString("CreatedDateTimeOffset", yearEndVoucherDto.CreatedDateTimeOffsetOption.Value!.Value.ToString(CreatedDateTimeOffsetFormat));

            if (yearEndVoucherDto.CurrencyCodeOption.IsSet)
                if (yearEndVoucherDto.CurrencyCodeOption.Value != null)
                    writer.WriteString("CurrencyCode", yearEndVoucherDto.CurrencyCode);
                else
                    writer.WriteNull("CurrencyCode");

            if (yearEndVoucherDto.DescriptionOption.IsSet)
                if (yearEndVoucherDto.DescriptionOption.Value != null)
                    writer.WriteString("Description", yearEndVoucherDto.Description);
                else
                    writer.WriteNull("Description");

            if (yearEndVoucherDto.ExternalImportReferenceOption.IsSet)
                if (yearEndVoucherDto.ExternalImportReferenceOption.Value != null)
                    writer.WriteString("ExternalImportReference", yearEndVoucherDto.ExternalImportReference);
                else
                    writer.WriteNull("ExternalImportReference");

            if (yearEndVoucherDto.IdOption.IsSet)
                writer.WriteString("Id", yearEndVoucherDto.IdOption.Value!.Value);

            if (yearEndVoucherDto.ImportedVoucherNoOption.IsSet)
                if (yearEndVoucherDto.ImportedVoucherNoOption.Value != null)
                    writer.WriteNumber("ImportedVoucherNo", yearEndVoucherDto.ImportedVoucherNoOption.Value!.Value);
                else
                    writer.WriteNull("ImportedVoucherNo");

            if (yearEndVoucherDto.IsReversedOption.IsSet)
                if (yearEndVoucherDto.IsReversedOption.Value != null)
                    writer.WriteBoolean("IsReversed", yearEndVoucherDto.IsReversedOption.Value!.Value);
                else
                    writer.WriteNull("IsReversed");

            if (yearEndVoucherDto.SaftBatchIdOption.IsSet)
                if (yearEndVoucherDto.SaftBatchIdOption.Value != null)
                    writer.WriteString("SaftBatchId", yearEndVoucherDto.SaftBatchId);
                else
                    writer.WriteNull("SaftBatchId");

            if (yearEndVoucherDto.SaftSourceIdOption.IsSet)
                if (yearEndVoucherDto.SaftSourceIdOption.Value != null)
                    writer.WriteString("SaftSourceId", yearEndVoucherDto.SaftSourceId);
                else
                    writer.WriteNull("SaftSourceId");

            if (yearEndVoucherDto.VoucherDateOption.IsSet)
                writer.WriteString("VoucherDate", yearEndVoucherDto.VoucherDateOption.Value!.Value.ToString(VoucherDateFormat));

            if (yearEndVoucherDto.VoucherLinesOption.IsSet)
                if (yearEndVoucherDto.VoucherLinesOption.Value != null)
                {
                    writer.WritePropertyName("VoucherLines");
                    JsonSerializer.Serialize(writer, yearEndVoucherDto.VoucherLines, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("VoucherLines");
            if (yearEndVoucherDto.VoucherNoOption.IsSet)
                writer.WriteNumber("VoucherNo", yearEndVoucherDto.VoucherNoOption.Value!.Value);
        }
    }
}
