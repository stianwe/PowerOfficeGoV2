...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class EmploymentFixedSalaryPostDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmploymentFixedSalaryPostDto" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmploymentFixedSalaryPostDto {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="EmploymentFixedSalaryPostDto" />
    /// </summary>
    public class EmploymentFixedSalaryPostDtoJsonConverter : JsonConverter<EmploymentFixedSalaryPostDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="EmploymentFixedSalaryPostDto" />
        /// </summary>
        ...
        public override EmploymentFixedSalaryPostDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!payItemId.IsSet)
                throw new ArgumentException("Property is required for class EmploymentFixedSalaryPostDto.", nameof(payItemId));

            return new EmploymentFixedSalaryPostDto(accountId, amount, carListPrice, carRegistrationDate, carRegistrationNo, cid, comment, commuterPersonType, deductionType, departmentId, fromDate, homeWorkKilometers, incomeYear, isActive, isCarPool, maxAmount, memberNo, minAmount, number, oppositeAccountId, payItemId.Value!, privateDrivenKilometers, projectId, quantity, rate, startAmount, supplierAccountId, supplierBankAccountId, taxDeduction, taxRule, toDate, useRemittance, vatCodeId, workDriveExceedsKilometerLimit);
        }

        /// <summary>
        /// Serializes a <see cref="EmploymentFixedSalaryPostDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="employmentFixedSalaryPostDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EmploymentFixedSalaryPostDto employmentFixedSalaryPostDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, employmentFixedSalaryPostDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EmploymentFixedSalaryPostDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="employmentFixedSalaryPostDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EmploymentFixedSalaryPostDto employmentFixedSalaryPostDto, JsonSerializerOptions jsonSerializerOptions)
        {
            if (employmentFixedSalaryPostDto.AccountIdOption.IsSet)
                if (employmentFixedSalaryPostDto.AccountIdOption.Value != null)
                    writer.WriteNumber("AccountId", employmentFixedSalaryPostDto.AccountIdOption.Value!.Value);
                else
                    writer.WriteNull("AccountId");

            if (employmentFixedSalaryPostDto.AmountOption.IsSet)
                if (employmentFixedSalaryPostDto.AmountOption.Value != null)
                    writer.WriteNumber("Amount", employmentFixedSalaryPostDto.AmountOption.Value!.Value);
                else
                    writer.WriteNull("Amount");

            if (employmentFixedSalaryPostDto.CarListPriceOption.IsSet)
                if (employmentFixedSalaryPostDto.CarListPriceOption.Value != null)
                    writer.WriteNumber("CarListPrice", employmentFixedSalaryPostDto.CarListPriceOption.Value!.Value);
                else
                    writer.WriteNull("CarListPrice");

            if (employmentFixedSalaryPostDto.CarRegistrationDateOption.IsSet)
                if (employmentFixedSalaryPostDto.CarRegistrationDateOption.Value != null)
                    writer.WriteString("CarRegistrationDate", employmentFixedSalaryPostDto.CarRegistrationDateOption.Value!.Value.ToString(CarRegistrationDateFormat));
                else
                    writer.WriteNull("CarRegistrationDate");

            if (employmentFixedSalaryPostDto.CarRegistrationNoOption.IsSet)
                if (employmentFixedSalaryPostDto.CarRegistrationNoOption.Value != null)
                    writer.WriteString("CarRegistrationNo", employmentFixedSalaryPostDto.CarRegistrationNo);
                else
                    writer.WriteNull("CarRegistrationNo");

            if (employmentFixedSalaryPostDto.CidOption.IsSet)
                if (employmentFixedSalaryPostDto.CidOption.Value != null)
                    writer.WriteString("Cid", employmentFixedSalaryPostDto.Cid);
                else
                    writer.WriteNull("Cid");

            if (employmentFixedSalaryPostDto.CommentOption.IsSet)
                if (employmentFixedSalaryPostDto.CommentOption.Value != null)
                    writer.WriteString("Comment", employmentFixedSalaryPostDto.Comment);
                else
                    writer.WriteNull("Comment");

            if (employmentFixedSalaryPostDto.CommuterPersonTypeOption.IsSet)
                if (employmentFixedSalaryPostDto.CommuterPersonTypeOption!.Value != null)
                {
                    var commuterPersonTypeRawValue = CommuterPersonTypeValueConverter.ToJsonValue(employmentFixedSalaryPostDto.CommuterPersonTypeOption.Value!.Value);
                    writer.WriteString("CommuterPersonType", commuterPersonTypeRawValue);
                }
                else
                    writer.WriteNull("CommuterPersonType");
            if (employmentFixedSalaryPostDto.DeductionTypeOption.IsSet)
                if (employmentFixedSalaryPostDto.DeductionTypeOption!.Value != null)
                {
                    var deductionTypeRawValue = DeductionTypeValueConverter.ToJsonValue(employmentFixedSalaryPostDto.DeductionTypeOption.Value!.Value);
                    writer.WriteString("DeductionType", deductionTypeRawValue);
                }
                else
                    writer.WriteNull("DeductionType");
            if (employmentFixedSalaryPostDto.DepartmentIdOption.IsSet)
                if (employmentFixedSalaryPostDto.DepartmentIdOption.Value != null)
                    writer.WriteNumber("DepartmentId", employmentFixedSalaryPostDto.DepartmentIdOption.Value!.Value);
                else
                    writer.WriteNull("DepartmentId");

            if (employmentFixedSalaryPostDto.FromDateOption.IsSet)
                if (employmentFixedSalaryPostDto.FromDateOption.Value != null)
                    writer.WriteString("FromDate", employmentFixedSalaryPostDto.FromDateOption.Value!.Value.ToString(FromDateFormat));
                else
                    writer.WriteNull("FromDate");

            if (employmentFixedSalaryPostDto.HomeWorkKilometersOption.IsSet)
                if (employmentFixedSalaryPostDto.HomeWorkKilometersOption.Value != null)
                    writer.WriteNumber("HomeWorkKilometers", employmentFixedSalaryPostDto.HomeWorkKilometersOption.Value!.Value);
                else
                    writer.WriteNull("HomeWorkKilometers");

            if (employmentFixedSalaryPostDto.IncomeYearOption.IsSet)
                if (employmentFixedSalaryPostDto.IncomeYearOption.Value != null)
                    writer.WriteNumber("IncomeYear", employmentFixedSalaryPostDto.IncomeYearOption.Value!.Value);
                else
                    writer.WriteNull("IncomeYear");

            if (employmentFixedSalaryPostDto.IsActiveOption.IsSet)
                if (employmentFixedSalaryPostDto.IsActiveOption.Value != null)
                    writer.WriteBoolean("IsActive", employmentFixedSalaryPostDto.IsActiveOption.Value!.Value);
                else
                    writer.WriteNull("IsActive");

            if (employmentFixedSalaryPostDto.IsCarPoolOption.IsSet)
                if (employmentFixedSalaryPostDto.IsCarPoolOption.Value != null)
                    writer.WriteBoolean("IsCarPool", employmentFixedSalaryPostDto.IsCarPoolOption.Value!.Value);
                else
                    writer.WriteNull("IsCarPool");

            if (employmentFixedSalaryPostDto.MaxAmountOption.IsSet)
                if (employmentFixedSalaryPostDto.MaxAmountOption.Value != null)
                    writer.WriteNumber("MaxAmount", employmentFixedSalaryPostDto.MaxAmountOption.Value!.Value);
                else
                    writer.WriteNull("MaxAmount");

            if (employmentFixedSalaryPostDto.MemberNoOption.IsSet)
                if (employmentFixedSalaryPostDto.MemberNoOption.Value != null)
                    writer.WriteString("MemberNo", employmentFixedSalaryPostDto.MemberNo);
                else
                    writer.WriteNull("MemberNo");

            if (employmentFixedSalaryPostDto.MinAmountOption.IsSet)
                if (employmentFixedSalaryPostDto.MinAmountOption.Value != null)
                    writer.WriteNumber("MinAmount", employmentFixedSalaryPostDto.MinAmountOption.Value!.Value);
                else
                    writer.WriteNull("MinAmount");

            if (employmentFixedSalaryPostDto.NumberOption.IsSet)
                if (employmentFixedSalaryPostDto.NumberOption.Value != null)
                    writer.WriteNumber("Number", employmentFixedSalaryPostDto.NumberOption.Value!.Value);
                else
                    writer.WriteNull("Number");

            if (employmentFixedSalaryPostDto.OppositeAccountIdOption.IsSet)
                if (employmentFixedSalaryPostDto.OppositeAccountIdOption.Value != null)
                    writer.WriteNumber("OppositeAccountId", employmentFixedSalaryPostDto.OppositeAccountIdOption.Value!.Value);
                else
                    writer.WriteNull("OppositeAccountId");

            if (employmentFixedSalaryPostDto.PayItemId != null)
                writer.WriteString("PayItemId", employmentFixedSalaryPostDto.PayItemId.Value);
            else
                writer.WriteNull("PayItemId");

            if (employmentFixedSalaryPostDto.PrivateDrivenKilometersOption.IsSet)
                if (employmentFixedSalaryPostDto.PrivateDrivenKilometersOption.Value != null)
                    writer.WriteNumber("PrivateDrivenKilometers", employmentFixedSalaryPostDto.PrivateDrivenKilometersOption.Value!.Value);
                else
                    writer.WriteNull("PrivateDrivenKilometers");

            if (employmentFixedSalaryPostDto.ProjectIdOption.IsSet)
                if (employmentFixedSalaryPostDto.ProjectIdOption.Value != null)
                    writer.WriteNumber("ProjectId", employmentFixedSalaryPostDto.ProjectIdOption.Value!.Value);
                else
                    writer.WriteNull("ProjectId");

            if (employmentFixedSalaryPostDto.QuantityOption.IsSet)
                if (employmentFixedSalaryPostDto.QuantityOption.Value != null)
                    writer.WriteNumber("Quantity", employmentFixedSalaryPostDto.QuantityOption.Value!.Value);
                else
                    writer.WriteNull("Quantity");

            if (employmentFixedSalaryPostDto.RateOption.IsSet)
                if (employmentFixedSalaryPostDto.RateOption.Value != null)
                    writer.WriteNumber("Rate", employmentFixedSalaryPostDto.RateOption.Value!.Value);
                else
                    writer.WriteNull("Rate");

            if (employmentFixedSalaryPostDto.StartAmountOption.IsSet)
                if (employmentFixedSalaryPostDto.StartAmountOption.Value != null)
                    writer.WriteNumber("StartAmount", employmentFixedSalaryPostDto.StartAmountOption.Value!.Value);
                else
                    writer.WriteNull("StartAmount");

            if (employmentFixedSalaryPostDto.SupplierAccountIdOption.IsSet)
                if (employmentFixedSalaryPostDto.SupplierAccountIdOption.Value != null)
                    writer.WriteNumber("SupplierAccountId", employmentFixedSalaryPostDto.SupplierAccountIdOption.Value!.Value);
                else
                    writer.WriteNull("SupplierAccountId");

            if (employmentFixedSalaryPostDto.SupplierBankAccountIdOption.IsSet)
                if (employmentFixedSalaryPostDto.SupplierBankAccountIdOption.Value != null)
                    writer.WriteNumber("SupplierBankAccountId", employmentFixedSalaryPostDto.SupplierBankAccountIdOption.Value!.Value);
                else
                    writer.WriteNull("SupplierBankAccountId");

            if (employmentFixedSalaryPostDto.TaxDeductionOption.IsSet)
                if (employmentFixedSalaryPostDto.TaxDeductionOption!.Value != null)
                {
                    var taxDeductionRawValue = TaxDeductionTypeValueConverter.ToJsonValue(employmentFixedSalaryPostDto.TaxDeductionOption.Value!.Value);
                    writer.WriteString("TaxDeduction", taxDeductionRawValue);
                }
                else
                    writer.WriteNull("TaxDeduction");
            if (employmentFixedSalaryPostDto.TaxRuleOption.IsSet)
                if (employmentFixedSalaryPostDto.TaxRuleOption!.Value != null)
                {
                    var taxRuleRawValue = TaxRuleTypeValueConverter.ToJsonValue(employmentFixedSalaryPostDto.TaxRuleOption.Value!.Value);
                    writer.WriteString("TaxRule", taxRuleRawValue);
                }
                else
                    writer.WriteNull("TaxRule");
            if (employmentFixedSalaryPostDto.ToDateOption.IsSet)
                if (employmentFixedSalaryPostDto.ToDateOption.Value != null)
                    writer.WriteString("ToDate", employmentFixedSalaryPostDto.ToDateOption.Value!.Value.ToString(ToDateFormat));
                else
                    writer.WriteNull("ToDate");

            if (employmentFixedSalaryPostDto.UseRemittanceOption.IsSet)
                if (employmentFixedSalaryPostDto.UseRemittanceOption.Value != null)
                    writer.WriteBoolean("UseRemittance", employmentFixedSalaryPostDto.UseRemittanceOption.Value!.Value);
                else
                    writer.WriteNull("UseRemittance");

            if (employmentFixedSalaryPostDto.VatCodeIdOption.IsSet)
                if (employmentFixedSalaryPostDto.VatCodeIdOption.Value != null)
                    writer.WriteNumber("VatCodeId", employmentFixedSalaryPostDto.VatCodeIdOption.Value!.Value);
                else
                    writer.WriteNull("VatCodeId");

            if (employmentFixedSalaryPostDto.WorkDriveExceedsKilometerLimitOption.IsSet)
                if (employmentFixedSalaryPostDto.WorkDriveExceedsKilometerLimitOption.Value != null)
                    writer.WriteBoolean("WorkDriveExceedsKilometerLimit", employmentFixedSalaryPostDto.WorkDriveExceedsKilometerLimitOption.Value!.Value);
                else
