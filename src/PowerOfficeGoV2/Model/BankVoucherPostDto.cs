...
namespace PowerOfficeGoV2.Model
{
    ...
    public partial class BankVoucherPostDto : IValidatableObject
    {
        ...
        [JsonConstructor]
        public BankVoucherPostDto(DateOnly voucherDate, string? currencyCode = default, Option<string?> description = default, Option<string?> externalImportReference = default, Option<long?> importedVoucherNo = default, Option<string?> saftBatchId = default, Option<string?> saftSourceId = default, Option<List<BankVoucherLinePostDto>?> voucherLines = default)
        {
