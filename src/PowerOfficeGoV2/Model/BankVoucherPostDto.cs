...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class BankVoucherPostDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BankVoucherPostDto" /> class.
        /// </summary>
        ...
        /// <param name="voucherLines">The lines of the bank voucher to be posted</param>
        [JsonConstructor]
        public BankVoucherPostDto(DateTimeOffset voucherDate, string? currencyCode = default, Option<string?> description = default, Option<string?> externalImportReference = default, Option<long?> importedVoucherNo = default, Option<string?> saftBatchId = default, Option<string?> saftSourceId = default, Option<List<BankVoucherLinePostDto>?> voucherLines = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<BankVoucherLinePostDto>?> VoucherLinesOption { get; private set; }

        /// <summary>
        /// The lines of the bank voucher to be posted
        /// </summary>
        /// <value>The lines of the bank voucher to be posted</value>
        [JsonPropertyName("VoucherLines")]
        public List<BankVoucherLinePostDto>? VoucherLines { get { return this.VoucherLinesOption; } set { this.VoucherLinesOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BankVoucherPostDto {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="BankVoucherPostDto" />
    /// </summary>
    public class BankVoucherPostDtoJsonConverter : JsonConverter<BankVoucherPostDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="BankVoucherPostDto" />
        /// </summary>
        ...
        public override BankVoucherPostDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<BankVoucherLinePostDto>?> voucherLines = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "VoucherLines":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                voucherLines = new Option<List<BankVoucherLinePostDto>?>(JsonSerializer.Deserialize<List<BankVoucherLinePostDto>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        default:
                            break;
                    }
            ...
            if (!voucherDate.IsSet)
                throw new ArgumentException("Property is required for class BankVoucherPostDto.", nameof(voucherDate));

            if (!currencyCode.IsSet)
                throw new ArgumentException("Property is required for class BankVoucherPostDto.", nameof(currencyCode));

            if (voucherDate.IsSet && voucherDate.Value == null)
                throw new ArgumentNullException(nameof(voucherDate), "Property is not nullable for class BankVoucherPostDto.");

            return new BankVoucherPostDto(voucherDate.Value!.Value!, currencyCode.Value!, description, externalImportReference, importedVoucherNo, saftBatchId, saftSourceId, voucherLines);
        }

        /// <summary>
        /// Serializes a <see cref="BankVoucherPostDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="bankVoucherPostDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BankVoucherPostDto bankVoucherPostDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, bankVoucherPostDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="BankVoucherPostDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="bankVoucherPostDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BankVoucherPostDto bankVoucherPostDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteString("VoucherDate", bankVoucherPostDto.VoucherDate.ToString(VoucherDateFormat));

            if (bankVoucherPostDto.CurrencyCode != null)
                writer.WriteString("CurrencyCode", bankVoucherPostDto.CurrencyCode);
            else
                writer.WriteNull("CurrencyCode");

            if (bankVoucherPostDto.DescriptionOption.IsSet)
                if (bankVoucherPostDto.DescriptionOption.Value != null)
                    writer.WriteString("Description", bankVoucherPostDto.Description);
                else
                    writer.WriteNull("Description");

            if (bankVoucherPostDto.ExternalImportReferenceOption.IsSet)
                if (bankVoucherPostDto.ExternalImportReferenceOption.Value != null)
                    writer.WriteString("ExternalImportReference", bankVoucherPostDto.ExternalImportReference);
                else
                    writer.WriteNull("ExternalImportReference");

            if (bankVoucherPostDto.ImportedVoucherNoOption.IsSet)
                if (bankVoucherPostDto.ImportedVoucherNoOption.Value != null)
                    writer.WriteNumber("ImportedVoucherNo", bankVoucherPostDto.ImportedVoucherNoOption.Value!.Value);
                else
                    writer.WriteNull("ImportedVoucherNo");

            if (bankVoucherPostDto.SaftBatchIdOption.IsSet)
                if (bankVoucherPostDto.SaftBatchIdOption.Value != null)
                    writer.WriteString("SaftBatchId", bankVoucherPostDto.SaftBatchId);
                else
                    writer.WriteNull("SaftBatchId");

            if (bankVoucherPostDto.SaftSourceIdOption.IsSet)
                if (bankVoucherPostDto.SaftSourceIdOption.Value != null)
                    writer.WriteString("SaftSourceId", bankVoucherPostDto.SaftSourceId);
                else
                    writer.WriteNull("SaftSourceId");

            if (bankVoucherPostDto.VoucherLinesOption.IsSet)
                if (bankVoucherPostDto.VoucherLinesOption.Value != null)
                {
                    writer.WritePropertyName("VoucherLines");
                    JsonSerializer.Serialize(writer, bankVoucherPostDto.VoucherLines, jsonSerializerOptions);
                }
                else
