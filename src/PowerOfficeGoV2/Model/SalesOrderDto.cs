...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class SalesOrderDto : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public SalesOrderDto(Option<string?> brandingThemeCode = default, Option<long?> brandingThemeId = default, Option<long?> contactDeliveryAddressId = default, Option<string?> contractNo = default, Option<DateTime?> createdDateTimeOffset = default, Option<string?> currencyCode = default, Option<double?> currencyExchangeRate = default, Option<string?> customMatchingReference = default, Option<long?> customerId = default, Option<long?> customerNo = default, Option<string?> customerReference = default, Option<long?> customerReferenceContactPersonId = default, Option<DateOnly?> deliveryDate = default, Option<string?> deliveryTerm = default, Option<long?> deliveryTermId = default, Option<string?> departmentCode = default, Option<long?> departmentId = default, Option<string?> dim1Code = default, Option<long?> dim1Id = default, Option<string?> dim2Code = default, Option<long?> dim2Id = default, Option<string?> dim3Code = default, Option<long?> dim3Id = default, Option<string?> externalImportReference = default, Option<Guid?> id = default, Option<long?> importedOrderNo = default, Option<bool?> isCreatedByCurrentIntegration = default, Option<DateTime?> lastChangedDateTimeOffset = default, Option<long?> lineCount = default, Option<string?> locationCode = default, Option<long?> locationId = default, Option<double?> netAmount = default, Option<int?> paymentTerm = default, Option<long?> paymentTermId = default, Option<string?> projectCode = default, Option<long?> projectId = default, Option<string?> purchaseOrderReference = default, Option<long?> relatedInvoiceNo = default, Option<DateOnly?> salesOrderDate = default, Option<long?> salesOrderNo = default, Option<OrderStatus?> salesOrderStatus = default, Option<long?> salesPersonEmployeeId = default, Option<long?> salesPersonEmployeeNumber = default, Option<double?> totalAmount = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<DateOnly?> SalesOrderDateOption { get; private set; }
        ...
        public DateOnly? SalesOrderDate { get { return this.SalesOrderDateOption; } set { this.SalesOrderDateOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="SalesOrderDto" />
    /// </summary>
    public class SalesOrderDtoJsonConverter : JsonConverter<SalesOrderDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="SalesOrderDto" />
        /// </summary>
        ...
        public override SalesOrderDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<DateOnly?> salesOrderDate = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "SalesOrderDate":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                salesOrderDate = new Option<DateOnly?>(JsonSerializer.Deserialize<DateOnly?>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "SalesOrderNo":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (createdDateTimeOffset.IsSet && createdDateTimeOffset.Value == null)
                throw new ArgumentNullException(nameof(createdDateTimeOffset), "Property is not nullable for class SalesOrderDto.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class SalesOrderDto.");

            if (lastChangedDateTimeOffset.IsSet && lastChangedDateTimeOffset.Value == null)
                throw new ArgumentNullException(nameof(lastChangedDateTimeOffset), "Property is not nullable for class SalesOrderDto.");

            if (lineCount.IsSet && lineCount.Value == null)
                throw new ArgumentNullException(nameof(lineCount), "Property is not nullable for class SalesOrderDto.");

            if (netAmount.IsSet && netAmount.Value == null)
                throw new ArgumentNullException(nameof(netAmount), "Property is not nullable for class SalesOrderDto.");

            if (totalAmount.IsSet && totalAmount.Value == null)
                throw new ArgumentNullException(nameof(totalAmount), "Property is not nullable for class SalesOrderDto.");

            return new SalesOrderDto(brandingThemeCode, brandingThemeId, contactDeliveryAddressId, contractNo, createdDateTimeOffset, currencyCode, currencyExchangeRate, customMatchingReference, customerId, customerNo, customerReference, customerReferenceContactPersonId, deliveryDate, deliveryTerm, deliveryTermId, departmentCode, departmentId, dim1Code, dim1Id, dim2Code, dim2Id, dim3Code, dim3Id, externalImportReference, id, importedOrderNo, isCreatedByCurrentIntegration, lastChangedDateTimeOffset, lineCount, locationCode, locationId, netAmount, paymentTerm, paymentTermId, projectCode, projectId, purchaseOrderReference, relatedInvoiceNo, salesOrderDate, salesOrderNo, salesOrderStatus, salesPersonEmployeeId, salesPersonEmployeeNumber, totalAmount);
        }

        /// <summary>
        /// Serializes a <see cref="SalesOrderDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="salesOrderDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SalesOrderDto salesOrderDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, salesOrderDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SalesOrderDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="salesOrderDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SalesOrderDto salesOrderDto, JsonSerializerOptions jsonSerializerOptions)
        {
            if (salesOrderDto.BrandingThemeCodeOption.IsSet)
                if (salesOrderDto.BrandingThemeCodeOption.Value != null)
                    writer.WriteString("BrandingThemeCode", salesOrderDto.BrandingThemeCode);
                else
                    writer.WriteNull("BrandingThemeCode");

            if (salesOrderDto.BrandingThemeIdOption.IsSet)
                if (salesOrderDto.BrandingThemeIdOption.Value != null)
                    writer.WriteNumber("BrandingThemeId", salesOrderDto.BrandingThemeIdOption.Value!.Value);
                else
                    writer.WriteNull("BrandingThemeId");

            if (salesOrderDto.ContactDeliveryAddressIdOption.IsSet)
                if (salesOrderDto.ContactDeliveryAddressIdOption.Value != null)
                    writer.WriteNumber("ContactDeliveryAddressId", salesOrderDto.ContactDeliveryAddressIdOption.Value!.Value);
                else
                    writer.WriteNull("ContactDeliveryAddressId");

            if (salesOrderDto.ContractNoOption.IsSet)
                if (salesOrderDto.ContractNoOption.Value != null)
                    writer.WriteString("ContractNo", salesOrderDto.ContractNo);
                else
                    writer.WriteNull("ContractNo");

            if (salesOrderDto.CreatedDateTimeOffsetOption.IsSet)
                writer.WriteString("CreatedDateTimeOffset", salesOrderDto.CreatedDateTimeOffsetOption.Value!.Value.ToString(CreatedDateTimeOffsetFormat));

            if (salesOrderDto.CurrencyCodeOption.IsSet)
                if (salesOrderDto.CurrencyCodeOption.Value != null)
                    writer.WriteString("CurrencyCode", salesOrderDto.CurrencyCode);
                else
                    writer.WriteNull("CurrencyCode");

            if (salesOrderDto.CurrencyExchangeRateOption.IsSet)
                if (salesOrderDto.CurrencyExchangeRateOption.Value != null)
                    writer.WriteNumber("CurrencyExchangeRate", salesOrderDto.CurrencyExchangeRateOption.Value!.Value);
                else
                    writer.WriteNull("CurrencyExchangeRate");

            if (salesOrderDto.CustomMatchingReferenceOption.IsSet)
                if (salesOrderDto.CustomMatchingReferenceOption.Value != null)
                    writer.WriteString("CustomMatchingReference", salesOrderDto.CustomMatchingReference);
                else
                    writer.WriteNull("CustomMatchingReference");

            if (salesOrderDto.CustomerIdOption.IsSet)
                if (salesOrderDto.CustomerIdOption.Value != null)
                    writer.WriteNumber("CustomerId", salesOrderDto.CustomerIdOption.Value!.Value);
                else
                    writer.WriteNull("CustomerId");

            if (salesOrderDto.CustomerNoOption.IsSet)
                if (salesOrderDto.CustomerNoOption.Value != null)
                    writer.WriteNumber("CustomerNo", salesOrderDto.CustomerNoOption.Value!.Value);
                else
                    writer.WriteNull("CustomerNo");

            if (salesOrderDto.CustomerReferenceOption.IsSet)
                if (salesOrderDto.CustomerReferenceOption.Value != null)
                    writer.WriteString("CustomerReference", salesOrderDto.CustomerReference);
                else
                    writer.WriteNull("CustomerReference");

            if (salesOrderDto.CustomerReferenceContactPersonIdOption.IsSet)
                if (salesOrderDto.CustomerReferenceContactPersonIdOption.Value != null)
                    writer.WriteNumber("CustomerReferenceContactPersonId", salesOrderDto.CustomerReferenceContactPersonIdOption.Value!.Value);
                else
                    writer.WriteNull("CustomerReferenceContactPersonId");

            if (salesOrderDto.DeliveryDateOption.IsSet)
                if (salesOrderDto.DeliveryDateOption.Value != null)
                    writer.WriteString("DeliveryDate", salesOrderDto.DeliveryDateOption.Value!.Value.ToString(DeliveryDateFormat));
                else
                    writer.WriteNull("DeliveryDate");

            if (salesOrderDto.DeliveryTermOption.IsSet)
                if (salesOrderDto.DeliveryTermOption.Value != null)
                    writer.WriteString("DeliveryTerm", salesOrderDto.DeliveryTerm);
                else
                    writer.WriteNull("DeliveryTerm");

            if (salesOrderDto.DeliveryTermIdOption.IsSet)
                if (salesOrderDto.DeliveryTermIdOption.Value != null)
                    writer.WriteNumber("DeliveryTermId", salesOrderDto.DeliveryTermIdOption.Value!.Value);
                else
                    writer.WriteNull("DeliveryTermId");

            if (salesOrderDto.DepartmentCodeOption.IsSet)
                if (salesOrderDto.DepartmentCodeOption.Value != null)
                    writer.WriteString("DepartmentCode", salesOrderDto.DepartmentCode);
                else
                    writer.WriteNull("DepartmentCode");

            if (salesOrderDto.DepartmentIdOption.IsSet)
                if (salesOrderDto.DepartmentIdOption.Value != null)
                    writer.WriteNumber("DepartmentId", salesOrderDto.DepartmentIdOption.Value!.Value);
                else
                    writer.WriteNull("DepartmentId");

            if (salesOrderDto.Dim1CodeOption.IsSet)
                if (salesOrderDto.Dim1CodeOption.Value != null)
                    writer.WriteString("Dim1Code", salesOrderDto.Dim1Code);
                else
                    writer.WriteNull("Dim1Code");

            if (salesOrderDto.Dim1IdOption.IsSet)
                if (salesOrderDto.Dim1IdOption.Value != null)
                    writer.WriteNumber("Dim1Id", salesOrderDto.Dim1IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim1Id");

            if (salesOrderDto.Dim2CodeOption.IsSet)
                if (salesOrderDto.Dim2CodeOption.Value != null)
                    writer.WriteString("Dim2Code", salesOrderDto.Dim2Code);
                else
                    writer.WriteNull("Dim2Code");

            if (salesOrderDto.Dim2IdOption.IsSet)
                if (salesOrderDto.Dim2IdOption.Value != null)
                    writer.WriteNumber("Dim2Id", salesOrderDto.Dim2IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim2Id");

            if (salesOrderDto.Dim3CodeOption.IsSet)
                if (salesOrderDto.Dim3CodeOption.Value != null)
                    writer.WriteString("Dim3Code", salesOrderDto.Dim3Code);
                else
                    writer.WriteNull("Dim3Code");

            if (salesOrderDto.Dim3IdOption.IsSet)
                if (salesOrderDto.Dim3IdOption.Value != null)
                    writer.WriteNumber("Dim3Id", salesOrderDto.Dim3IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim3Id");

            if (salesOrderDto.ExternalImportReferenceOption.IsSet)
                if (salesOrderDto.ExternalImportReferenceOption.Value != null)
                    writer.WriteString("ExternalImportReference", salesOrderDto.ExternalImportReference);
                else
                    writer.WriteNull("ExternalImportReference");

            if (salesOrderDto.IdOption.IsSet)
                writer.WriteString("Id", salesOrderDto.IdOption.Value!.Value);

            if (salesOrderDto.ImportedOrderNoOption.IsSet)
                if (salesOrderDto.ImportedOrderNoOption.Value != null)
                    writer.WriteNumber("ImportedOrderNo", salesOrderDto.ImportedOrderNoOption.Value!.Value);
                else
                    writer.WriteNull("ImportedOrderNo");

            if (salesOrderDto.IsCreatedByCurrentIntegrationOption.IsSet)
                if (salesOrderDto.IsCreatedByCurrentIntegrationOption.Value != null)
                    writer.WriteBoolean("IsCreatedByCurrentIntegration", salesOrderDto.IsCreatedByCurrentIntegrationOption.Value!.Value);
                else
                    writer.WriteNull("IsCreatedByCurrentIntegration");

            if (salesOrderDto.LastChangedDateTimeOffsetOption.IsSet)
                writer.WriteString("LastChangedDateTimeOffset", salesOrderDto.LastChangedDateTimeOffsetOption.Value!.Value.ToString(LastChangedDateTimeOffsetFormat));

            if (salesOrderDto.LineCountOption.IsSet)
                writer.WriteNumber("LineCount", salesOrderDto.LineCountOption.Value!.Value);

            if (salesOrderDto.LocationCodeOption.IsSet)
                if (salesOrderDto.LocationCodeOption.Value != null)
                    writer.WriteString("LocationCode", salesOrderDto.LocationCode);
                else
                    writer.WriteNull("LocationCode");

            if (salesOrderDto.LocationIdOption.IsSet)
                if (salesOrderDto.LocationIdOption.Value != null)
                    writer.WriteNumber("LocationId", salesOrderDto.LocationIdOption.Value!.Value);
                else
                    writer.WriteNull("LocationId");

            if (salesOrderDto.NetAmountOption.IsSet)
                writer.WriteNumber("NetAmount", salesOrderDto.NetAmountOption.Value!.Value);

            if (salesOrderDto.PaymentTermOption.IsSet)
                if (salesOrderDto.PaymentTermOption.Value != null)
                    writer.WriteNumber("PaymentTerm", salesOrderDto.PaymentTermOption.Value!.Value);
                else
                    writer.WriteNull("PaymentTerm");

            if (salesOrderDto.PaymentTermIdOption.IsSet)
                if (salesOrderDto.PaymentTermIdOption.Value != null)
                    writer.WriteNumber("PaymentTermId", salesOrderDto.PaymentTermIdOption.Value!.Value);
                else
                    writer.WriteNull("PaymentTermId");

            if (salesOrderDto.ProjectCodeOption.IsSet)
                if (salesOrderDto.ProjectCodeOption.Value != null)
                    writer.WriteString("ProjectCode", salesOrderDto.ProjectCode);
                else
                    writer.WriteNull("ProjectCode");

            if (salesOrderDto.ProjectIdOption.IsSet)
                if (salesOrderDto.ProjectIdOption.Value != null)
                    writer.WriteNumber("ProjectId", salesOrderDto.ProjectIdOption.Value!.Value);
                else
                    writer.WriteNull("ProjectId");

            if (salesOrderDto.PurchaseOrderReferenceOption.IsSet)
                if (salesOrderDto.PurchaseOrderReferenceOption.Value != null)
                    writer.WriteString("PurchaseOrderReference", salesOrderDto.PurchaseOrderReference);
                else
                    writer.WriteNull("PurchaseOrderReference");

            if (salesOrderDto.RelatedInvoiceNoOption.IsSet)
                if (salesOrderDto.RelatedInvoiceNoOption.Value != null)
                    writer.WriteNumber("RelatedInvoiceNo", salesOrderDto.RelatedInvoiceNoOption.Value!.Value);
                else
                    writer.WriteNull("RelatedInvoiceNo");

            if (salesOrderDto.SalesOrderDateOption.IsSet)
                if (salesOrderDto.SalesOrderDateOption.Value != null)
                    writer.WriteString("SalesOrderDate", salesOrderDto.SalesOrderDateOption.Value!.Value.ToString(SalesOrderDateFormat));
                else
                    writer.WriteNull("SalesOrderDate");

            if (salesOrderDto.SalesOrderNoOption.IsSet)
                if (salesOrderDto.SalesOrderNoOption.Value != null)
                    writer.WriteNumber("SalesOrderNo", salesOrderDto.SalesOrderNoOption.Value!.Value);
                else
                    writer.WriteNull("SalesOrderNo");

            if (salesOrderDto.SalesOrderStatusOption.IsSet)
                if (salesOrderDto.SalesOrderStatusOption!.Value != null)
                {
                    var salesOrderStatusRawValue = OrderStatusValueConverter.ToJsonValue(salesOrderDto.SalesOrderStatusOption.Value!.Value);
                    writer.WriteString("SalesOrderStatus", salesOrderStatusRawValue);
                }
                else
                    writer.WriteNull("SalesOrderStatus");
            if (salesOrderDto.SalesPersonEmployeeIdOption.IsSet)
                if (salesOrderDto.SalesPersonEmployeeIdOption.Value != null)
                    writer.WriteNumber("SalesPersonEmployeeId", salesOrderDto.SalesPersonEmployeeIdOption.Value!.Value);
                else
                    writer.WriteNull("SalesPersonEmployeeId");

            if (salesOrderDto.SalesPersonEmployeeNumberOption.IsSet)
                if (salesOrderDto.SalesPersonEmployeeNumberOption.Value != null)
                    writer.WriteNumber("SalesPersonEmployeeNumber", salesOrderDto.SalesPersonEmployeeNumberOption.Value!.Value);
                else
                    writer.WriteNull("SalesPersonEmployeeNumber");

            if (salesOrderDto.TotalAmountOption.IsSet)
                writer.WriteNumber("TotalAmount", salesOrderDto.TotalAmountOption.Value!.Value);
        }
    }
}
