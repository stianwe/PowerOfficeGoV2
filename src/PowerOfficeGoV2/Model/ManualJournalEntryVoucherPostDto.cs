...
namespace PowerOfficeGoV2.Model
{
    ...
    public partial class ManualJournalEntryVoucherPostDto : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ManualJournalEntryVoucherPostDto(Option<string?> comment = default, string? currencyCode = default, Option<long?> departmentId = default, Option<string?> description = default, Option<long?> dim1Id = default, Option<long?> dim2Id = default, Option<long?> dim3Id = default, Option<long?> locationId = default, Option<List<ManualJournalEntryVoucherLinePostDto>?> manualVoucherLines = default, Option<long?> projectId = default, DateTimeOffset? voucherDate = default)
        {
