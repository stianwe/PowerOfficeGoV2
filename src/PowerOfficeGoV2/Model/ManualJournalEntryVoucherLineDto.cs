...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class ManualJournalEntryVoucherLineDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManualJournalEntryVoucherLineDto" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ManualJournalEntryVoucherLineDto(Option<AccrualBase?> accrual = default, Option<AgricultureDetails?> agricultureDetails = default, Option<DateTimeOffset?> createdDateTimeOffset = default, Option<AgricultureDepartment?> creditAccountAgricultureDepartment = default, Option<long?> creditAccountId = default, Option<int?> creditVatId = default, Option<VatReturnSpecification?> creditVatReturnSpecification = default, Option<double?> currencyAmount = default, Option<string?> currencyCode = default, Option<double?> currencyExchangeRate = default, Option<AgricultureDepartment?> debitAccountAgricultureDepartment = default, Option<long?> debitAccountId = default, Option<int?> debitVatId = default, Option<VatReturnSpecification?> debitVatReturnSpecification = default, Option<long?> departmentId = default, Option<string?> description = default, Option<long?> dim1Id = default, Option<long?> dim2Id = default, Option<long?> dim3Id = default, Option<long?> id = default, Option<DateTimeOffset?> lastChangedDateTimeOffset = default, Option<long?> locationId = default, Option<DateTimeOffset?> postingDate = default, Option<long?> productId = default, Option<long?> projectId = default, Option<double?> quantity = default, Option<double?> quantity2 = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ManualJournalEntryVoucherLineDto {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ManualJournalEntryVoucherLineDto" />
    /// </summary>
    public class ManualJournalEntryVoucherLineDtoJsonConverter : JsonConverter<ManualJournalEntryVoucherLineDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="ManualJournalEntryVoucherLineDto" />
        /// </summary>
        ...
        public override ManualJournalEntryVoucherLineDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accrual.IsSet && accrual.Value == null)
                throw new ArgumentNullException(nameof(accrual), "Property is not nullable for class ManualJournalEntryVoucherLineDto.");

            if (agricultureDetails.IsSet && agricultureDetails.Value == null)
                throw new ArgumentNullException(nameof(agricultureDetails), "Property is not nullable for class ManualJournalEntryVoucherLineDto.");

            if (createdDateTimeOffset.IsSet && createdDateTimeOffset.Value == null)
                throw new ArgumentNullException(nameof(createdDateTimeOffset), "Property is not nullable for class ManualJournalEntryVoucherLineDto.");

            if (currencyAmount.IsSet && currencyAmount.Value == null)
                throw new ArgumentNullException(nameof(currencyAmount), "Property is not nullable for class ManualJournalEntryVoucherLineDto.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class ManualJournalEntryVoucherLineDto.");

            if (lastChangedDateTimeOffset.IsSet && lastChangedDateTimeOffset.Value == null)
                throw new ArgumentNullException(nameof(lastChangedDateTimeOffset), "Property is not nullable for class ManualJournalEntryVoucherLineDto.");

            return new ManualJournalEntryVoucherLineDto(accrual, agricultureDetails, createdDateTimeOffset, creditAccountAgricultureDepartment, creditAccountId, creditVatId, creditVatReturnSpecification, currencyAmount, currencyCode, currencyExchangeRate, debitAccountAgricultureDepartment, debitAccountId, debitVatId, debitVatReturnSpecification, departmentId, description, dim1Id, dim2Id, dim3Id, id, lastChangedDateTimeOffset, locationId, postingDate, productId, projectId, quantity, quantity2);
        }

        /// <summary>
        /// Serializes a <see cref="ManualJournalEntryVoucherLineDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="manualJournalEntryVoucherLineDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ManualJournalEntryVoucherLineDto manualJournalEntryVoucherLineDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, manualJournalEntryVoucherLineDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ManualJournalEntryVoucherLineDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="manualJournalEntryVoucherLineDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ManualJournalEntryVoucherLineDto manualJournalEntryVoucherLineDto, JsonSerializerOptions jsonSerializerOptions)
        {
            if (manualJournalEntryVoucherLineDto.AccrualOption.IsSet && manualJournalEntryVoucherLineDto.Accrual == null)
                throw new ArgumentNullException(nameof(manualJournalEntryVoucherLineDto.Accrual), "Property is required for class ManualJournalEntryVoucherLineDto.");

            if (manualJournalEntryVoucherLineDto.AgricultureDetailsOption.IsSet && manualJournalEntryVoucherLineDto.AgricultureDetails == null)
                throw new ArgumentNullException(nameof(manualJournalEntryVoucherLineDto.AgricultureDetails), "Property is required for class ManualJournalEntryVoucherLineDto.");

            if (manualJournalEntryVoucherLineDto.AccrualOption.IsSet)
            {
                writer.WritePropertyName("Accrual");
                JsonSerializer.Serialize(writer, manualJournalEntryVoucherLineDto.Accrual, jsonSerializerOptions);
            }
            if (manualJournalEntryVoucherLineDto.AgricultureDetailsOption.IsSet)
            {
                writer.WritePropertyName("AgricultureDetails");
                JsonSerializer.Serialize(writer, manualJournalEntryVoucherLineDto.AgricultureDetails, jsonSerializerOptions);
            }
            if (manualJournalEntryVoucherLineDto.CreatedDateTimeOffsetOption.IsSet)
                writer.WriteString("CreatedDateTimeOffset", manualJournalEntryVoucherLineDto.CreatedDateTimeOffsetOption.Value!.Value.ToString(CreatedDateTimeOffsetFormat));

            if (manualJournalEntryVoucherLineDto.CreditAccountAgricultureDepartmentOption.IsSet)
                if (manualJournalEntryVoucherLineDto.CreditAccountAgricultureDepartmentOption!.Value != null)
                {
                    var creditAccountAgricultureDepartmentRawValue = AgricultureDepartmentValueConverter.ToJsonValue(manualJournalEntryVoucherLineDto.CreditAccountAgricultureDepartmentOption.Value!.Value);
            ...
            if (manualJournalEntryVoucherLineDto.CreditAccountIdOption.IsSet)
                if (manualJournalEntryVoucherLineDto.CreditAccountIdOption.Value != null)
                    writer.WriteNumber("CreditAccountId", manualJournalEntryVoucherLineDto.CreditAccountIdOption.Value!.Value);
                else
                    writer.WriteNull("CreditAccountId");

            if (manualJournalEntryVoucherLineDto.CreditVatIdOption.IsSet)
                if (manualJournalEntryVoucherLineDto.CreditVatIdOption.Value != null)
                    writer.WriteNumber("CreditVatId", manualJournalEntryVoucherLineDto.CreditVatIdOption.Value!.Value);
                else
                    writer.WriteNull("CreditVatId");

            if (manualJournalEntryVoucherLineDto.CreditVatReturnSpecificationOption.IsSet)
                if (manualJournalEntryVoucherLineDto.CreditVatReturnSpecificationOption!.Value != null)
                {
                    var creditVatReturnSpecificationRawValue = VatReturnSpecificationValueConverter.ToJsonValue(manualJournalEntryVoucherLineDto.CreditVatReturnSpecificationOption.Value!.Value);
            ...
            if (manualJournalEntryVoucherLineDto.CurrencyAmountOption.IsSet)
                writer.WriteNumber("CurrencyAmount", manualJournalEntryVoucherLineDto.CurrencyAmountOption.Value!.Value);

            if (manualJournalEntryVoucherLineDto.CurrencyCodeOption.IsSet)
                if (manualJournalEntryVoucherLineDto.CurrencyCodeOption.Value != null)
                    writer.WriteString("CurrencyCode", manualJournalEntryVoucherLineDto.CurrencyCode);
                else
                    writer.WriteNull("CurrencyCode");

            if (manualJournalEntryVoucherLineDto.CurrencyExchangeRateOption.IsSet)
                if (manualJournalEntryVoucherLineDto.CurrencyExchangeRateOption.Value != null)
                    writer.WriteNumber("CurrencyExchangeRate", manualJournalEntryVoucherLineDto.CurrencyExchangeRateOption.Value!.Value);
                else
                    writer.WriteNull("CurrencyExchangeRate");

            if (manualJournalEntryVoucherLineDto.DebitAccountAgricultureDepartmentOption.IsSet)
                if (manualJournalEntryVoucherLineDto.DebitAccountAgricultureDepartmentOption!.Value != null)
                {
                    var debitAccountAgricultureDepartmentRawValue = AgricultureDepartmentValueConverter.ToJsonValue(manualJournalEntryVoucherLineDto.DebitAccountAgricultureDepartmentOption.Value!.Value);
            ...
            if (manualJournalEntryVoucherLineDto.DebitAccountIdOption.IsSet)
                if (manualJournalEntryVoucherLineDto.DebitAccountIdOption.Value != null)
                    writer.WriteNumber("DebitAccountId", manualJournalEntryVoucherLineDto.DebitAccountIdOption.Value!.Value);
                else
                    writer.WriteNull("DebitAccountId");

            if (manualJournalEntryVoucherLineDto.DebitVatIdOption.IsSet)
                if (manualJournalEntryVoucherLineDto.DebitVatIdOption.Value != null)
                    writer.WriteNumber("DebitVatId", manualJournalEntryVoucherLineDto.DebitVatIdOption.Value!.Value);
                else
                    writer.WriteNull("DebitVatId");

            if (manualJournalEntryVoucherLineDto.DebitVatReturnSpecificationOption.IsSet)
                if (manualJournalEntryVoucherLineDto.DebitVatReturnSpecificationOption!.Value != null)
                {
                    var debitVatReturnSpecificationRawValue = VatReturnSpecificationValueConverter.ToJsonValue(manualJournalEntryVoucherLineDto.DebitVatReturnSpecificationOption.Value!.Value);
            ...
            if (manualJournalEntryVoucherLineDto.DepartmentIdOption.IsSet)
                if (manualJournalEntryVoucherLineDto.DepartmentIdOption.Value != null)
                    writer.WriteNumber("DepartmentId", manualJournalEntryVoucherLineDto.DepartmentIdOption.Value!.Value);
                else
                    writer.WriteNull("DepartmentId");

            if (manualJournalEntryVoucherLineDto.DescriptionOption.IsSet)
                if (manualJournalEntryVoucherLineDto.DescriptionOption.Value != null)
                    writer.WriteString("Description", manualJournalEntryVoucherLineDto.Description);
                else
                    writer.WriteNull("Description");

            if (manualJournalEntryVoucherLineDto.Dim1IdOption.IsSet)
                if (manualJournalEntryVoucherLineDto.Dim1IdOption.Value != null)
                    writer.WriteNumber("Dim1Id", manualJournalEntryVoucherLineDto.Dim1IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim1Id");

            if (manualJournalEntryVoucherLineDto.Dim2IdOption.IsSet)
                if (manualJournalEntryVoucherLineDto.Dim2IdOption.Value != null)
                    writer.WriteNumber("Dim2Id", manualJournalEntryVoucherLineDto.Dim2IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim2Id");

            if (manualJournalEntryVoucherLineDto.Dim3IdOption.IsSet)
                if (manualJournalEntryVoucherLineDto.Dim3IdOption.Value != null)
                    writer.WriteNumber("Dim3Id", manualJournalEntryVoucherLineDto.Dim3IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim3Id");

            if (manualJournalEntryVoucherLineDto.IdOption.IsSet)
                writer.WriteNumber("Id", manualJournalEntryVoucherLineDto.IdOption.Value!.Value);

            if (manualJournalEntryVoucherLineDto.LastChangedDateTimeOffsetOption.IsSet)
                writer.WriteString("LastChangedDateTimeOffset", manualJournalEntryVoucherLineDto.LastChangedDateTimeOffsetOption.Value!.Value.ToString(LastChangedDateTimeOffsetFormat));

            if (manualJournalEntryVoucherLineDto.LocationIdOption.IsSet)
                if (manualJournalEntryVoucherLineDto.LocationIdOption.Value != null)
                    writer.WriteNumber("LocationId", manualJournalEntryVoucherLineDto.LocationIdOption.Value!.Value);
                else
                    writer.WriteNull("LocationId");

            if (manualJournalEntryVoucherLineDto.PostingDateOption.IsSet)
                if (manualJournalEntryVoucherLineDto.PostingDateOption.Value != null)
                    writer.WriteString("PostingDate", manualJournalEntryVoucherLineDto.PostingDateOption.Value!.Value.ToString(PostingDateFormat));
                else
                    writer.WriteNull("PostingDate");

            if (manualJournalEntryVoucherLineDto.ProductIdOption.IsSet)
                if (manualJournalEntryVoucherLineDto.ProductIdOption.Value != null)
                    writer.WriteNumber("ProductId", manualJournalEntryVoucherLineDto.ProductIdOption.Value!.Value);
                else
                    writer.WriteNull("ProductId");

            if (manualJournalEntryVoucherLineDto.ProjectIdOption.IsSet)
                if (manualJournalEntryVoucherLineDto.ProjectIdOption.Value != null)
                    writer.WriteNumber("ProjectId", manualJournalEntryVoucherLineDto.ProjectIdOption.Value!.Value);
                else
                    writer.WriteNull("ProjectId");

            if (manualJournalEntryVoucherLineDto.QuantityOption.IsSet)
                if (manualJournalEntryVoucherLineDto.QuantityOption.Value != null)
                    writer.WriteNumber("Quantity", manualJournalEntryVoucherLineDto.QuantityOption.Value!.Value);
                else
                    writer.WriteNull("Quantity");

            if (manualJournalEntryVoucherLineDto.Quantity2Option.IsSet)
                if (manualJournalEntryVoucherLineDto.Quantity2Option.Value != null)
                    writer.WriteNumber("Quantity2", manualJournalEntryVoucherLineDto.Quantity2Option.Value!.Value);
                else
