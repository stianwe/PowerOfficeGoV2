...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class CashVoucherDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CashVoucherDto" /> class.
        /// </summary>
        ...
        /// <param name="voucherLines">The lines of the cash voucher</param>
        ...
        [JsonConstructor]
        public CashVoucherDto(Option<DateTimeOffset?> createdDateTimeOffset = default, Option<string?> currencyCode = default, Option<string?> description = default, Option<string?> externalImportReference = default, Option<Guid?> id = default, Option<long?> importedVoucherNo = default, Option<bool?> isReversed = default, Option<string?> saftBatchId = default, Option<string?> saftSourceId = default, Option<DateTimeOffset?> voucherDate = default, Option<List<CashVoucherLineDto>?> voucherLines = default, Option<long?> voucherNo = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<CashVoucherLineDto>?> VoucherLinesOption { get; private set; }

        /// <summary>
        /// The lines of the cash voucher
        /// </summary>
        /// <value>The lines of the cash voucher</value>
        [JsonPropertyName("VoucherLines")]
        public List<CashVoucherLineDto>? VoucherLines { get { return this.VoucherLinesOption; } set { this.VoucherLinesOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CashVoucherDto {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="CashVoucherDto" />
    /// </summary>
    public class CashVoucherDtoJsonConverter : JsonConverter<CashVoucherDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="CashVoucherDto" />
        /// </summary>
        ...
        public override CashVoucherDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<CashVoucherLineDto>?> voucherLines = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "VoucherLines":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                voucherLines = new Option<List<CashVoucherLineDto>?>(JsonSerializer.Deserialize<List<CashVoucherLineDto>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "VoucherNo":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (createdDateTimeOffset.IsSet && createdDateTimeOffset.Value == null)
                throw new ArgumentNullException(nameof(createdDateTimeOffset), "Property is not nullable for class CashVoucherDto.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class CashVoucherDto.");

            if (voucherDate.IsSet && voucherDate.Value == null)
                throw new ArgumentNullException(nameof(voucherDate), "Property is not nullable for class CashVoucherDto.");

            if (voucherNo.IsSet && voucherNo.Value == null)
                throw new ArgumentNullException(nameof(voucherNo), "Property is not nullable for class CashVoucherDto.");

            return new CashVoucherDto(createdDateTimeOffset, currencyCode, description, externalImportReference, id, importedVoucherNo, isReversed, saftBatchId, saftSourceId, voucherDate, voucherLines, voucherNo);
        }

        /// <summary>
        /// Serializes a <see cref="CashVoucherDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="cashVoucherDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CashVoucherDto cashVoucherDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, cashVoucherDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CashVoucherDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="cashVoucherDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CashVoucherDto cashVoucherDto, JsonSerializerOptions jsonSerializerOptions)
        {
            if (cashVoucherDto.CreatedDateTimeOffsetOption.IsSet)
                writer.WriteString("CreatedDateTimeOffset", cashVoucherDto.CreatedDateTimeOffsetOption.Value!.Value.ToString(CreatedDateTimeOffsetFormat));

            if (cashVoucherDto.CurrencyCodeOption.IsSet)
                if (cashVoucherDto.CurrencyCodeOption.Value != null)
                    writer.WriteString("CurrencyCode", cashVoucherDto.CurrencyCode);
                else
                    writer.WriteNull("CurrencyCode");

            if (cashVoucherDto.DescriptionOption.IsSet)
                if (cashVoucherDto.DescriptionOption.Value != null)
                    writer.WriteString("Description", cashVoucherDto.Description);
                else
                    writer.WriteNull("Description");

            if (cashVoucherDto.ExternalImportReferenceOption.IsSet)
                if (cashVoucherDto.ExternalImportReferenceOption.Value != null)
                    writer.WriteString("ExternalImportReference", cashVoucherDto.ExternalImportReference);
                else
                    writer.WriteNull("ExternalImportReference");

            if (cashVoucherDto.IdOption.IsSet)
                writer.WriteString("Id", cashVoucherDto.IdOption.Value!.Value);

            if (cashVoucherDto.ImportedVoucherNoOption.IsSet)
                if (cashVoucherDto.ImportedVoucherNoOption.Value != null)
                    writer.WriteNumber("ImportedVoucherNo", cashVoucherDto.ImportedVoucherNoOption.Value!.Value);
                else
                    writer.WriteNull("ImportedVoucherNo");

            if (cashVoucherDto.IsReversedOption.IsSet)
                if (cashVoucherDto.IsReversedOption.Value != null)
                    writer.WriteBoolean("IsReversed", cashVoucherDto.IsReversedOption.Value!.Value);
                else
                    writer.WriteNull("IsReversed");

            if (cashVoucherDto.SaftBatchIdOption.IsSet)
                if (cashVoucherDto.SaftBatchIdOption.Value != null)
                    writer.WriteString("SaftBatchId", cashVoucherDto.SaftBatchId);
                else
                    writer.WriteNull("SaftBatchId");

            if (cashVoucherDto.SaftSourceIdOption.IsSet)
                if (cashVoucherDto.SaftSourceIdOption.Value != null)
                    writer.WriteString("SaftSourceId", cashVoucherDto.SaftSourceId);
                else
                    writer.WriteNull("SaftSourceId");

            if (cashVoucherDto.VoucherDateOption.IsSet)
                writer.WriteString("VoucherDate", cashVoucherDto.VoucherDateOption.Value!.Value.ToString(VoucherDateFormat));

            if (cashVoucherDto.VoucherLinesOption.IsSet)
                if (cashVoucherDto.VoucherLinesOption.Value != null)
                {
                    writer.WritePropertyName("VoucherLines");
                    JsonSerializer.Serialize(writer, cashVoucherDto.VoucherLines, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("VoucherLines");
            if (cashVoucherDto.VoucherNoOption.IsSet)
                writer.WriteNumber("VoucherNo", cashVoucherDto.VoucherNoOption.Value!.Value);
        }
    }
}
