...
namespace PowerOfficeGoV2.Model
{
    ...
    public partial class DeliveryTermDto : IValidatableObject
    {
        ...
        [JsonConstructor]
        public DeliveryTermDto(Option<DateTimeOffset?> createdDateTimeOffset = default, Option<long?> id = default, Option<bool?> isDefault = default, Option<DateTimeOffset?> lastChangedDateTimeOffset = default, Option<string?> name = default)
        {
