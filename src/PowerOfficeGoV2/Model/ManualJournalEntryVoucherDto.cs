...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class ManualJournalEntryVoucherDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManualJournalEntryVoucherDto" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ManualJournalEntryVoucherDto(Option<string?> currencyCode = default, Option<long?> departmentId = default, Option<string?> description = default, Option<long?> dim1Id = default, Option<long?> dim2Id = default, Option<long?> dim3Id = default, Option<Guid?> id = default, Option<long?> locationId = default, Option<List<ManualJournalEntryVoucherLineDto>?> manualVoucherLines = default, Option<List<VoucherPage>?> pages = default, Option<long?> projectId = default, Option<DateTimeOffset?> voucherDate = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<ManualJournalEntryVoucherLineDto>?> ManualVoucherLinesOption { get; private set; }
        ...
        public List<ManualJournalEntryVoucherLineDto>? ManualVoucherLines { get { return this.ManualVoucherLinesOption; } set { this.ManualVoucherLinesOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ManualJournalEntryVoucherDto {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ManualJournalEntryVoucherDto" />
    /// </summary>
    public class ManualJournalEntryVoucherDtoJsonConverter : JsonConverter<ManualJournalEntryVoucherDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="ManualJournalEntryVoucherDto" />
        /// </summary>
        ...
        public override ManualJournalEntryVoucherDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<ManualJournalEntryVoucherLineDto>?> manualVoucherLines = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "ManualVoucherLines":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                manualVoucherLines = new Option<List<ManualJournalEntryVoucherLineDto>?>(JsonSerializer.Deserialize<List<ManualJournalEntryVoucherLineDto>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "Pages":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class ManualJournalEntryVoucherDto.");

            return new ManualJournalEntryVoucherDto(currencyCode, departmentId, description, dim1Id, dim2Id, dim3Id, id, locationId, manualVoucherLines, pages, projectId, voucherDate);
        }

        /// <summary>
        /// Serializes a <see cref="ManualJournalEntryVoucherDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="manualJournalEntryVoucherDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ManualJournalEntryVoucherDto manualJournalEntryVoucherDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, manualJournalEntryVoucherDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ManualJournalEntryVoucherDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="manualJournalEntryVoucherDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ManualJournalEntryVoucherDto manualJournalEntryVoucherDto, JsonSerializerOptions jsonSerializerOptions)
        {
            if (manualJournalEntryVoucherDto.CurrencyCodeOption.IsSet)
                if (manualJournalEntryVoucherDto.CurrencyCodeOption.Value != null)
                    writer.WriteString("CurrencyCode", manualJournalEntryVoucherDto.CurrencyCode);
                else
                    writer.WriteNull("CurrencyCode");

            if (manualJournalEntryVoucherDto.DepartmentIdOption.IsSet)
                if (manualJournalEntryVoucherDto.DepartmentIdOption.Value != null)
                    writer.WriteNumber("DepartmentId", manualJournalEntryVoucherDto.DepartmentIdOption.Value!.Value);
                else
                    writer.WriteNull("DepartmentId");

            if (manualJournalEntryVoucherDto.DescriptionOption.IsSet)
                if (manualJournalEntryVoucherDto.DescriptionOption.Value != null)
                    writer.WriteString("Description", manualJournalEntryVoucherDto.Description);
                else
                    writer.WriteNull("Description");

            if (manualJournalEntryVoucherDto.Dim1IdOption.IsSet)
                if (manualJournalEntryVoucherDto.Dim1IdOption.Value != null)
                    writer.WriteNumber("Dim1Id", manualJournalEntryVoucherDto.Dim1IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim1Id");

            if (manualJournalEntryVoucherDto.Dim2IdOption.IsSet)
                if (manualJournalEntryVoucherDto.Dim2IdOption.Value != null)
                    writer.WriteNumber("Dim2Id", manualJournalEntryVoucherDto.Dim2IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim2Id");

            if (manualJournalEntryVoucherDto.Dim3IdOption.IsSet)
                if (manualJournalEntryVoucherDto.Dim3IdOption.Value != null)
                    writer.WriteNumber("Dim3Id", manualJournalEntryVoucherDto.Dim3IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim3Id");

            if (manualJournalEntryVoucherDto.IdOption.IsSet)
                writer.WriteString("Id", manualJournalEntryVoucherDto.IdOption.Value!.Value);

            if (manualJournalEntryVoucherDto.LocationIdOption.IsSet)
                if (manualJournalEntryVoucherDto.LocationIdOption.Value != null)
                    writer.WriteNumber("LocationId", manualJournalEntryVoucherDto.LocationIdOption.Value!.Value);
                else
                    writer.WriteNull("LocationId");

            if (manualJournalEntryVoucherDto.ManualVoucherLinesOption.IsSet)
                if (manualJournalEntryVoucherDto.ManualVoucherLinesOption.Value != null)
                {
                    writer.WritePropertyName("ManualVoucherLines");
                    JsonSerializer.Serialize(writer, manualJournalEntryVoucherDto.ManualVoucherLines, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("ManualVoucherLines");
            if (manualJournalEntryVoucherDto.PagesOption.IsSet)
                if (manualJournalEntryVoucherDto.PagesOption.Value != null)
                {
                    writer.WritePropertyName("Pages");
                    JsonSerializer.Serialize(writer, manualJournalEntryVoucherDto.Pages, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("Pages");
            if (manualJournalEntryVoucherDto.ProjectIdOption.IsSet)
                if (manualJournalEntryVoucherDto.ProjectIdOption.Value != null)
                    writer.WriteNumber("ProjectId", manualJournalEntryVoucherDto.ProjectIdOption.Value!.Value);
                else
                    writer.WriteNull("ProjectId");

            if (manualJournalEntryVoucherDto.VoucherDateOption.IsSet)
                if (manualJournalEntryVoucherDto.VoucherDateOption.Value != null)
                    writer.WriteString("VoucherDate", manualJournalEntryVoucherDto.VoucherDateOption.Value!.Value.ToString(VoucherDateFormat));
                else
