...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class BankJournalEntryVoucherLinePostDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BankJournalEntryVoucherLinePostDto" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public BankJournalEntryVoucherLinePostDto(Option<AccrualBase?> accrual = default, Option<AgricultureDetails?> agricultureDetails = default, Option<long?> creditAccountId = default, Option<int?> creditVatId = default, Option<VatReturnSpecification?> creditVatReturnSpecification = default, Option<double?> currencyAmount = default, Option<string?> currencyCode = default, Option<double?> currencyExchangeRate = default, Option<long?> debitAccountId = default, Option<int?> debitVatId = default, Option<VatReturnSpecification?> debitVatReturnSpecification = default, Option<long?> departmentId = default, Option<string?> description = default, Option<long?> dim1Id = default, Option<long?> dim2Id = default, Option<long?> dim3Id = default, Option<string?> invoiceNo = default, Option<long?> locationId = default, Option<DateTimeOffset?> postingDate = default, Option<long?> productId = default, Option<long?> projectId = default, Option<double?> quantity = default, Option<double?> quantity2 = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BankJournalEntryVoucherLinePostDto {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="BankJournalEntryVoucherLinePostDto" />
    /// </summary>
    public class BankJournalEntryVoucherLinePostDtoJsonConverter : JsonConverter<BankJournalEntryVoucherLinePostDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="BankJournalEntryVoucherLinePostDto" />
        /// </summary>
        ...
        public override BankJournalEntryVoucherLinePostDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accrual.IsSet && accrual.Value == null)
                throw new ArgumentNullException(nameof(accrual), "Property is not nullable for class BankJournalEntryVoucherLinePostDto.");

            if (agricultureDetails.IsSet && agricultureDetails.Value == null)
                throw new ArgumentNullException(nameof(agricultureDetails), "Property is not nullable for class BankJournalEntryVoucherLinePostDto.");

            if (currencyAmount.IsSet && currencyAmount.Value == null)
                throw new ArgumentNullException(nameof(currencyAmount), "Property is not nullable for class BankJournalEntryVoucherLinePostDto.");

            return new BankJournalEntryVoucherLinePostDto(accrual, agricultureDetails, creditAccountId, creditVatId, creditVatReturnSpecification, currencyAmount, currencyCode, currencyExchangeRate, debitAccountId, debitVatId, debitVatReturnSpecification, departmentId, description, dim1Id, dim2Id, dim3Id, invoiceNo, locationId, postingDate, productId, projectId, quantity, quantity2);
        }

        /// <summary>
        /// Serializes a <see cref="BankJournalEntryVoucherLinePostDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="bankJournalEntryVoucherLinePostDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BankJournalEntryVoucherLinePostDto bankJournalEntryVoucherLinePostDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, bankJournalEntryVoucherLinePostDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="BankJournalEntryVoucherLinePostDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="bankJournalEntryVoucherLinePostDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BankJournalEntryVoucherLinePostDto bankJournalEntryVoucherLinePostDto, JsonSerializerOptions jsonSerializerOptions)
        {
            if (bankJournalEntryVoucherLinePostDto.AccrualOption.IsSet && bankJournalEntryVoucherLinePostDto.Accrual == null)
                throw new ArgumentNullException(nameof(bankJournalEntryVoucherLinePostDto.Accrual), "Property is required for class BankJournalEntryVoucherLinePostDto.");

            if (bankJournalEntryVoucherLinePostDto.AgricultureDetailsOption.IsSet && bankJournalEntryVoucherLinePostDto.AgricultureDetails == null)
                throw new ArgumentNullException(nameof(bankJournalEntryVoucherLinePostDto.AgricultureDetails), "Property is required for class BankJournalEntryVoucherLinePostDto.");

            if (bankJournalEntryVoucherLinePostDto.AccrualOption.IsSet)
            {
                writer.WritePropertyName("Accrual");
                JsonSerializer.Serialize(writer, bankJournalEntryVoucherLinePostDto.Accrual, jsonSerializerOptions);
            }
            if (bankJournalEntryVoucherLinePostDto.AgricultureDetailsOption.IsSet)
            {
                writer.WritePropertyName("AgricultureDetails");
                JsonSerializer.Serialize(writer, bankJournalEntryVoucherLinePostDto.AgricultureDetails, jsonSerializerOptions);
            }
            if (bankJournalEntryVoucherLinePostDto.CreditAccountIdOption.IsSet)
                if (bankJournalEntryVoucherLinePostDto.CreditAccountIdOption.Value != null)
                    writer.WriteNumber("CreditAccountId", bankJournalEntryVoucherLinePostDto.CreditAccountIdOption.Value!.Value);
                else
                    writer.WriteNull("CreditAccountId");

            if (bankJournalEntryVoucherLinePostDto.CreditVatIdOption.IsSet)
                if (bankJournalEntryVoucherLinePostDto.CreditVatIdOption.Value != null)
                    writer.WriteNumber("CreditVatId", bankJournalEntryVoucherLinePostDto.CreditVatIdOption.Value!.Value);
                else
                    writer.WriteNull("CreditVatId");

            if (bankJournalEntryVoucherLinePostDto.CreditVatReturnSpecificationOption.IsSet)
                if (bankJournalEntryVoucherLinePostDto.CreditVatReturnSpecificationOption!.Value != null)
                {
                    var creditVatReturnSpecificationRawValue = VatReturnSpecificationValueConverter.ToJsonValue(bankJournalEntryVoucherLinePostDto.CreditVatReturnSpecificationOption.Value!.Value);
            ...
            if (bankJournalEntryVoucherLinePostDto.CurrencyAmountOption.IsSet)
                writer.WriteNumber("CurrencyAmount", bankJournalEntryVoucherLinePostDto.CurrencyAmountOption.Value!.Value);

            if (bankJournalEntryVoucherLinePostDto.CurrencyCodeOption.IsSet)
                if (bankJournalEntryVoucherLinePostDto.CurrencyCodeOption.Value != null)
                    writer.WriteString("CurrencyCode", bankJournalEntryVoucherLinePostDto.CurrencyCode);
                else
                    writer.WriteNull("CurrencyCode");

            if (bankJournalEntryVoucherLinePostDto.CurrencyExchangeRateOption.IsSet)
                if (bankJournalEntryVoucherLinePostDto.CurrencyExchangeRateOption.Value != null)
                    writer.WriteNumber("CurrencyExchangeRate", bankJournalEntryVoucherLinePostDto.CurrencyExchangeRateOption.Value!.Value);
                else
                    writer.WriteNull("CurrencyExchangeRate");

            if (bankJournalEntryVoucherLinePostDto.DebitAccountIdOption.IsSet)
                if (bankJournalEntryVoucherLinePostDto.DebitAccountIdOption.Value != null)
                    writer.WriteNumber("DebitAccountId", bankJournalEntryVoucherLinePostDto.DebitAccountIdOption.Value!.Value);
                else
                    writer.WriteNull("DebitAccountId");

            if (bankJournalEntryVoucherLinePostDto.DebitVatIdOption.IsSet)
                if (bankJournalEntryVoucherLinePostDto.DebitVatIdOption.Value != null)
                    writer.WriteNumber("DebitVatId", bankJournalEntryVoucherLinePostDto.DebitVatIdOption.Value!.Value);
                else
                    writer.WriteNull("DebitVatId");

            if (bankJournalEntryVoucherLinePostDto.DebitVatReturnSpecificationOption.IsSet)
                if (bankJournalEntryVoucherLinePostDto.DebitVatReturnSpecificationOption!.Value != null)
                {
                    var debitVatReturnSpecificationRawValue = VatReturnSpecificationValueConverter.ToJsonValue(bankJournalEntryVoucherLinePostDto.DebitVatReturnSpecificationOption.Value!.Value);
            ...
            if (bankJournalEntryVoucherLinePostDto.DepartmentIdOption.IsSet)
                if (bankJournalEntryVoucherLinePostDto.DepartmentIdOption.Value != null)
                    writer.WriteNumber("DepartmentId", bankJournalEntryVoucherLinePostDto.DepartmentIdOption.Value!.Value);
                else
                    writer.WriteNull("DepartmentId");

            if (bankJournalEntryVoucherLinePostDto.DescriptionOption.IsSet)
                if (bankJournalEntryVoucherLinePostDto.DescriptionOption.Value != null)
                    writer.WriteString("Description", bankJournalEntryVoucherLinePostDto.Description);
                else
                    writer.WriteNull("Description");

            if (bankJournalEntryVoucherLinePostDto.Dim1IdOption.IsSet)
                if (bankJournalEntryVoucherLinePostDto.Dim1IdOption.Value != null)
                    writer.WriteNumber("Dim1Id", bankJournalEntryVoucherLinePostDto.Dim1IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim1Id");

            if (bankJournalEntryVoucherLinePostDto.Dim2IdOption.IsSet)
                if (bankJournalEntryVoucherLinePostDto.Dim2IdOption.Value != null)
                    writer.WriteNumber("Dim2Id", bankJournalEntryVoucherLinePostDto.Dim2IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim2Id");

            if (bankJournalEntryVoucherLinePostDto.Dim3IdOption.IsSet)
                if (bankJournalEntryVoucherLinePostDto.Dim3IdOption.Value != null)
                    writer.WriteNumber("Dim3Id", bankJournalEntryVoucherLinePostDto.Dim3IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim3Id");

            if (bankJournalEntryVoucherLinePostDto.InvoiceNoOption.IsSet)
                if (bankJournalEntryVoucherLinePostDto.InvoiceNoOption.Value != null)
                    writer.WriteString("InvoiceNo", bankJournalEntryVoucherLinePostDto.InvoiceNo);
                else
                    writer.WriteNull("InvoiceNo");

            if (bankJournalEntryVoucherLinePostDto.LocationIdOption.IsSet)
                if (bankJournalEntryVoucherLinePostDto.LocationIdOption.Value != null)
                    writer.WriteNumber("LocationId", bankJournalEntryVoucherLinePostDto.LocationIdOption.Value!.Value);
                else
                    writer.WriteNull("LocationId");

            if (bankJournalEntryVoucherLinePostDto.PostingDateOption.IsSet)
                if (bankJournalEntryVoucherLinePostDto.PostingDateOption.Value != null)
                    writer.WriteString("PostingDate", bankJournalEntryVoucherLinePostDto.PostingDateOption.Value!.Value.ToString(PostingDateFormat));
                else
                    writer.WriteNull("PostingDate");

            if (bankJournalEntryVoucherLinePostDto.ProductIdOption.IsSet)
                if (bankJournalEntryVoucherLinePostDto.ProductIdOption.Value != null)
                    writer.WriteNumber("ProductId", bankJournalEntryVoucherLinePostDto.ProductIdOption.Value!.Value);
                else
                    writer.WriteNull("ProductId");

            if (bankJournalEntryVoucherLinePostDto.ProjectIdOption.IsSet)
                if (bankJournalEntryVoucherLinePostDto.ProjectIdOption.Value != null)
                    writer.WriteNumber("ProjectId", bankJournalEntryVoucherLinePostDto.ProjectIdOption.Value!.Value);
                else
                    writer.WriteNull("ProjectId");

            if (bankJournalEntryVoucherLinePostDto.QuantityOption.IsSet)
                if (bankJournalEntryVoucherLinePostDto.QuantityOption.Value != null)
                    writer.WriteNumber("Quantity", bankJournalEntryVoucherLinePostDto.QuantityOption.Value!.Value);
                else
                    writer.WriteNull("Quantity");

            if (bankJournalEntryVoucherLinePostDto.Quantity2Option.IsSet)
                if (bankJournalEntryVoucherLinePostDto.Quantity2Option.Value != null)
                    writer.WriteNumber("Quantity2", bankJournalEntryVoucherLinePostDto.Quantity2Option.Value!.Value);
                else
