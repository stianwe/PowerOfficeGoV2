...
namespace PowerOfficeGoV2.Model
{
    ...
    public partial class ContactDeliveryAddressDto : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ContactDeliveryAddressDto(Option<string?> addressLine1 = default, Option<string?> addressLine2 = default, Option<string?> city = default, Option<long?> contactId = default, Option<string?> countryCode = default, Option<DateTime?> createdDateTimeOffset = default, Option<string?> externalCode = default, Option<long?> id = default, Option<bool?> isPrimary = default, Option<DateTime?> lastChangedDateTimeOffset = default, Option<string?> zipCode = default)
        {
