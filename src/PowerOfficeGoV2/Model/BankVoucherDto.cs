...
namespace PowerOfficeGoV2.Model
{
    ...
    public partial class BankVoucherDto : IValidatableObject
    {
        ...
        [JsonConstructor]
        public BankVoucherDto(Option<DateTimeOffset?> createdDateTimeOffset = default, Option<string?> currencyCode = default, Option<string?> description = default, Option<string?> externalImportReference = default, Option<Guid?> id = default, Option<long?> importedVoucherNo = default, Option<bool?> isReversed = default, Option<string?> saftBatchId = default, Option<string?> saftSourceId = default, Option<DateTimeOffset?> voucherDate = default, Option<List<BankVoucherLineDto>?> voucherLines = default, Option<long?> voucherNo = default)
        {
