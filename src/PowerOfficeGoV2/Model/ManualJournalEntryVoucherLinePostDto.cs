...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class ManualJournalEntryVoucherLinePostDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManualJournalEntryVoucherLinePostDto" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ManualJournalEntryVoucherLinePostDto {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ManualJournalEntryVoucherLinePostDto" />
    /// </summary>
    public class ManualJournalEntryVoucherLinePostDtoJsonConverter : JsonConverter<ManualJournalEntryVoucherLinePostDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="ManualJournalEntryVoucherLinePostDto" />
        /// </summary>
        ...
        public override ManualJournalEntryVoucherLinePostDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accrual.IsSet && accrual.Value == null)
                throw new ArgumentNullException(nameof(accrual), "Property is not nullable for class ManualJournalEntryVoucherLinePostDto.");

            if (agricultureDetails.IsSet && agricultureDetails.Value == null)
                throw new ArgumentNullException(nameof(agricultureDetails), "Property is not nullable for class ManualJournalEntryVoucherLinePostDto.");

            if (currencyAmount.IsSet && currencyAmount.Value == null)
                throw new ArgumentNullException(nameof(currencyAmount), "Property is not nullable for class ManualJournalEntryVoucherLinePostDto.");

            return new ManualJournalEntryVoucherLinePostDto(accrual, agricultureDetails, creditAccountId, creditVatId, creditVatReturnSpecification, currencyAmount, currencyCode, currencyExchangeRate, debitAccountId, debitVatId, debitVatReturnSpecification, departmentId, description, dim1Id, dim2Id, dim3Id, locationId, postingDate, productId, projectId, quantity, quantity2);
        }

        /// <summary>
        /// Serializes a <see cref="ManualJournalEntryVoucherLinePostDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="manualJournalEntryVoucherLinePostDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ManualJournalEntryVoucherLinePostDto manualJournalEntryVoucherLinePostDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, manualJournalEntryVoucherLinePostDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ManualJournalEntryVoucherLinePostDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="manualJournalEntryVoucherLinePostDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ManualJournalEntryVoucherLinePostDto manualJournalEntryVoucherLinePostDto, JsonSerializerOptions jsonSerializerOptions)
        {
            if (manualJournalEntryVoucherLinePostDto.AccrualOption.IsSet && manualJournalEntryVoucherLinePostDto.Accrual == null)
                throw new ArgumentNullException(nameof(manualJournalEntryVoucherLinePostDto.Accrual), "Property is required for class ManualJournalEntryVoucherLinePostDto.");

            if (manualJournalEntryVoucherLinePostDto.AgricultureDetailsOption.IsSet && manualJournalEntryVoucherLinePostDto.AgricultureDetails == null)
                throw new ArgumentNullException(nameof(manualJournalEntryVoucherLinePostDto.AgricultureDetails), "Property is required for class ManualJournalEntryVoucherLinePostDto.");

            if (manualJournalEntryVoucherLinePostDto.AccrualOption.IsSet)
            {
                writer.WritePropertyName("Accrual");
                JsonSerializer.Serialize(writer, manualJournalEntryVoucherLinePostDto.Accrual, jsonSerializerOptions);
            }
            if (manualJournalEntryVoucherLinePostDto.AgricultureDetailsOption.IsSet)
            {
                writer.WritePropertyName("AgricultureDetails");
                JsonSerializer.Serialize(writer, manualJournalEntryVoucherLinePostDto.AgricultureDetails, jsonSerializerOptions);
            }
            if (manualJournalEntryVoucherLinePostDto.CreditAccountIdOption.IsSet)
                if (manualJournalEntryVoucherLinePostDto.CreditAccountIdOption.Value != null)
                    writer.WriteNumber("CreditAccountId", manualJournalEntryVoucherLinePostDto.CreditAccountIdOption.Value!.Value);
                else
                    writer.WriteNull("CreditAccountId");

            if (manualJournalEntryVoucherLinePostDto.CreditVatIdOption.IsSet)
                if (manualJournalEntryVoucherLinePostDto.CreditVatIdOption.Value != null)
                    writer.WriteNumber("CreditVatId", manualJournalEntryVoucherLinePostDto.CreditVatIdOption.Value!.Value);
                else
                    writer.WriteNull("CreditVatId");

            if (manualJournalEntryVoucherLinePostDto.CreditVatReturnSpecificationOption.IsSet)
                if (manualJournalEntryVoucherLinePostDto.CreditVatReturnSpecificationOption!.Value != null)
                {
                    var creditVatReturnSpecificationRawValue = VatReturnSpecificationValueConverter.ToJsonValue(manualJournalEntryVoucherLinePostDto.CreditVatReturnSpecificationOption.Value!.Value);
            ...
            if (manualJournalEntryVoucherLinePostDto.CurrencyAmountOption.IsSet)
                writer.WriteNumber("CurrencyAmount", manualJournalEntryVoucherLinePostDto.CurrencyAmountOption.Value!.Value);

            if (manualJournalEntryVoucherLinePostDto.CurrencyCodeOption.IsSet)
                if (manualJournalEntryVoucherLinePostDto.CurrencyCodeOption.Value != null)
                    writer.WriteString("CurrencyCode", manualJournalEntryVoucherLinePostDto.CurrencyCode);
                else
                    writer.WriteNull("CurrencyCode");

            if (manualJournalEntryVoucherLinePostDto.CurrencyExchangeRateOption.IsSet)
                if (manualJournalEntryVoucherLinePostDto.CurrencyExchangeRateOption.Value != null)
                    writer.WriteNumber("CurrencyExchangeRate", manualJournalEntryVoucherLinePostDto.CurrencyExchangeRateOption.Value!.Value);
                else
                    writer.WriteNull("CurrencyExchangeRate");

            if (manualJournalEntryVoucherLinePostDto.DebitAccountIdOption.IsSet)
                if (manualJournalEntryVoucherLinePostDto.DebitAccountIdOption.Value != null)
                    writer.WriteNumber("DebitAccountId", manualJournalEntryVoucherLinePostDto.DebitAccountIdOption.Value!.Value);
                else
                    writer.WriteNull("DebitAccountId");

            if (manualJournalEntryVoucherLinePostDto.DebitVatIdOption.IsSet)
                if (manualJournalEntryVoucherLinePostDto.DebitVatIdOption.Value != null)
                    writer.WriteNumber("DebitVatId", manualJournalEntryVoucherLinePostDto.DebitVatIdOption.Value!.Value);
                else
                    writer.WriteNull("DebitVatId");

            if (manualJournalEntryVoucherLinePostDto.DebitVatReturnSpecificationOption.IsSet)
                if (manualJournalEntryVoucherLinePostDto.DebitVatReturnSpecificationOption!.Value != null)
                {
                    var debitVatReturnSpecificationRawValue = VatReturnSpecificationValueConverter.ToJsonValue(manualJournalEntryVoucherLinePostDto.DebitVatReturnSpecificationOption.Value!.Value);
            ...
            if (manualJournalEntryVoucherLinePostDto.DepartmentIdOption.IsSet)
                if (manualJournalEntryVoucherLinePostDto.DepartmentIdOption.Value != null)
                    writer.WriteNumber("DepartmentId", manualJournalEntryVoucherLinePostDto.DepartmentIdOption.Value!.Value);
                else
                    writer.WriteNull("DepartmentId");

            if (manualJournalEntryVoucherLinePostDto.DescriptionOption.IsSet)
                if (manualJournalEntryVoucherLinePostDto.DescriptionOption.Value != null)
                    writer.WriteString("Description", manualJournalEntryVoucherLinePostDto.Description);
                else
                    writer.WriteNull("Description");

            if (manualJournalEntryVoucherLinePostDto.Dim1IdOption.IsSet)
                if (manualJournalEntryVoucherLinePostDto.Dim1IdOption.Value != null)
                    writer.WriteNumber("Dim1Id", manualJournalEntryVoucherLinePostDto.Dim1IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim1Id");

            if (manualJournalEntryVoucherLinePostDto.Dim2IdOption.IsSet)
                if (manualJournalEntryVoucherLinePostDto.Dim2IdOption.Value != null)
                    writer.WriteNumber("Dim2Id", manualJournalEntryVoucherLinePostDto.Dim2IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim2Id");

            if (manualJournalEntryVoucherLinePostDto.Dim3IdOption.IsSet)
                if (manualJournalEntryVoucherLinePostDto.Dim3IdOption.Value != null)
                    writer.WriteNumber("Dim3Id", manualJournalEntryVoucherLinePostDto.Dim3IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim3Id");

            if (manualJournalEntryVoucherLinePostDto.LocationIdOption.IsSet)
                if (manualJournalEntryVoucherLinePostDto.LocationIdOption.Value != null)
                    writer.WriteNumber("LocationId", manualJournalEntryVoucherLinePostDto.LocationIdOption.Value!.Value);
                else
                    writer.WriteNull("LocationId");

            if (manualJournalEntryVoucherLinePostDto.PostingDateOption.IsSet)
                if (manualJournalEntryVoucherLinePostDto.PostingDateOption.Value != null)
                    writer.WriteString("PostingDate", manualJournalEntryVoucherLinePostDto.PostingDateOption.Value!.Value.ToString(PostingDateFormat));
                else
                    writer.WriteNull("PostingDate");

            if (manualJournalEntryVoucherLinePostDto.ProductIdOption.IsSet)
                if (manualJournalEntryVoucherLinePostDto.ProductIdOption.Value != null)
                    writer.WriteNumber("ProductId", manualJournalEntryVoucherLinePostDto.ProductIdOption.Value!.Value);
                else
                    writer.WriteNull("ProductId");

            if (manualJournalEntryVoucherLinePostDto.ProjectIdOption.IsSet)
                if (manualJournalEntryVoucherLinePostDto.ProjectIdOption.Value != null)
                    writer.WriteNumber("ProjectId", manualJournalEntryVoucherLinePostDto.ProjectIdOption.Value!.Value);
                else
                    writer.WriteNull("ProjectId");

            if (manualJournalEntryVoucherLinePostDto.QuantityOption.IsSet)
                if (manualJournalEntryVoucherLinePostDto.QuantityOption.Value != null)
                    writer.WriteNumber("Quantity", manualJournalEntryVoucherLinePostDto.QuantityOption.Value!.Value);
                else
                    writer.WriteNull("Quantity");

            if (manualJournalEntryVoucherLinePostDto.Quantity2Option.IsSet)
                if (manualJournalEntryVoucherLinePostDto.Quantity2Option.Value != null)
                    writer.WriteNumber("Quantity2", manualJournalEntryVoucherLinePostDto.Quantity2Option.Value!.Value);
                else
