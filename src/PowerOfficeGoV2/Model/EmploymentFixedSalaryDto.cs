...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class EmploymentFixedSalaryDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmploymentFixedSalaryDto" /> class.
        /// </summary>
        ...
        /// <param name="createdDateTimeOffset">The timestamp when the employment fixed salary entity was created.</param>
        ...
        /// <param name="employmentId">The id of the employment (employment relationship) the fixed salary line belongs to.</param>
        ...
        /// <param name="id">The id of the employment fixed salary (line).</param>
        ...
        /// <param name="isActive">Value indicating whether this (fixed) salary line should be included when creating a new payroll.  If true then this (fixed) salary line will be included in the payroll.  Defaults to true if not set.</param>
        ...
        /// <param name="lastChangedDateTimeOffset">The timestamp when the employment fixed salary entity was last changed.</param>
        ...
        /// <param name="useRemittance">Value indicating whether to use remittance or not.  Only relevant to set for pay items with the following processing types: TradeUnionDeduction and AttachmentOfEarnings.  Defaults to true if not set.</param>
        ...
        [JsonConstructor]
        public EmploymentFixedSalaryDto(Option<long?> accountId = default, Option<double?> amount = default, Option<double?> carListPrice = default, Option<DateOnly?> carRegistrationDate = default, Option<string?> carRegistrationNo = default, Option<string?> cid = default, Option<string?> comment = default, Option<CommuterPersonType?> commuterPersonType = default, Option<DateTime?> createdDateTimeOffset = default, Option<DeductionType?> deductionType = default, Option<long?> departmentId = default, Option<long?> employeeId = default, Option<long?> employmentId = default, Option<DateOnly?> fromDate = default, Option<double?> homeWorkKilometers = default, Option<Guid?> id = default, Option<int?> incomeYear = default, Option<bool?> isActive = default, Option<bool?> isCarPool = default, Option<DateTime?> lastChangedDateTimeOffset = default, Option<double?> maxAmount = default, Option<string?> memberNo = default, Option<double?> minAmount = default, Option<int?> number = default, Option<long?> oppositeAccountId = default, Option<Guid?> payItemId = default, Option<double?> privateDrivenKilometers = default, Option<long?> projectId = default, Option<double?> quantity = default, Option<double?> rate = default, Option<double?> startAmount = default, Option<long?> supplierAccountId = default, Option<long?> supplierBankAccountId = default, Option<TaxDeductionType?> taxDeduction = default, Option<TaxRuleType?> taxRule = default, Option<DateOnly?> toDate = default, Option<bool?> useRemittance = default, Option<int?> vatCodeId = default, Option<bool?> workDriveExceedsKilometerLimit = default)
        {
        ...
        /// </summary>
        /// <value>The timestamp when the employment fixed salary entity was created.</value>
        ...
        /// </summary>
        /// <value>The id of the employment (employment relationship) the fixed salary line belongs to.</value>
        /* <example>12345</example> */
        ...
        /// </summary>
        /// <value>The id of the employment fixed salary (line).</value>
        ...
        /// <summary>
        /// Value indicating whether this (fixed) salary line should be included when creating a new payroll.  If true then this (fixed) salary line will be included in the payroll.  Defaults to true if not set.
        /// </summary>
        /// <value>Value indicating whether this (fixed) salary line should be included when creating a new payroll.  If true then this (fixed) salary line will be included in the payroll.  Defaults to true if not set.</value>
        ...
        /// </summary>
        /// <value>The timestamp when the employment fixed salary entity was last changed.</value>
        ...
        /// <summary>
        /// Used to track the state of PayItemId
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<Guid?> PayItemIdOption { get; private set; }
        ...
        public Guid? PayItemId { get { return this.PayItemIdOption; } set { this.PayItemIdOption = new(value); } }
        ...
        /// <summary>
        /// Value indicating whether to use remittance or not.  Only relevant to set for pay items with the following processing types: TradeUnionDeduction and AttachmentOfEarnings.  Defaults to true if not set.
        /// </summary>
        /// <value>Value indicating whether to use remittance or not.  Only relevant to set for pay items with the following processing types: TradeUnionDeduction and AttachmentOfEarnings.  Defaults to true if not set.</value>
        /* <example>true</example> */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmploymentFixedSalaryDto {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="EmploymentFixedSalaryDto" />
    /// </summary>
    public class EmploymentFixedSalaryDtoJsonConverter : JsonConverter<EmploymentFixedSalaryDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="EmploymentFixedSalaryDto" />
        /// </summary>
        ...
        public override EmploymentFixedSalaryDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createdDateTimeOffset.IsSet && createdDateTimeOffset.Value == null)
                throw new ArgumentNullException(nameof(createdDateTimeOffset), "Property is not nullable for class EmploymentFixedSalaryDto.");

            if (employeeId.IsSet && employeeId.Value == null)
                throw new ArgumentNullException(nameof(employeeId), "Property is not nullable for class EmploymentFixedSalaryDto.");

            if (employmentId.IsSet && employmentId.Value == null)
                throw new ArgumentNullException(nameof(employmentId), "Property is not nullable for class EmploymentFixedSalaryDto.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class EmploymentFixedSalaryDto.");

            if (lastChangedDateTimeOffset.IsSet && lastChangedDateTimeOffset.Value == null)
                throw new ArgumentNullException(nameof(lastChangedDateTimeOffset), "Property is not nullable for class EmploymentFixedSalaryDto.");

            return new EmploymentFixedSalaryDto(accountId, amount, carListPrice, carRegistrationDate, carRegistrationNo, cid, comment, commuterPersonType, createdDateTimeOffset, deductionType, departmentId, employeeId, employmentId, fromDate, homeWorkKilometers, id, incomeYear, isActive, isCarPool, lastChangedDateTimeOffset, maxAmount, memberNo, minAmount, number, oppositeAccountId, payItemId, privateDrivenKilometers, projectId, quantity, rate, startAmount, supplierAccountId, supplierBankAccountId, taxDeduction, taxRule, toDate, useRemittance, vatCodeId, workDriveExceedsKilometerLimit);
        }

        /// <summary>
        /// Serializes a <see cref="EmploymentFixedSalaryDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="employmentFixedSalaryDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EmploymentFixedSalaryDto employmentFixedSalaryDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, employmentFixedSalaryDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EmploymentFixedSalaryDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="employmentFixedSalaryDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EmploymentFixedSalaryDto employmentFixedSalaryDto, JsonSerializerOptions jsonSerializerOptions)
        {
            if (employmentFixedSalaryDto.AccountIdOption.IsSet)
                if (employmentFixedSalaryDto.AccountIdOption.Value != null)
                    writer.WriteNumber("AccountId", employmentFixedSalaryDto.AccountIdOption.Value!.Value);
                else
                    writer.WriteNull("AccountId");

            if (employmentFixedSalaryDto.AmountOption.IsSet)
                if (employmentFixedSalaryDto.AmountOption.Value != null)
                    writer.WriteNumber("Amount", employmentFixedSalaryDto.AmountOption.Value!.Value);
                else
                    writer.WriteNull("Amount");

            if (employmentFixedSalaryDto.CarListPriceOption.IsSet)
                if (employmentFixedSalaryDto.CarListPriceOption.Value != null)
                    writer.WriteNumber("CarListPrice", employmentFixedSalaryDto.CarListPriceOption.Value!.Value);
                else
                    writer.WriteNull("CarListPrice");

            if (employmentFixedSalaryDto.CarRegistrationDateOption.IsSet)
                if (employmentFixedSalaryDto.CarRegistrationDateOption.Value != null)
                    writer.WriteString("CarRegistrationDate", employmentFixedSalaryDto.CarRegistrationDateOption.Value!.Value.ToString(CarRegistrationDateFormat));
                else
                    writer.WriteNull("CarRegistrationDate");

            if (employmentFixedSalaryDto.CarRegistrationNoOption.IsSet)
                if (employmentFixedSalaryDto.CarRegistrationNoOption.Value != null)
                    writer.WriteString("CarRegistrationNo", employmentFixedSalaryDto.CarRegistrationNo);
                else
                    writer.WriteNull("CarRegistrationNo");

            if (employmentFixedSalaryDto.CidOption.IsSet)
                if (employmentFixedSalaryDto.CidOption.Value != null)
                    writer.WriteString("Cid", employmentFixedSalaryDto.Cid);
                else
                    writer.WriteNull("Cid");

            if (employmentFixedSalaryDto.CommentOption.IsSet)
                if (employmentFixedSalaryDto.CommentOption.Value != null)
                    writer.WriteString("Comment", employmentFixedSalaryDto.Comment);
                else
                    writer.WriteNull("Comment");

            if (employmentFixedSalaryDto.CommuterPersonTypeOption.IsSet)
                if (employmentFixedSalaryDto.CommuterPersonTypeOption!.Value != null)
                {
                    var commuterPersonTypeRawValue = CommuterPersonTypeValueConverter.ToJsonValue(employmentFixedSalaryDto.CommuterPersonTypeOption.Value!.Value);
                    writer.WriteString("CommuterPersonType", commuterPersonTypeRawValue);
                }
                else
                    writer.WriteNull("CommuterPersonType");
            if (employmentFixedSalaryDto.CreatedDateTimeOffsetOption.IsSet)
                writer.WriteString("CreatedDateTimeOffset", employmentFixedSalaryDto.CreatedDateTimeOffsetOption.Value!.Value.ToString(CreatedDateTimeOffsetFormat));

            if (employmentFixedSalaryDto.DeductionTypeOption.IsSet)
                if (employmentFixedSalaryDto.DeductionTypeOption!.Value != null)
                {
                    var deductionTypeRawValue = DeductionTypeValueConverter.ToJsonValue(employmentFixedSalaryDto.DeductionTypeOption.Value!.Value);
                    writer.WriteString("DeductionType", deductionTypeRawValue);
                }
                else
                    writer.WriteNull("DeductionType");
            if (employmentFixedSalaryDto.DepartmentIdOption.IsSet)
                if (employmentFixedSalaryDto.DepartmentIdOption.Value != null)
                    writer.WriteNumber("DepartmentId", employmentFixedSalaryDto.DepartmentIdOption.Value!.Value);
                else
                    writer.WriteNull("DepartmentId");

            if (employmentFixedSalaryDto.EmployeeIdOption.IsSet)
                writer.WriteNumber("EmployeeId", employmentFixedSalaryDto.EmployeeIdOption.Value!.Value);

            if (employmentFixedSalaryDto.EmploymentIdOption.IsSet)
                writer.WriteNumber("EmploymentId", employmentFixedSalaryDto.EmploymentIdOption.Value!.Value);

            if (employmentFixedSalaryDto.FromDateOption.IsSet)
                if (employmentFixedSalaryDto.FromDateOption.Value != null)
                    writer.WriteString("FromDate", employmentFixedSalaryDto.FromDateOption.Value!.Value.ToString(FromDateFormat));
                else
                    writer.WriteNull("FromDate");

            if (employmentFixedSalaryDto.HomeWorkKilometersOption.IsSet)
                if (employmentFixedSalaryDto.HomeWorkKilometersOption.Value != null)
                    writer.WriteNumber("HomeWorkKilometers", employmentFixedSalaryDto.HomeWorkKilometersOption.Value!.Value);
                else
                    writer.WriteNull("HomeWorkKilometers");

            if (employmentFixedSalaryDto.IdOption.IsSet)
                writer.WriteString("Id", employmentFixedSalaryDto.IdOption.Value!.Value);

            if (employmentFixedSalaryDto.IncomeYearOption.IsSet)
                if (employmentFixedSalaryDto.IncomeYearOption.Value != null)
                    writer.WriteNumber("IncomeYear", employmentFixedSalaryDto.IncomeYearOption.Value!.Value);
                else
                    writer.WriteNull("IncomeYear");

            if (employmentFixedSalaryDto.IsActiveOption.IsSet)
                if (employmentFixedSalaryDto.IsActiveOption.Value != null)
                    writer.WriteBoolean("IsActive", employmentFixedSalaryDto.IsActiveOption.Value!.Value);
                else
                    writer.WriteNull("IsActive");

            if (employmentFixedSalaryDto.IsCarPoolOption.IsSet)
                if (employmentFixedSalaryDto.IsCarPoolOption.Value != null)
                    writer.WriteBoolean("IsCarPool", employmentFixedSalaryDto.IsCarPoolOption.Value!.Value);
                else
                    writer.WriteNull("IsCarPool");

            if (employmentFixedSalaryDto.LastChangedDateTimeOffsetOption.IsSet)
                writer.WriteString("LastChangedDateTimeOffset", employmentFixedSalaryDto.LastChangedDateTimeOffsetOption.Value!.Value.ToString(LastChangedDateTimeOffsetFormat));

            if (employmentFixedSalaryDto.MaxAmountOption.IsSet)
                if (employmentFixedSalaryDto.MaxAmountOption.Value != null)
                    writer.WriteNumber("MaxAmount", employmentFixedSalaryDto.MaxAmountOption.Value!.Value);
                else
                    writer.WriteNull("MaxAmount");

            if (employmentFixedSalaryDto.MemberNoOption.IsSet)
                if (employmentFixedSalaryDto.MemberNoOption.Value != null)
                    writer.WriteString("MemberNo", employmentFixedSalaryDto.MemberNo);
                else
                    writer.WriteNull("MemberNo");

            if (employmentFixedSalaryDto.MinAmountOption.IsSet)
                if (employmentFixedSalaryDto.MinAmountOption.Value != null)
                    writer.WriteNumber("MinAmount", employmentFixedSalaryDto.MinAmountOption.Value!.Value);
                else
                    writer.WriteNull("MinAmount");

            if (employmentFixedSalaryDto.NumberOption.IsSet)
                if (employmentFixedSalaryDto.NumberOption.Value != null)
                    writer.WriteNumber("Number", employmentFixedSalaryDto.NumberOption.Value!.Value);
                else
                    writer.WriteNull("Number");

            if (employmentFixedSalaryDto.OppositeAccountIdOption.IsSet)
                if (employmentFixedSalaryDto.OppositeAccountIdOption.Value != null)
                    writer.WriteNumber("OppositeAccountId", employmentFixedSalaryDto.OppositeAccountIdOption.Value!.Value);
                else
                    writer.WriteNull("OppositeAccountId");

            if (employmentFixedSalaryDto.PayItemIdOption.IsSet)
                if (employmentFixedSalaryDto.PayItemIdOption.Value != null)
                    writer.WriteString("PayItemId", employmentFixedSalaryDto.PayItemIdOption.Value!.Value);
                else
                    writer.WriteNull("PayItemId");

            if (employmentFixedSalaryDto.PrivateDrivenKilometersOption.IsSet)
                if (employmentFixedSalaryDto.PrivateDrivenKilometersOption.Value != null)
                    writer.WriteNumber("PrivateDrivenKilometers", employmentFixedSalaryDto.PrivateDrivenKilometersOption.Value!.Value);
                else
                    writer.WriteNull("PrivateDrivenKilometers");

            if (employmentFixedSalaryDto.ProjectIdOption.IsSet)
                if (employmentFixedSalaryDto.ProjectIdOption.Value != null)
                    writer.WriteNumber("ProjectId", employmentFixedSalaryDto.ProjectIdOption.Value!.Value);
                else
                    writer.WriteNull("ProjectId");

            if (employmentFixedSalaryDto.QuantityOption.IsSet)
                if (employmentFixedSalaryDto.QuantityOption.Value != null)
                    writer.WriteNumber("Quantity", employmentFixedSalaryDto.QuantityOption.Value!.Value);
                else
                    writer.WriteNull("Quantity");

            if (employmentFixedSalaryDto.RateOption.IsSet)
                if (employmentFixedSalaryDto.RateOption.Value != null)
                    writer.WriteNumber("Rate", employmentFixedSalaryDto.RateOption.Value!.Value);
                else
                    writer.WriteNull("Rate");

            if (employmentFixedSalaryDto.StartAmountOption.IsSet)
                if (employmentFixedSalaryDto.StartAmountOption.Value != null)
                    writer.WriteNumber("StartAmount", employmentFixedSalaryDto.StartAmountOption.Value!.Value);
                else
                    writer.WriteNull("StartAmount");

            if (employmentFixedSalaryDto.SupplierAccountIdOption.IsSet)
                if (employmentFixedSalaryDto.SupplierAccountIdOption.Value != null)
                    writer.WriteNumber("SupplierAccountId", employmentFixedSalaryDto.SupplierAccountIdOption.Value!.Value);
                else
                    writer.WriteNull("SupplierAccountId");

            if (employmentFixedSalaryDto.SupplierBankAccountIdOption.IsSet)
                if (employmentFixedSalaryDto.SupplierBankAccountIdOption.Value != null)
                    writer.WriteNumber("SupplierBankAccountId", employmentFixedSalaryDto.SupplierBankAccountIdOption.Value!.Value);
                else
                    writer.WriteNull("SupplierBankAccountId");

            if (employmentFixedSalaryDto.TaxDeductionOption.IsSet)
                if (employmentFixedSalaryDto.TaxDeductionOption!.Value != null)
                {
                    var taxDeductionRawValue = TaxDeductionTypeValueConverter.ToJsonValue(employmentFixedSalaryDto.TaxDeductionOption.Value!.Value);
                    writer.WriteString("TaxDeduction", taxDeductionRawValue);
                }
                else
                    writer.WriteNull("TaxDeduction");
            if (employmentFixedSalaryDto.TaxRuleOption.IsSet)
                if (employmentFixedSalaryDto.TaxRuleOption!.Value != null)
                {
                    var taxRuleRawValue = TaxRuleTypeValueConverter.ToJsonValue(employmentFixedSalaryDto.TaxRuleOption.Value!.Value);
                    writer.WriteString("TaxRule", taxRuleRawValue);
                }
                else
                    writer.WriteNull("TaxRule");
            if (employmentFixedSalaryDto.ToDateOption.IsSet)
                if (employmentFixedSalaryDto.ToDateOption.Value != null)
                    writer.WriteString("ToDate", employmentFixedSalaryDto.ToDateOption.Value!.Value.ToString(ToDateFormat));
                else
                    writer.WriteNull("ToDate");

            if (employmentFixedSalaryDto.UseRemittanceOption.IsSet)
                if (employmentFixedSalaryDto.UseRemittanceOption.Value != null)
                    writer.WriteBoolean("UseRemittance", employmentFixedSalaryDto.UseRemittanceOption.Value!.Value);
                else
                    writer.WriteNull("UseRemittance");

            if (employmentFixedSalaryDto.VatCodeIdOption.IsSet)
                if (employmentFixedSalaryDto.VatCodeIdOption.Value != null)
                    writer.WriteNumber("VatCodeId", employmentFixedSalaryDto.VatCodeIdOption.Value!.Value);
                else
                    writer.WriteNull("VatCodeId");

            if (employmentFixedSalaryDto.WorkDriveExceedsKilometerLimitOption.IsSet)
                if (employmentFixedSalaryDto.WorkDriveExceedsKilometerLimitOption.Value != null)
                    writer.WriteBoolean("WorkDriveExceedsKilometerLimit", employmentFixedSalaryDto.WorkDriveExceedsKilometerLimitOption.Value!.Value);
                else
