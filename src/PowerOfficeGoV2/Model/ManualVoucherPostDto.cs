...
namespace PowerOfficeGoV2.Model
{
    ...
    public partial class ManualVoucherPostDto : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ManualVoucherPostDto(DateOnly voucherDate, string? currencyCode = default, Option<string?> description = default, Option<string?> externalImportReference = default, Option<long?> importedVoucherNo = default, Option<string?> saftBatchId = default, Option<string?> saftSourceId = default, Option<List<ManualVoucherLinePostDto>?> voucherLines = default)
        {
