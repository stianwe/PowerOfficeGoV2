...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class ManualVoucherPostDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManualVoucherPostDto" /> class.
        /// </summary>
        ...
        /// <param name="voucherLines">The lines of the manual voucher to be posted</param>
        [JsonConstructor]
        public ManualVoucherPostDto(DateTimeOffset voucherDate, string? currencyCode = default, Option<string?> description = default, Option<string?> externalImportReference = default, Option<long?> importedVoucherNo = default, Option<string?> saftBatchId = default, Option<string?> saftSourceId = default, Option<List<ManualVoucherLinePostDto>?> voucherLines = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<ManualVoucherLinePostDto>?> VoucherLinesOption { get; private set; }

        /// <summary>
        /// The lines of the manual voucher to be posted
        /// </summary>
        /// <value>The lines of the manual voucher to be posted</value>
        [JsonPropertyName("VoucherLines")]
        public List<ManualVoucherLinePostDto>? VoucherLines { get { return this.VoucherLinesOption; } set { this.VoucherLinesOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ManualVoucherPostDto {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ManualVoucherPostDto" />
    /// </summary>
    public class ManualVoucherPostDtoJsonConverter : JsonConverter<ManualVoucherPostDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="ManualVoucherPostDto" />
        /// </summary>
        ...
        public override ManualVoucherPostDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<ManualVoucherLinePostDto>?> voucherLines = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "VoucherLines":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                voucherLines = new Option<List<ManualVoucherLinePostDto>?>(JsonSerializer.Deserialize<List<ManualVoucherLinePostDto>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        default:
                            break;
                    }
            ...
            if (!voucherDate.IsSet)
                throw new ArgumentException("Property is required for class ManualVoucherPostDto.", nameof(voucherDate));

            if (!currencyCode.IsSet)
                throw new ArgumentException("Property is required for class ManualVoucherPostDto.", nameof(currencyCode));

            if (voucherDate.IsSet && voucherDate.Value == null)
                throw new ArgumentNullException(nameof(voucherDate), "Property is not nullable for class ManualVoucherPostDto.");

            return new ManualVoucherPostDto(voucherDate.Value!.Value!, currencyCode.Value!, description, externalImportReference, importedVoucherNo, saftBatchId, saftSourceId, voucherLines);
        }

        /// <summary>
        /// Serializes a <see cref="ManualVoucherPostDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="manualVoucherPostDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ManualVoucherPostDto manualVoucherPostDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, manualVoucherPostDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ManualVoucherPostDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="manualVoucherPostDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ManualVoucherPostDto manualVoucherPostDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteString("VoucherDate", manualVoucherPostDto.VoucherDate.ToString(VoucherDateFormat));

            if (manualVoucherPostDto.CurrencyCode != null)
                writer.WriteString("CurrencyCode", manualVoucherPostDto.CurrencyCode);
            else
                writer.WriteNull("CurrencyCode");

            if (manualVoucherPostDto.DescriptionOption.IsSet)
                if (manualVoucherPostDto.DescriptionOption.Value != null)
                    writer.WriteString("Description", manualVoucherPostDto.Description);
                else
                    writer.WriteNull("Description");

            if (manualVoucherPostDto.ExternalImportReferenceOption.IsSet)
                if (manualVoucherPostDto.ExternalImportReferenceOption.Value != null)
                    writer.WriteString("ExternalImportReference", manualVoucherPostDto.ExternalImportReference);
                else
                    writer.WriteNull("ExternalImportReference");

            if (manualVoucherPostDto.ImportedVoucherNoOption.IsSet)
                if (manualVoucherPostDto.ImportedVoucherNoOption.Value != null)
                    writer.WriteNumber("ImportedVoucherNo", manualVoucherPostDto.ImportedVoucherNoOption.Value!.Value);
                else
                    writer.WriteNull("ImportedVoucherNo");

            if (manualVoucherPostDto.SaftBatchIdOption.IsSet)
                if (manualVoucherPostDto.SaftBatchIdOption.Value != null)
                    writer.WriteString("SaftBatchId", manualVoucherPostDto.SaftBatchId);
                else
                    writer.WriteNull("SaftBatchId");

            if (manualVoucherPostDto.SaftSourceIdOption.IsSet)
                if (manualVoucherPostDto.SaftSourceIdOption.Value != null)
                    writer.WriteString("SaftSourceId", manualVoucherPostDto.SaftSourceId);
                else
                    writer.WriteNull("SaftSourceId");

            if (manualVoucherPostDto.VoucherLinesOption.IsSet)
                if (manualVoucherPostDto.VoucherLinesOption.Value != null)
                {
                    writer.WritePropertyName("VoucherLines");
                    JsonSerializer.Serialize(writer, manualVoucherPostDto.VoucherLines, jsonSerializerOptions);
                }
                else
