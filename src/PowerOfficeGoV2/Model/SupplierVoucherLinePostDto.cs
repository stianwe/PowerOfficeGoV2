...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class SupplierVoucherLinePostDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SupplierVoucherLinePostDto" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public SupplierVoucherLinePostDto(Option<AccrualBase?> accrual = default, Option<AgricultureDetails?> agricultureDetails = default, Option<long?> creditAccountId = default, Option<int?> creditVatId = default, Option<VatReturnSpecification?> creditVatReturnSpecification = default, Option<double?> currencyAmount = default, Option<long?> debitAccountId = default, Option<int?> debitVatId = default, Option<VatReturnSpecification?> debitVatReturnSpecification = default, Option<long?> departmentId = default, Option<string?> description = default, Option<long?> dim1Id = default, Option<long?> dim2Id = default, Option<long?> dim3Id = default, Option<long?> locationId = default, Option<long?> productId = default, Option<long?> projectId = default, Option<double?> quantity = default, Option<double?> quantity2 = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SupplierVoucherLinePostDto {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="SupplierVoucherLinePostDto" />
    /// </summary>
    public class SupplierVoucherLinePostDtoJsonConverter : JsonConverter<SupplierVoucherLinePostDto>
    {
        /// <summary>
        /// Deserializes json to <see cref="SupplierVoucherLinePostDto" />
        /// </summary>
        ...
        public override SupplierVoucherLinePostDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accrual.IsSet && accrual.Value == null)
                throw new ArgumentNullException(nameof(accrual), "Property is not nullable for class SupplierVoucherLinePostDto.");

            if (agricultureDetails.IsSet && agricultureDetails.Value == null)
                throw new ArgumentNullException(nameof(agricultureDetails), "Property is not nullable for class SupplierVoucherLinePostDto.");

            if (currencyAmount.IsSet && currencyAmount.Value == null)
                throw new ArgumentNullException(nameof(currencyAmount), "Property is not nullable for class SupplierVoucherLinePostDto.");

            return new SupplierVoucherLinePostDto(accrual, agricultureDetails, creditAccountId, creditVatId, creditVatReturnSpecification, currencyAmount, debitAccountId, debitVatId, debitVatReturnSpecification, departmentId, description, dim1Id, dim2Id, dim3Id, locationId, productId, projectId, quantity, quantity2);
        }

        /// <summary>
        /// Serializes a <see cref="SupplierVoucherLinePostDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="supplierVoucherLinePostDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SupplierVoucherLinePostDto supplierVoucherLinePostDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, supplierVoucherLinePostDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SupplierVoucherLinePostDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="supplierVoucherLinePostDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SupplierVoucherLinePostDto supplierVoucherLinePostDto, JsonSerializerOptions jsonSerializerOptions)
        {
            if (supplierVoucherLinePostDto.AccrualOption.IsSet && supplierVoucherLinePostDto.Accrual == null)
                throw new ArgumentNullException(nameof(supplierVoucherLinePostDto.Accrual), "Property is required for class SupplierVoucherLinePostDto.");

            if (supplierVoucherLinePostDto.AgricultureDetailsOption.IsSet && supplierVoucherLinePostDto.AgricultureDetails == null)
                throw new ArgumentNullException(nameof(supplierVoucherLinePostDto.AgricultureDetails), "Property is required for class SupplierVoucherLinePostDto.");

            if (supplierVoucherLinePostDto.AccrualOption.IsSet)
            {
                writer.WritePropertyName("Accrual");
                JsonSerializer.Serialize(writer, supplierVoucherLinePostDto.Accrual, jsonSerializerOptions);
            }
            if (supplierVoucherLinePostDto.AgricultureDetailsOption.IsSet)
            {
                writer.WritePropertyName("AgricultureDetails");
                JsonSerializer.Serialize(writer, supplierVoucherLinePostDto.AgricultureDetails, jsonSerializerOptions);
            }
            if (supplierVoucherLinePostDto.CreditAccountIdOption.IsSet)
                if (supplierVoucherLinePostDto.CreditAccountIdOption.Value != null)
                    writer.WriteNumber("CreditAccountId", supplierVoucherLinePostDto.CreditAccountIdOption.Value!.Value);
                else
                    writer.WriteNull("CreditAccountId");

            if (supplierVoucherLinePostDto.CreditVatIdOption.IsSet)
                if (supplierVoucherLinePostDto.CreditVatIdOption.Value != null)
                    writer.WriteNumber("CreditVatId", supplierVoucherLinePostDto.CreditVatIdOption.Value!.Value);
                else
                    writer.WriteNull("CreditVatId");

            if (supplierVoucherLinePostDto.CreditVatReturnSpecificationOption.IsSet)
                if (supplierVoucherLinePostDto.CreditVatReturnSpecificationOption!.Value != null)
                {
                    var creditVatReturnSpecificationRawValue = VatReturnSpecificationValueConverter.ToJsonValue(supplierVoucherLinePostDto.CreditVatReturnSpecificationOption.Value!.Value);
            ...
            if (supplierVoucherLinePostDto.CurrencyAmountOption.IsSet)
                writer.WriteNumber("CurrencyAmount", supplierVoucherLinePostDto.CurrencyAmountOption.Value!.Value);

            if (supplierVoucherLinePostDto.DebitAccountIdOption.IsSet)
                if (supplierVoucherLinePostDto.DebitAccountIdOption.Value != null)
                    writer.WriteNumber("DebitAccountId", supplierVoucherLinePostDto.DebitAccountIdOption.Value!.Value);
                else
                    writer.WriteNull("DebitAccountId");

            if (supplierVoucherLinePostDto.DebitVatIdOption.IsSet)
                if (supplierVoucherLinePostDto.DebitVatIdOption.Value != null)
                    writer.WriteNumber("DebitVatId", supplierVoucherLinePostDto.DebitVatIdOption.Value!.Value);
                else
                    writer.WriteNull("DebitVatId");

            if (supplierVoucherLinePostDto.DebitVatReturnSpecificationOption.IsSet)
                if (supplierVoucherLinePostDto.DebitVatReturnSpecificationOption!.Value != null)
                {
                    var debitVatReturnSpecificationRawValue = VatReturnSpecificationValueConverter.ToJsonValue(supplierVoucherLinePostDto.DebitVatReturnSpecificationOption.Value!.Value);
            ...
            if (supplierVoucherLinePostDto.DepartmentIdOption.IsSet)
                if (supplierVoucherLinePostDto.DepartmentIdOption.Value != null)
                    writer.WriteNumber("DepartmentId", supplierVoucherLinePostDto.DepartmentIdOption.Value!.Value);
                else
                    writer.WriteNull("DepartmentId");

            if (supplierVoucherLinePostDto.DescriptionOption.IsSet)
                if (supplierVoucherLinePostDto.DescriptionOption.Value != null)
                    writer.WriteString("Description", supplierVoucherLinePostDto.Description);
                else
                    writer.WriteNull("Description");

            if (supplierVoucherLinePostDto.Dim1IdOption.IsSet)
                if (supplierVoucherLinePostDto.Dim1IdOption.Value != null)
                    writer.WriteNumber("Dim1Id", supplierVoucherLinePostDto.Dim1IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim1Id");

            if (supplierVoucherLinePostDto.Dim2IdOption.IsSet)
                if (supplierVoucherLinePostDto.Dim2IdOption.Value != null)
                    writer.WriteNumber("Dim2Id", supplierVoucherLinePostDto.Dim2IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim2Id");

            if (supplierVoucherLinePostDto.Dim3IdOption.IsSet)
                if (supplierVoucherLinePostDto.Dim3IdOption.Value != null)
                    writer.WriteNumber("Dim3Id", supplierVoucherLinePostDto.Dim3IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim3Id");

            if (supplierVoucherLinePostDto.LocationIdOption.IsSet)
                if (supplierVoucherLinePostDto.LocationIdOption.Value != null)
                    writer.WriteNumber("LocationId", supplierVoucherLinePostDto.LocationIdOption.Value!.Value);
                else
                    writer.WriteNull("LocationId");

            if (supplierVoucherLinePostDto.ProductIdOption.IsSet)
                if (supplierVoucherLinePostDto.ProductIdOption.Value != null)
                    writer.WriteNumber("ProductId", supplierVoucherLinePostDto.ProductIdOption.Value!.Value);
                else
                    writer.WriteNull("ProductId");

            if (supplierVoucherLinePostDto.ProjectIdOption.IsSet)
                if (supplierVoucherLinePostDto.ProjectIdOption.Value != null)
                    writer.WriteNumber("ProjectId", supplierVoucherLinePostDto.ProjectIdOption.Value!.Value);
                else
                    writer.WriteNull("ProjectId");

            if (supplierVoucherLinePostDto.QuantityOption.IsSet)
                if (supplierVoucherLinePostDto.QuantityOption.Value != null)
                    writer.WriteNumber("Quantity", supplierVoucherLinePostDto.QuantityOption.Value!.Value);
                else
                    writer.WriteNull("Quantity");

            if (supplierVoucherLinePostDto.Quantity2Option.IsSet)
                if (supplierVoucherLinePostDto.Quantity2Option.Value != null)
                    writer.WriteNumber("Quantity2", supplierVoucherLinePostDto.Quantity2Option.Value!.Value);
                else
