...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class CashVoucherLineDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CashVoucherLineDto" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CashVoucherLineDto {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="CashVoucherLineDto" />
    /// </summary>
    public class CashVoucherLineDtoJsonConverter : JsonConverter<CashVoucherLineDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="CashVoucherLineDto" />
        /// </summary>
        ...
        public override CashVoucherLineDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!postingDate.IsSet)
                throw new ArgumentException("Property is required for class CashVoucherLineDto.", nameof(postingDate));

            if (postingDate.IsSet && postingDate.Value == null)
                throw new ArgumentNullException(nameof(postingDate), "Property is not nullable for class CashVoucherLineDto.");

            if (createdDateTimeOffset.IsSet && createdDateTimeOffset.Value == null)
                throw new ArgumentNullException(nameof(createdDateTimeOffset), "Property is not nullable for class CashVoucherLineDto.");

            if (currencyAmount.IsSet && currencyAmount.Value == null)
                throw new ArgumentNullException(nameof(currencyAmount), "Property is not nullable for class CashVoucherLineDto.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class CashVoucherLineDto.");

            return new CashVoucherLineDto(postingDate.Value!.Value!, accountId, createdDateTimeOffset, currencyAmount, currencyCode, currencyExchangeRate, customMatchingReference, departmentId, description, dim1Id, dim2Id, dim3Id, externalLineReference, id, locationId, productId, projectId, quantity, quantity2, vatId, vatReturnSpecification);
        }

        /// <summary>
        /// Serializes a <see cref="CashVoucherLineDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="cashVoucherLineDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CashVoucherLineDto cashVoucherLineDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, cashVoucherLineDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CashVoucherLineDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="cashVoucherLineDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CashVoucherLineDto cashVoucherLineDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteString("PostingDate", cashVoucherLineDto.PostingDate.ToString(PostingDateFormat));

            if (cashVoucherLineDto.AccountIdOption.IsSet)
                if (cashVoucherLineDto.AccountIdOption.Value != null)
                    writer.WriteNumber("AccountId", cashVoucherLineDto.AccountIdOption.Value!.Value);
                else
                    writer.WriteNull("AccountId");

            if (cashVoucherLineDto.CreatedDateTimeOffsetOption.IsSet)
                writer.WriteString("CreatedDateTimeOffset", cashVoucherLineDto.CreatedDateTimeOffsetOption.Value!.Value.ToString(CreatedDateTimeOffsetFormat));

            if (cashVoucherLineDto.CurrencyAmountOption.IsSet)
                writer.WriteNumber("CurrencyAmount", cashVoucherLineDto.CurrencyAmountOption.Value!.Value);

            if (cashVoucherLineDto.CurrencyCodeOption.IsSet)
                if (cashVoucherLineDto.CurrencyCodeOption.Value != null)
                    writer.WriteString("CurrencyCode", cashVoucherLineDto.CurrencyCode);
                else
                    writer.WriteNull("CurrencyCode");

            if (cashVoucherLineDto.CurrencyExchangeRateOption.IsSet)
                if (cashVoucherLineDto.CurrencyExchangeRateOption.Value != null)
                    writer.WriteNumber("CurrencyExchangeRate", cashVoucherLineDto.CurrencyExchangeRateOption.Value!.Value);
                else
                    writer.WriteNull("CurrencyExchangeRate");

            if (cashVoucherLineDto.CustomMatchingReferenceOption.IsSet)
                if (cashVoucherLineDto.CustomMatchingReferenceOption.Value != null)
                    writer.WriteString("CustomMatchingReference", cashVoucherLineDto.CustomMatchingReference);
                else
                    writer.WriteNull("CustomMatchingReference");

            if (cashVoucherLineDto.DepartmentIdOption.IsSet)
                if (cashVoucherLineDto.DepartmentIdOption.Value != null)
                    writer.WriteNumber("DepartmentId", cashVoucherLineDto.DepartmentIdOption.Value!.Value);
                else
                    writer.WriteNull("DepartmentId");

            if (cashVoucherLineDto.DescriptionOption.IsSet)
                if (cashVoucherLineDto.DescriptionOption.Value != null)
                    writer.WriteString("Description", cashVoucherLineDto.Description);
                else
                    writer.WriteNull("Description");

            if (cashVoucherLineDto.Dim1IdOption.IsSet)
                if (cashVoucherLineDto.Dim1IdOption.Value != null)
                    writer.WriteNumber("Dim1Id", cashVoucherLineDto.Dim1IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim1Id");

            if (cashVoucherLineDto.Dim2IdOption.IsSet)
                if (cashVoucherLineDto.Dim2IdOption.Value != null)
                    writer.WriteNumber("Dim2Id", cashVoucherLineDto.Dim2IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim2Id");

            if (cashVoucherLineDto.Dim3IdOption.IsSet)
                if (cashVoucherLineDto.Dim3IdOption.Value != null)
                    writer.WriteNumber("Dim3Id", cashVoucherLineDto.Dim3IdOption.Value!.Value);
                else
                    writer.WriteNull("Dim3Id");

            if (cashVoucherLineDto.ExternalLineReferenceOption.IsSet)
                if (cashVoucherLineDto.ExternalLineReferenceOption.Value != null)
                    writer.WriteString("ExternalLineReference", cashVoucherLineDto.ExternalLineReference);
                else
                    writer.WriteNull("ExternalLineReference");

            if (cashVoucherLineDto.IdOption.IsSet)
                writer.WriteNumber("Id", cashVoucherLineDto.IdOption.Value!.Value);

            if (cashVoucherLineDto.LocationIdOption.IsSet)
                if (cashVoucherLineDto.LocationIdOption.Value != null)
                    writer.WriteNumber("LocationId", cashVoucherLineDto.LocationIdOption.Value!.Value);
                else
                    writer.WriteNull("LocationId");

            if (cashVoucherLineDto.ProductIdOption.IsSet)
                if (cashVoucherLineDto.ProductIdOption.Value != null)
                    writer.WriteNumber("ProductId", cashVoucherLineDto.ProductIdOption.Value!.Value);
                else
                    writer.WriteNull("ProductId");

            if (cashVoucherLineDto.ProjectIdOption.IsSet)
                if (cashVoucherLineDto.ProjectIdOption.Value != null)
                    writer.WriteNumber("ProjectId", cashVoucherLineDto.ProjectIdOption.Value!.Value);
                else
                    writer.WriteNull("ProjectId");

            if (cashVoucherLineDto.QuantityOption.IsSet)
                if (cashVoucherLineDto.QuantityOption.Value != null)
                    writer.WriteNumber("Quantity", cashVoucherLineDto.QuantityOption.Value!.Value);
                else
                    writer.WriteNull("Quantity");

            if (cashVoucherLineDto.Quantity2Option.IsSet)
                if (cashVoucherLineDto.Quantity2Option.Value != null)
                    writer.WriteNumber("Quantity2", cashVoucherLineDto.Quantity2Option.Value!.Value);
                else
                    writer.WriteNull("Quantity2");

            if (cashVoucherLineDto.VatIdOption.IsSet)
                if (cashVoucherLineDto.VatIdOption.Value != null)
                    writer.WriteNumber("VatId", cashVoucherLineDto.VatIdOption.Value!.Value);
                else
                    writer.WriteNull("VatId");

            if (cashVoucherLineDto.VatReturnSpecificationOption.IsSet)
                if (cashVoucherLineDto.VatReturnSpecificationOption!.Value != null)
                {
                    var vatReturnSpecificationRawValue = VatReturnSpecificationValueConverter.ToJsonValue(cashVoucherLineDto.VatReturnSpecificationOption.Value!.Value);
