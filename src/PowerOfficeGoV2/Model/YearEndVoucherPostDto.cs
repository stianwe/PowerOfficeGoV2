...
namespace PowerOfficeGoV2.Model
{
    ...
    public partial class YearEndVoucherPostDto : IValidatableObject
    {
        ...
        [JsonConstructor]
        public YearEndVoucherPostDto(DateTimeOffset voucherDate, string? currencyCode = default, Option<string?> description = default, Option<string?> externalImportReference = default, Option<long?> importedVoucherNo = default, Option<string?> saftBatchId = default, Option<string?> saftSourceId = default, List<YearEndVoucherLinePostDto>? voucherLines = default)
        {
