...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class SalaryLineDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SalaryLineDto" /> class.
        /// </summary>
        ...
        /// <param name="createdDateTimeOffset">The timestamp when the salary line entity was created.</param>
        ...
        /// <param name="id">The identifier of the salary line.</param>
        ...
        /// <param name="isDeletedByUser">Value indicating whether this instance have been soft-deleted by a user in Go.</param>
        /// <param name="isLocked">Value indicating whether this instance is locked in Go.  Salary lines that have been added to a payroll in Go will have this property set true, and the lines cannot be altered by the integration if locked.  Salary lines are also marked as locked if they have been soft-deleted by a user in Go.</param>
        /// <param name="lastChangedDateTimeOffset">The timestamp when the salary line entity was updated.</param>
        ...
        [JsonConstructor]
        public SalaryLineDto(Option<long?> accountId = default, Option<double?> amount = default, Option<double?> carListPrice = default, Option<DateTimeOffset?> carRegistrationDate = default, Option<string?> carRegistrationNo = default, Option<string?> cid = default, Option<string?> comment = default, Option<CommuterPersonType?> commuterPersonType = default, Option<DateTimeOffset?> createdDateTimeOffset = default, Option<DeductionType?> deductionType = default, Option<long?> departmentId = default, Option<long?> employeeId = default, Option<string?> externalImportReference = default, Option<DateTimeOffset?> fromDate = default, Option<double?> homeWorkKilometers = default, Option<long?> id = default, Option<int?> incomeYear = default, Option<bool?> isCarPool = default, Option<bool?> isDeletedByUser = default, Option<bool?> isLocked = default, Option<DateTimeOffset?> lastChangedDateTimeOffset = default, Option<double?> maxAmount = default, Option<string?> memberNo = default, Option<double?> minAmount = default, Option<int?> number = default, Option<long?> oppositeAccountId = default, Option<Guid?> payItemId = default, Option<double?> privateDrivenKilometers = default, Option<long?> projectId = default, Option<double?> quantity = default, Option<double?> rate = default, Option<double?> startAmount = default, Option<long?> supplierAccountId = default, Option<long?> supplierBankAccountId = default, Option<TaxRuleType?> taxRule = default, Option<DateTimeOffset?> toDate = default, Option<bool?> useRemittance = default, Option<int?> vatCodeId = default, Option<bool?> workDriveExceedsKilometerLimit = default)
        {
            ...
            IsDeletedByUserOption = isDeletedByUser;
        ...
        /// </summary>
        /// <value>The timestamp when the salary line entity was created.</value>
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<long?> EmployeeIdOption { get; private set; }
        ...
        public long? EmployeeId { get { return this.EmployeeIdOption; } set { this.EmployeeIdOption = new(value); } }
        ...
        /// </summary>
        /// <value>The identifier of the salary line.</value>
        /* <example>12345</example> */
        [JsonPropertyName("Id")]
        ...
        /// <summary>
        /// Used to track the state of IsDeletedByUser
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<bool?> IsDeletedByUserOption { get; }

        /// <summary>
        /// Value indicating whether this instance have been soft-deleted by a user in Go.
        /// </summary>
        /// <value>Value indicating whether this instance have been soft-deleted by a user in Go.</value>
        /* <example>true</example> */
        [JsonPropertyName("IsDeletedByUser")]
        public bool? IsDeletedByUser { get { return this.IsDeletedByUserOption; } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<bool?> IsLockedOption { get; }

        /// <summary>
        /// Value indicating whether this instance is locked in Go.  Salary lines that have been added to a payroll in Go will have this property set true, and the lines cannot be altered by the integration if locked.  Salary lines are also marked as locked if they have been soft-deleted by a user in Go.
        /// </summary>
        /// <value>Value indicating whether this instance is locked in Go.  Salary lines that have been added to a payroll in Go will have this property set true, and the lines cannot be altered by the integration if locked.  Salary lines are also marked as locked if they have been soft-deleted by a user in Go.</value>
        /* <example>true</example> */
        [JsonPropertyName("IsLocked")]
        public bool? IsLocked { get { return this.IsLockedOption; } }
        ...
        /// </summary>
        /// <value>The timestamp when the salary line entity was updated.</value>
        /* <example>2021-09-30T08:07:00.123456700Z</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="SalaryLineDto" />
    /// </summary>
    public class SalaryLineDtoJsonConverter : JsonConverter<SalaryLineDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="SalaryLineDto" />
        /// </summary>
        ...
        public override SalaryLineDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<bool?> isDeletedByUser = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "IsCarPool":
                            ...
                            break;
                        case "IsDeletedByUser":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                isDeletedByUser = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "IsLocked":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (createdDateTimeOffset.IsSet && createdDateTimeOffset.Value == null)
                throw new ArgumentNullException(nameof(createdDateTimeOffset), "Property is not nullable for class SalaryLineDto.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class SalaryLineDto.");

            if (isDeletedByUser.IsSet && isDeletedByUser.Value == null)
                throw new ArgumentNullException(nameof(isDeletedByUser), "Property is not nullable for class SalaryLineDto.");

            if (isLocked.IsSet && isLocked.Value == null)
                throw new ArgumentNullException(nameof(isLocked), "Property is not nullable for class SalaryLineDto.");

            if (lastChangedDateTimeOffset.IsSet && lastChangedDateTimeOffset.Value == null)
                throw new ArgumentNullException(nameof(lastChangedDateTimeOffset), "Property is not nullable for class SalaryLineDto.");

            return new SalaryLineDto(accountId, amount, carListPrice, carRegistrationDate, carRegistrationNo, cid, comment, commuterPersonType, createdDateTimeOffset, deductionType, departmentId, employeeId, externalImportReference, fromDate, homeWorkKilometers, id, incomeYear, isCarPool, isDeletedByUser, isLocked, lastChangedDateTimeOffset, maxAmount, memberNo, minAmount, number, oppositeAccountId, payItemId, privateDrivenKilometers, projectId, quantity, rate, startAmount, supplierAccountId, supplierBankAccountId, taxRule, toDate, useRemittance, vatCodeId, workDriveExceedsKilometerLimit);
        }

        /// <summary>
        /// Serializes a <see cref="SalaryLineDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="salaryLineDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SalaryLineDto salaryLineDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, salaryLineDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SalaryLineDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="salaryLineDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SalaryLineDto salaryLineDto, JsonSerializerOptions jsonSerializerOptions)
        {
            if (salaryLineDto.AccountIdOption.IsSet)
                if (salaryLineDto.AccountIdOption.Value != null)
                    writer.WriteNumber("AccountId", salaryLineDto.AccountIdOption.Value!.Value);
                else
                    writer.WriteNull("AccountId");

            if (salaryLineDto.AmountOption.IsSet)
                if (salaryLineDto.AmountOption.Value != null)
                    writer.WriteNumber("Amount", salaryLineDto.AmountOption.Value!.Value);
                else
                    writer.WriteNull("Amount");

            if (salaryLineDto.CarListPriceOption.IsSet)
                if (salaryLineDto.CarListPriceOption.Value != null)
                    writer.WriteNumber("CarListPrice", salaryLineDto.CarListPriceOption.Value!.Value);
                else
                    writer.WriteNull("CarListPrice");

            if (salaryLineDto.CarRegistrationDateOption.IsSet)
                if (salaryLineDto.CarRegistrationDateOption.Value != null)
                    writer.WriteString("CarRegistrationDate", salaryLineDto.CarRegistrationDateOption.Value!.Value.ToString(CarRegistrationDateFormat));
                else
                    writer.WriteNull("CarRegistrationDate");

            if (salaryLineDto.CarRegistrationNoOption.IsSet)
                if (salaryLineDto.CarRegistrationNoOption.Value != null)
                    writer.WriteString("CarRegistrationNo", salaryLineDto.CarRegistrationNo);
                else
                    writer.WriteNull("CarRegistrationNo");

            if (salaryLineDto.CidOption.IsSet)
                if (salaryLineDto.CidOption.Value != null)
                    writer.WriteString("Cid", salaryLineDto.Cid);
                else
                    writer.WriteNull("Cid");

            if (salaryLineDto.CommentOption.IsSet)
                if (salaryLineDto.CommentOption.Value != null)
                    writer.WriteString("Comment", salaryLineDto.Comment);
                else
                    writer.WriteNull("Comment");

            if (salaryLineDto.CommuterPersonTypeOption.IsSet)
                if (salaryLineDto.CommuterPersonTypeOption!.Value != null)
                {
                    var commuterPersonTypeRawValue = CommuterPersonTypeValueConverter.ToJsonValue(salaryLineDto.CommuterPersonTypeOption.Value!.Value);
                    writer.WriteString("CommuterPersonType", commuterPersonTypeRawValue);
                }
                else
                    writer.WriteNull("CommuterPersonType");
            if (salaryLineDto.CreatedDateTimeOffsetOption.IsSet)
                writer.WriteString("CreatedDateTimeOffset", salaryLineDto.CreatedDateTimeOffsetOption.Value!.Value.ToString(CreatedDateTimeOffsetFormat));

            if (salaryLineDto.DeductionTypeOption.IsSet)
                if (salaryLineDto.DeductionTypeOption!.Value != null)
                {
                    var deductionTypeRawValue = DeductionTypeValueConverter.ToJsonValue(salaryLineDto.DeductionTypeOption.Value!.Value);
                    writer.WriteString("DeductionType", deductionTypeRawValue);
                }
                else
                    writer.WriteNull("DeductionType");
            if (salaryLineDto.DepartmentIdOption.IsSet)
                if (salaryLineDto.DepartmentIdOption.Value != null)
                    writer.WriteNumber("DepartmentId", salaryLineDto.DepartmentIdOption.Value!.Value);
                else
                    writer.WriteNull("DepartmentId");

            if (salaryLineDto.EmployeeIdOption.IsSet)
                if (salaryLineDto.EmployeeIdOption.Value != null)
                    writer.WriteNumber("EmployeeId", salaryLineDto.EmployeeIdOption.Value!.Value);
                else
                    writer.WriteNull("EmployeeId");

            if (salaryLineDto.ExternalImportReferenceOption.IsSet)
                if (salaryLineDto.ExternalImportReferenceOption.Value != null)
                    writer.WriteString("ExternalImportReference", salaryLineDto.ExternalImportReference);
                else
                    writer.WriteNull("ExternalImportReference");

            if (salaryLineDto.FromDateOption.IsSet)
                if (salaryLineDto.FromDateOption.Value != null)
                    writer.WriteString("FromDate", salaryLineDto.FromDateOption.Value!.Value.ToString(FromDateFormat));
                else
                    writer.WriteNull("FromDate");

            if (salaryLineDto.HomeWorkKilometersOption.IsSet)
                if (salaryLineDto.HomeWorkKilometersOption.Value != null)
                    writer.WriteNumber("HomeWorkKilometers", salaryLineDto.HomeWorkKilometersOption.Value!.Value);
                else
                    writer.WriteNull("HomeWorkKilometers");

            if (salaryLineDto.IdOption.IsSet)
                writer.WriteNumber("Id", salaryLineDto.IdOption.Value!.Value);

            if (salaryLineDto.IncomeYearOption.IsSet)
                if (salaryLineDto.IncomeYearOption.Value != null)
                    writer.WriteNumber("IncomeYear", salaryLineDto.IncomeYearOption.Value!.Value);
                else
                    writer.WriteNull("IncomeYear");

            if (salaryLineDto.IsCarPoolOption.IsSet)
                if (salaryLineDto.IsCarPoolOption.Value != null)
                    writer.WriteBoolean("IsCarPool", salaryLineDto.IsCarPoolOption.Value!.Value);
                else
                    writer.WriteNull("IsCarPool");

            if (salaryLineDto.IsDeletedByUserOption.IsSet)
                writer.WriteBoolean("IsDeletedByUser", salaryLineDto.IsDeletedByUserOption.Value!.Value);

            if (salaryLineDto.IsLockedOption.IsSet)
                writer.WriteBoolean("IsLocked", salaryLineDto.IsLockedOption.Value!.Value);

            if (salaryLineDto.LastChangedDateTimeOffsetOption.IsSet)
                writer.WriteString("LastChangedDateTimeOffset", salaryLineDto.LastChangedDateTimeOffsetOption.Value!.Value.ToString(LastChangedDateTimeOffsetFormat));

            if (salaryLineDto.MaxAmountOption.IsSet)
                if (salaryLineDto.MaxAmountOption.Value != null)
                    writer.WriteNumber("MaxAmount", salaryLineDto.MaxAmountOption.Value!.Value);
                else
                    writer.WriteNull("MaxAmount");

            if (salaryLineDto.MemberNoOption.IsSet)
                if (salaryLineDto.MemberNoOption.Value != null)
                    writer.WriteString("MemberNo", salaryLineDto.MemberNo);
                else
                    writer.WriteNull("MemberNo");

            if (salaryLineDto.MinAmountOption.IsSet)
                if (salaryLineDto.MinAmountOption.Value != null)
                    writer.WriteNumber("MinAmount", salaryLineDto.MinAmountOption.Value!.Value);
                else
                    writer.WriteNull("MinAmount");

            if (salaryLineDto.NumberOption.IsSet)
                if (salaryLineDto.NumberOption.Value != null)
                    writer.WriteNumber("Number", salaryLineDto.NumberOption.Value!.Value);
                else
                    writer.WriteNull("Number");

            if (salaryLineDto.OppositeAccountIdOption.IsSet)
                if (salaryLineDto.OppositeAccountIdOption.Value != null)
                    writer.WriteNumber("OppositeAccountId", salaryLineDto.OppositeAccountIdOption.Value!.Value);
                else
                    writer.WriteNull("OppositeAccountId");

            if (salaryLineDto.PayItemIdOption.IsSet)
                if (salaryLineDto.PayItemIdOption.Value != null)
                    writer.WriteString("PayItemId", salaryLineDto.PayItemIdOption.Value!.Value);
                else
                    writer.WriteNull("PayItemId");

            if (salaryLineDto.PrivateDrivenKilometersOption.IsSet)
                if (salaryLineDto.PrivateDrivenKilometersOption.Value != null)
                    writer.WriteNumber("PrivateDrivenKilometers", salaryLineDto.PrivateDrivenKilometersOption.Value!.Value);
                else
                    writer.WriteNull("PrivateDrivenKilometers");

            if (salaryLineDto.ProjectIdOption.IsSet)
                if (salaryLineDto.ProjectIdOption.Value != null)
                    writer.WriteNumber("ProjectId", salaryLineDto.ProjectIdOption.Value!.Value);
                else
                    writer.WriteNull("ProjectId");

            if (salaryLineDto.QuantityOption.IsSet)
                if (salaryLineDto.QuantityOption.Value != null)
                    writer.WriteNumber("Quantity", salaryLineDto.QuantityOption.Value!.Value);
                else
                    writer.WriteNull("Quantity");

            if (salaryLineDto.RateOption.IsSet)
                if (salaryLineDto.RateOption.Value != null)
                    writer.WriteNumber("Rate", salaryLineDto.RateOption.Value!.Value);
                else
                    writer.WriteNull("Rate");

            if (salaryLineDto.StartAmountOption.IsSet)
                if (salaryLineDto.StartAmountOption.Value != null)
                    writer.WriteNumber("StartAmount", salaryLineDto.StartAmountOption.Value!.Value);
                else
                    writer.WriteNull("StartAmount");

            if (salaryLineDto.SupplierAccountIdOption.IsSet)
                if (salaryLineDto.SupplierAccountIdOption.Value != null)
                    writer.WriteNumber("SupplierAccountId", salaryLineDto.SupplierAccountIdOption.Value!.Value);
                else
                    writer.WriteNull("SupplierAccountId");

            if (salaryLineDto.SupplierBankAccountIdOption.IsSet)
                if (salaryLineDto.SupplierBankAccountIdOption.Value != null)
                    writer.WriteNumber("SupplierBankAccountId", salaryLineDto.SupplierBankAccountIdOption.Value!.Value);
                else
                    writer.WriteNull("SupplierBankAccountId");

            if (salaryLineDto.TaxRuleOption.IsSet)
                if (salaryLineDto.TaxRuleOption!.Value != null)
                {
                    var taxRuleRawValue = TaxRuleTypeValueConverter.ToJsonValue(salaryLineDto.TaxRuleOption.Value!.Value);
                    writer.WriteString("TaxRule", taxRuleRawValue);
                }
                else
                    writer.WriteNull("TaxRule");
            if (salaryLineDto.ToDateOption.IsSet)
                if (salaryLineDto.ToDateOption.Value != null)
                    writer.WriteString("ToDate", salaryLineDto.ToDateOption.Value!.Value.ToString(ToDateFormat));
                else
                    writer.WriteNull("ToDate");

            if (salaryLineDto.UseRemittanceOption.IsSet)
                if (salaryLineDto.UseRemittanceOption.Value != null)
                    writer.WriteBoolean("UseRemittance", salaryLineDto.UseRemittanceOption.Value!.Value);
                else
                    writer.WriteNull("UseRemittance");

            if (salaryLineDto.VatCodeIdOption.IsSet)
                if (salaryLineDto.VatCodeIdOption.Value != null)
                    writer.WriteNumber("VatCodeId", salaryLineDto.VatCodeIdOption.Value!.Value);
                else
                    writer.WriteNull("VatCodeId");

            if (salaryLineDto.WorkDriveExceedsKilometerLimitOption.IsSet)
                if (salaryLineDto.WorkDriveExceedsKilometerLimitOption.Value != null)
                    writer.WriteBoolean("WorkDriveExceedsKilometerLimit", salaryLineDto.WorkDriveExceedsKilometerLimitOption.Value!.Value);
                else
