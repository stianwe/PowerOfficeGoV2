...
namespace PowerOfficeGoV2.Model
{
    ...
    public partial class SalaryLineDto : IValidatableObject
    {
        ...
        [JsonConstructor]
        public SalaryLineDto(Option<long?> accountId = default, Option<double?> amount = default, Option<double?> carListPrice = default, Option<DateOnly?> carRegistrationDate = default, Option<string?> carRegistrationNo = default, Option<string?> cid = default, Option<string?> comment = default, Option<CommuterPersonType?> commuterPersonType = default, Option<DateTime?> createdDateTimeOffset = default, Option<DeductionType?> deductionType = default, Option<long?> departmentId = default, Option<long?> employeeId = default, Option<string?> externalImportReference = default, Option<DateOnly?> fromDate = default, Option<double?> homeWorkKilometers = default, Option<long?> id = default, Option<int?> incomeYear = default, Option<bool?> isCarPool = default, Option<bool?> isDeletedByUser = default, Option<bool?> isLocked = default, Option<DateTime?> lastChangedDateTimeOffset = default, Option<double?> maxAmount = default, Option<string?> memberNo = default, Option<double?> minAmount = default, Option<int?> number = default, Option<long?> oppositeAccountId = default, Option<Guid?> payItemId = default, Option<double?> privateDrivenKilometers = default, Option<long?> projectId = default, Option<double?> quantity = default, Option<double?> rate = default, Option<double?> startAmount = default, Option<long?> supplierAccountId = default, Option<long?> supplierBankAccountId = default, Option<TaxRuleType?> taxRule = default, Option<DateOnly?> toDate = default, Option<bool?> useRemittance = default, Option<int?> vatCodeId = default, Option<bool?> workDriveExceedsKilometerLimit = default)
        {
