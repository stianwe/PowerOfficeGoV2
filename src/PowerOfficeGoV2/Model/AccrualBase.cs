...
namespace PowerOfficeGoV2.Model
{
    ...
    public partial class AccrualBase : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AccrualBase(Option<AgricultureDepartment?> balanceAccountAgricultureDepartment = default, Option<long?> balanceAccountId = default, Option<long?> balanceAccountNo = default, Option<DateOnly?> fromDate = default, Option<bool?> isActive = default, Option<DateOnly?> toDate = default)
        {
