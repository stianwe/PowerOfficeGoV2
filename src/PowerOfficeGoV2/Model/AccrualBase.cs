...
namespace PowerOfficeGoV2.Model
{
    ...
    /// </summary>
    public partial class AccrualBase : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccrualBase" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public AccrualBase(Option<AgricultureDepartment?> balanceAccountAgricultureDepartment = default, Option<long?> balanceAccountId = default, Option<long?> balanceAccountNo = default, Option<DateTimeOffset?> fromDate = default, Option<bool?> isActive = default, Option<DateTimeOffset?> toDate = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="AccrualBase" />
    /// </summary>
    public class AccrualBaseJsonConverter : JsonConverter<AccrualBase>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="AccrualBase" />
        /// </summary>
        ...
        public override AccrualBase Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (fromDate.IsSet && fromDate.Value == null)
                throw new ArgumentNullException(nameof(fromDate), "Property is not nullable for class AccrualBase.");

            if (isActive.IsSet && isActive.Value == null)
                throw new ArgumentNullException(nameof(isActive), "Property is not nullable for class AccrualBase.");

            if (toDate.IsSet && toDate.Value == null)
                throw new ArgumentNullException(nameof(toDate), "Property is not nullable for class AccrualBase.");

            return new AccrualBase(balanceAccountAgricultureDepartment, balanceAccountId, balanceAccountNo, fromDate, isActive, toDate);
        }

        /// <summary>
        /// Serializes a <see cref="AccrualBase" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="accrualBase"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AccrualBase accrualBase, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, accrualBase, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AccrualBase" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="accrualBase"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AccrualBase accrualBase, JsonSerializerOptions jsonSerializerOptions)
        {
            if (accrualBase.BalanceAccountAgricultureDepartmentOption.IsSet)
                if (accrualBase.BalanceAccountAgricultureDepartmentOption!.Value != null)
                {
                    var balanceAccountAgricultureDepartmentRawValue = AgricultureDepartmentValueConverter.ToJsonValue(accrualBase.BalanceAccountAgricultureDepartmentOption.Value!.Value);
            ...
            if (accrualBase.BalanceAccountIdOption.IsSet)
                if (accrualBase.BalanceAccountIdOption.Value != null)
                    writer.WriteNumber("BalanceAccountId", accrualBase.BalanceAccountIdOption.Value!.Value);
                else
                    writer.WriteNull("BalanceAccountId");

            if (accrualBase.BalanceAccountNoOption.IsSet)
                if (accrualBase.BalanceAccountNoOption.Value != null)
                    writer.WriteNumber("BalanceAccountNo", accrualBase.BalanceAccountNoOption.Value!.Value);
                else
                    writer.WriteNull("BalanceAccountNo");

            if (accrualBase.FromDateOption.IsSet)
                writer.WriteString("FromDate", accrualBase.FromDateOption.Value!.Value.ToString(FromDateFormat));

            if (accrualBase.IsActiveOption.IsSet)
                writer.WriteBoolean("IsActive", accrualBase.IsActiveOption.Value!.Value);

            if (accrualBase.ToDateOption.IsSet)
                writer.WriteString("ToDate", accrualBase.ToDateOption.Value!.Value.ToString(ToDateFormat));
        }
    }
}
