...
namespace PowerOfficeGoV2.Model
{
    ...
    public partial class LocationDto : IValidatableObject
    {
        ...
        [JsonConstructor]
        public LocationDto(Option<string?> code = default, Option<DateTimeOffset?> createdDateTimeOffset = default, Option<long?> id = default, Option<bool?> isActive = default, Option<DateTimeOffset?> lastChangedDateTimeOffset = default, Option<string?> name = default)
        {
            CodeOption = code;
