...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAccessRolesApi>();
            ClientAdminClientIdAccessRolesGetApiResponse apiResponse = await api.ClientAdminClientIdAccessRolesGetAsync("todo");
            List<AccessRoleDto> model = apiResponse.Ok();
        }
