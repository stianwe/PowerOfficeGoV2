# PowerOfficeGoV2.Model.ManualVoucherPostDto
...
**VoucherLines** | [**List&lt;ManualVoucherLinePostDto&gt;**](ManualVoucherLinePostDto.md) | The lines of the manual voucher to be posted | [optional] 
