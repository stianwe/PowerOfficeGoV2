...
**CreatedDateTimeOffset** | **DateTimeOffset** | The timestamp when the employment fixed salary entity was created. | [optional] [readonly] 
...
**LastChangedDateTimeOffset** | **DateTimeOffset** | The timestamp when the employment fixed salary entity was last changed. | [optional] [readonly] 
