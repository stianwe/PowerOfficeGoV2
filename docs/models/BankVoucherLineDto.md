# PowerOfficeGoV2.Model.BankVoucherLineDto
...
**InvoiceNo** | **string** | The invoice number this payment transaction relate to.  If provided, and the account number set on the line is a subledger account, the system will try to match the payment line with the accounting entry of the invoice referenced. | [optional] [readonly] 
