# PowerOfficeGoV2.Model.CashVoucherPostDto
...
**VoucherLines** | [**List&lt;CashVoucherLinePostDto&gt;**](CashVoucherLinePostDto.md) | The lines of the cash voucher to be posted | [optional] 
