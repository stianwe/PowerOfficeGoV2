...
**CreatedDateTimeOffset** | **DateTimeOffset** | The timestamp the pay item entity was created. | [optional] [readonly] 
...
**LastChangedDateTimeOffset** | **DateTimeOffset** | The timestamp of the last change of the pay item. | [optional] [readonly] 
