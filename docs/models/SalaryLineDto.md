...
**CreatedDateTimeOffset** | **DateTime** | The timestamp when the salary line entity was created. | [optional] [readonly] 
...
**LastChangedDateTimeOffset** | **DateTime** | The timestamp when the salary line entity was updated. | [optional] [readonly] 
