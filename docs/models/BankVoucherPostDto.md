# PowerOfficeGoV2.Model.BankVoucherPostDto
...
**VoucherLines** | [**List&lt;BankVoucherLinePostDto&gt;**](BankVoucherLinePostDto.md) | The lines of the bank voucher to be posted | [optional] 
